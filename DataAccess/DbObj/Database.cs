...
/// {
///		tblBookingRow[] rows = db.tblBookingTable.GetAll();
/// }
/// </example>
        ...
        : Base.DatabaseBase
{
    ...
    public override IDbConnection CreateHYConnection()
    {
        return new System.Data.SqlClient.SqlConnection(SystemConfig.GetHyConnectionString());
    }
