// <fileinfo name="DbObj\asiaticadb.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
namespace asiaticasytem.asiatica.asiaticadb.DbObj
{
	/// <summary>
	/// Represents a connection to the <c>asiaticadb</c> database.
	/// </summary>
	/// <remarks>
	/// If the <c>asiaticadb</c> goes out of scope, the connection to the 
	...
	/// </remarks>
	/// <example>
	/// using(asiaticadb db = new asiaticadb())
	/// {
	///		tblAboutRow[] rows = db.tblAboutTable.GetAll();
	/// }
	/// </example>
	public class asiaticadb : asiaticadb_Base
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="asiaticadb"/> class.
		/// </summary>
		public asiaticadb()
		{
			// EMPTY
		...
		protected override IDbConnection CreateConnection()
		{
			...
			if (( dbConnection != null) && (dbConnection.Length > 0))
				...
				dbConnection = "Password=123456;User ID=sa;Initial Catalog=asiaticadb;Data Source" +
				"=ROSSI\\SQLEXPRESS";
			return new System.Data.SqlClient.SqlConnection(dbConnection);
#else
			return new System.Data.OleDb.OleDbConnection(
				"Provider=SQLNCLI.1;Password=123456;Persist Security Info=True;Use" +
				"r ID=sa;Initial Catalog=asiaticadb;Data Source=ROSSI\\SQLEXPRESS");
#endif
		}
