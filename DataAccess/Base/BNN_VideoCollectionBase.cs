...
// <fileinfo name="Base\BNN_VideoCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_VideoCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string Video_IDColumnName  = "Video_ID";
	...
	public BNN_VideoCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_Video";
	}

	public BNN_VideoCollectionBase() : base()
	{
		this.TABLENAME = "BNN_Video";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_Video</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_VideoRow"/> objects.</returns>
	public virtual BNN_VideoRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_Video</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_Video</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_Video_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_VideoRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_VideoRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_VideoRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_VideoRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_VideoRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_VideoRow"/> objects.</returns>
	public BNN_VideoRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_VideoRow"/> objects.</returns>
	public virtual BNN_VideoRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_VideoRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Video_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Video_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_VideoRow"/> by the primary key.
	/// </summary>
	/// <param name="video_ID">The <c>Video_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_VideoRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_VideoRow GetByPrimaryKey(int video_ID)
	{
		string LOCATION = "GetByPrimaryKey(int video_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_Video_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Video_ID", video_ID);
			BNN_VideoRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_Video</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_VideoRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_VideoRow value)
	{
		string LOCATION = "Insert(BNN_VideoRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Video_Insert", CommandType.StoredProcedure);
					// Title
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
						...
						value.Video_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_Video</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_VideoRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_VideoRow value)
	{	
		string LOCATION = "Update(BNN_VideoRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Video_Update", CommandType.StoredProcedure);
					// Title
			if (value.IsTitleNull)
				AddParameter(cmd, "Title", DBNull.Value);
			else
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
					...
					AddParameter(cmd, "Video_ID", value.Video_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_Video</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_VideoRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_VideoRow value)
		{
			string LOCATION = "Save(BNN_VideoRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_Video_Save",CommandType.StoredProcedure);
					// Title
				if (value.IsTitleNull)
					AddParameter(cmd, "Title", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Video_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_Video</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_VideoRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_VideoRow value)
	{
		return DeleteByPrimaryKey(value.Video_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_Video</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="video_ID">The <c>Video_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int video_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int video_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Video_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Video_ID", video_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_Video</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_Video</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Video_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_Video</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_Video_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_VideoRow"/> objects.</returns>
	protected BNN_VideoRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_VideoRow"/> objects.</returns>
	protected BNN_VideoRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_VideoRow"/> objects.</returns>
	protected virtual BNN_VideoRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// Video_ID
		int video_IDColumnIndex = reader.GetOrdinal("Video_ID");
		// Title
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_VideoRow record = new BNN_VideoRow();
				recordList.Add(record);

					record.Video_ID = Convert.ToInt32(reader.GetValue(video_IDColumnIndex));
		...
		return (BNN_VideoRow[])(recordList.ToArray(typeof(BNN_VideoRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_VideoRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_VideoRow"/> object.</returns>
	protected virtual BNN_VideoRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_VideoRow MapRow(DataRow row)";
		BNN_VideoRow mappedObject = new BNN_VideoRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "Video_ID"
		dataColumn = dataTable.Columns["Video_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Video_ID = (int)(row[dataColumn]);
		// Column "Title"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_Video";
		DataColumn dataColumn;
		// Create the "Video_ID" column
		dataColumn = dataTable.Columns.Add("Video_ID", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="BNN_VideoRow"/> by the primary key.
	/// </summary>
	/// <param name="video_ID">The <c>Video_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_VideoRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int video_ID)
	{
