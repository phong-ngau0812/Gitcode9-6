...
// <fileinfo name="Base\BNN_BannerRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="BNN_BannerRow"/> that 
/// represents a record in the <c>BNN_Banner</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="BNN_BannerRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class BNN_BannerRowBase
{
	/// _banner_ID
	private int _banner_ID;
	private bool _banner_IDNull = true;
	/// _positionBanner_ID
	private int _positionBanner_ID;
	private bool _positionBanner_IDNull = true;
	/// _title
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="BNN_BannerRowBase"/> class.
	/// </summary>
	public BNN_BannerRowBase():base()
	{
		// EMPTY
	}

		/// <summary>
		/// Gets or sets the <c>Banner_ID</c> column value.
		/// </summary>
		/// <value>The <c>Banner_ID</c> column value.</value>
	public int Banner_ID
	{
		...
		set
		{
			_banner_IDNull = false;
			_banner_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="Banner_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsBanner_IDNull
	{
		get
		{
			return _banner_IDNull;
		}
		set
		{
			_banner_IDNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>PositionBanner_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>PositionBanner_ID</c> column value.</value>
	public int PositionBanner_ID
	{
		get
		{
			if (IsPositionBanner_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _positionBanner_ID;
		}
		set
		{
			_positionBanner_IDNull = false;
			_positionBanner_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="PositionBanner_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsPositionBanner_IDNull
	{
		get
		{
			return _positionBanner_IDNull;
		}
		set
		{
			_positionBanner_IDNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		dynStr.Append(":");
		// Banner_ID
		dynStr.Append("  Banner_ID=");
		if( IsBanner_IDNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.Banner_ID);
		

		// PositionBanner_ID
		dynStr.Append("  PositionBanner_ID=");
		if( IsPositionBanner_IDNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.PositionBanner_ID);
		// Title
		dynStr.Append("  Title=");
		if( IsTitleNull)
			dynStr.Append("<NULL>");
