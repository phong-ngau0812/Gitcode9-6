...
// <fileinfo name="Base\WH_MaterialCategoryCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class WH_MaterialCategoryCollectionBase
...
{	
	...
	public WH_MaterialCategoryCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "WH_MaterialCategory";
	}

	public WH_MaterialCategoryCollectionBase() : base()
	{
		this.TABLENAME = "WH_MaterialCategory";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>WH_MaterialCategory</c> table.
	/// </summary>
	/// <returns>An array of <see cref="WH_MaterialCategoryRow"/> objects.</returns>
	public virtual WH_MaterialCategoryRow[] GetAll()
	{
	...
	/// includes all records from the <c>WH_MaterialCategory</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>WH_MaterialCategory</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("WH_MaterialCategory_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="WH_MaterialCategoryRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="WH_MaterialCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public WH_MaterialCategoryRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			WH_MaterialCategoryRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="WH_MaterialCategoryRow"/> objects that 
	...
	/// <returns>An array of <see cref="WH_MaterialCategoryRow"/> objects.</returns>
	public WH_MaterialCategoryRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="WH_MaterialCategoryRow"/> objects.</returns>
	public virtual WH_MaterialCategoryRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			WH_MaterialCategoryRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("WH_MaterialCategory_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("WH_MaterialCategory_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="WH_MaterialCategoryRow"/> by the primary key.
	/// </summary>
	/// <param name="materialCategory_ID">The <c>MaterialCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="WH_MaterialCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual WH_MaterialCategoryRow GetByPrimaryKey(int materialCategory_ID)
	{
		string LOCATION = "GetByPrimaryKey(int materialCategory_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("WH_MaterialCategory_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "MaterialCategory_ID", materialCategory_ID);
			WH_MaterialCategoryRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>WH_MaterialCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WH_MaterialCategoryRow"/> object to be inserted.</param>
	public virtual void Insert(WH_MaterialCategoryRow value)
	{
		string LOCATION = "Insert(WH_MaterialCategoryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("WH_MaterialCategory_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsCodeNull )
				...
				AddParameter(cmd, "Code", value.Code);
						...
						value.MaterialCategory_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>WH_MaterialCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WH_MaterialCategoryRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(WH_MaterialCategoryRow value)
	{	
		string LOCATION = "Update(WH_MaterialCategoryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("WH_MaterialCategory_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>WH_MaterialCategory</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="WH_MaterialCategoryRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(WH_MaterialCategoryRow value)
		{
			string LOCATION = "Save(WH_MaterialCategoryRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("WH_MaterialCategory_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["MaterialCategory_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>WH_MaterialCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WH_MaterialCategoryRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(WH_MaterialCategoryRow value)
	{
		return DeleteByPrimaryKey(value.MaterialCategory_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>WH_MaterialCategory</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="materialCategory_ID">The <c>MaterialCategory_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int materialCategory_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int materialCategory_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("WH_MaterialCategory_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "MaterialCategory_ID", materialCategory_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>WH_MaterialCategory</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>WH_MaterialCategory</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("WH_MaterialCategory_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>WH_MaterialCategory</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("WH_MaterialCategory_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="WH_MaterialCategoryRow"/> objects.</returns>
	protected WH_MaterialCategoryRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="WH_MaterialCategoryRow"/> objects.</returns>
	protected WH_MaterialCategoryRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="WH_MaterialCategoryRow"/> objects.</returns>
	protected virtual WH_MaterialCategoryRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				WH_MaterialCategoryRow record = new WH_MaterialCategoryRow();
		...
		return (WH_MaterialCategoryRow[])(recordList.ToArray(typeof(WH_MaterialCategoryRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="WH_MaterialCategoryRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="WH_MaterialCategoryRow"/> object.</returns>
	protected virtual WH_MaterialCategoryRow MapRow(DataRow row)
	{
		string LOCATION = "WH_MaterialCategoryRow MapRow(DataRow row)";
		WH_MaterialCategoryRow mappedObject = new WH_MaterialCategoryRow();
	...
	/// the <c>WH_MaterialCategory</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "WH_MaterialCategory";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="WH_MaterialCategoryRow"/> by the primary key.
	/// </summary>
	/// <param name="materialCategory_ID">The <c>MaterialCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="WH_MaterialCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int materialCategory_ID)
	{
