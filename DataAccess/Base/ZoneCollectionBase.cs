...
// <fileinfo name="Base\ZoneCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="ZoneCollection"/>. Provides methods 
/// for common database table operations. 
/// </summary>
/// <remarks>
/// Do not change this source code. Update the <see cref="ZoneCollection"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class ZoneCollectionBase
...
{	
	...
	public ZoneCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Zone";
	}

	public ZoneCollectionBase() : base()
	{
		this.TABLENAME = "Zone";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>Zone</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ZoneRow"/> objects.</returns>
	public virtual ZoneRow[] GetAll()
	{
	...
	/// includes all records from the <c>Zone</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>Zone</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Zone_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ZoneRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ZoneRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ZoneRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ZoneRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ZoneRow"/> objects that 
	...
	/// <returns>An array of <see cref="ZoneRow"/> objects.</returns>
	public ZoneRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ZoneRow"/> objects.</returns>
	public virtual ZoneRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ZoneRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Zone_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Zone_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ZoneRow"/> by the primary key.
	/// </summary>
	/// <param name="zone_ID">The <c>Zone_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ZoneRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ZoneRow GetByPrimaryKey(int zone_ID)
	{
		string LOCATION = "GetByPrimaryKey(int zone_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Zone_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Zone_ID", zone_ID);
			ZoneRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>Zone</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ZoneRow"/> object to be inserted.</param>
	public virtual void Insert(ZoneRow value)
	{
		string LOCATION = "Insert(ZoneRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Zone_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
			...
			if (value.IsWard_IDNull)
				...
				AddParameter(cmd, "Ward_ID", value.Ward_ID);
						...
						value.Zone_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>Zone</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ZoneRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ZoneRow value)
	{	
		string LOCATION = "Update(ZoneRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Zone_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Zone</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ZoneRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ZoneRow value)
		{
			string LOCATION = "Save(ZoneRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Zone_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Zone_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>Zone</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ZoneRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ZoneRow value)
	{
		return DeleteByPrimaryKey(value.Zone_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>Zone</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="zone_ID">The <c>Zone_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int zone_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int zone_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Zone_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Zone_ID", zone_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>Zone</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>Zone</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Zone_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>Zone</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Zone_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ZoneRow"/> objects.</returns>
	protected ZoneRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ZoneRow"/> objects.</returns>
	protected ZoneRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ZoneRow"/> objects.</returns>
	protected virtual ZoneRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		return (ZoneRow[])(recordList.ToArray(typeof(ZoneRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ZoneRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ZoneRow"/> object.</returns>
	protected virtual ZoneRow MapRow(DataRow row)
	{
		string LOCATION = "ZoneRow MapRow(DataRow row)";
		ZoneRow mappedObject = new ZoneRow();
	...
	/// <summary>
	/// Exist <see cref="ZoneRow"/> by the primary key.
	/// </summary>
	/// <param name="zone_ID">The <c>Zone_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ZoneRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int zone_ID)
	{
		string LOCATION = "Exist(int zone_ID)";
		IDbCommand cmd = _db.CreateCommand("Zone_GetByPrimaryKey", CommandType.StoredProcedure);
		AddParameter(cmd, "Zone_ID", zone_ID);
		ZoneRow[] tempArray = MapRecords(cmd);
		if( 0 == tempArray.Length)
