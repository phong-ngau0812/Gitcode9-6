...
// <fileinfo name="Base\QRCodeWarehouseRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="QRCodeWarehouseRow"/> that 
/// represents a record in the <c>QRCodeWarehouse</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="QRCodeWarehouseRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class QRCodeWarehouseRowBase
{
	/// _QRCodeWarehouse_ID
	private int _QRCodeWarehouse_ID;
	private bool _QRCodeWarehouse_IDNull = true;
	/// _QRCodeWarehouseType_ID
	private int _QRCodeWarehouseType_ID;
	private bool _QRCodeWarehouseType_IDNull = true;
	/// _product_ID
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="QRCodeWarehouseRowBase"/> class.
	/// </summary>
	public QRCodeWarehouseRowBase():base()
	{
		// EMPTY
	}
	...
	public bool IsQRCodeWarehouse_IDNull
	{
		...
		/// <summary>
		/// Gets or sets the <c>QRCodeWarehouseType_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>QRCodeWarehouseType_ID</c> column value.</value>
	public int QRCodeWarehouseType_ID
	{
		get
		{
			if (IsQRCodeWarehouseType_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _QRCodeWarehouseType_ID;
		}
		set
		{
			_QRCodeWarehouseType_IDNull = false;
			_QRCodeWarehouseType_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="QRCodeWarehouseType_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsQRCodeWarehouseType_IDNull
	{
		get
		{
			return _QRCodeWarehouseType_IDNull;
		}
		set
		{
			_QRCodeWarehouseType_IDNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		dynStr.Append("  QRCodeWarehouseType_ID=");
		if( IsQRCodeWarehouseType_IDNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.QRCodeWarehouseType_ID);
		// Product_ID
