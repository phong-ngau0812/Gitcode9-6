...
// <fileinfo name="Base\CustomerTypeCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class CustomerTypeCollectionBase
...
{	
	...
	public CustomerTypeCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "CustomerType";
	}

	public CustomerTypeCollectionBase() : base()
	{
		this.TABLENAME = "CustomerType";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>CustomerType</c> table.
	/// </summary>
	/// <returns>An array of <see cref="CustomerTypeRow"/> objects.</returns>
	public virtual CustomerTypeRow[] GetAll()
	{
	...
	/// includes all records from the <c>CustomerType</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>CustomerType</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("CustomerType_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="CustomerTypeRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="CustomerTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public CustomerTypeRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			CustomerTypeRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="CustomerTypeRow"/> objects that 
	...
	/// <returns>An array of <see cref="CustomerTypeRow"/> objects.</returns>
	public CustomerTypeRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="CustomerTypeRow"/> objects.</returns>
	public virtual CustomerTypeRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			CustomerTypeRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("CustomerType_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("CustomerType_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="CustomerTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="customerType_ID">The <c>CustomerType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="CustomerTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual CustomerTypeRow GetByPrimaryKey(int customerType_ID)
	{
		string LOCATION = "GetByPrimaryKey(int customerType_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("CustomerType_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "CustomerType_ID", customerType_ID);
			CustomerTypeRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>CustomerType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="CustomerTypeRow"/> object to be inserted.</param>
	public virtual void Insert(CustomerTypeRow value)
	{
		string LOCATION = "Insert(CustomerTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("CustomerType_Insert", CommandType.StoredProcedure);
					// Discount_ID
			if (value.IsDiscount_IDNull)
				AddParameter(cmd, "Discount_ID", DBNull.Value);
			else
			...
			if (value.IsSortNull)
				...
				AddParameter(cmd, "Sort", value.Sort);
						...
						value.CustomerType_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>CustomerType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="CustomerTypeRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(CustomerTypeRow value)
	{	
		string LOCATION = "Update(CustomerTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("CustomerType_Update", CommandType.StoredProcedure);
					// Discount_ID
			if (value.IsDiscount_IDNull)
				AddParameter(cmd, "Discount_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>CustomerType</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="CustomerTypeRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(CustomerTypeRow value)
		{
			string LOCATION = "Save(CustomerTypeRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("CustomerType_Save",CommandType.StoredProcedure);
					// Discount_ID
				if (value.IsDiscount_IDNull)
					AddParameter(cmd, "Discount_ID", DBNull.Value);
				else
					AddParameter(cmd, "Discount_ID", (object)(value.Discount_ID));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["CustomerType_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>CustomerType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="CustomerTypeRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(CustomerTypeRow value)
	{
		return DeleteByPrimaryKey(value.CustomerType_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>CustomerType</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="customerType_ID">The <c>CustomerType_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int customerType_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int customerType_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("CustomerType_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "CustomerType_ID", customerType_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>CustomerType</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>CustomerType</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("CustomerType_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>CustomerType</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("CustomerType_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="CustomerTypeRow"/> objects.</returns>
	protected CustomerTypeRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="CustomerTypeRow"/> objects.</returns>
	protected CustomerTypeRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="CustomerTypeRow"/> objects.</returns>
	protected virtual CustomerTypeRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		return (CustomerTypeRow[])(recordList.ToArray(typeof(CustomerTypeRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="CustomerTypeRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="CustomerTypeRow"/> object.</returns>
	protected virtual CustomerTypeRow MapRow(DataRow row)
	{
		string LOCATION = "CustomerTypeRow MapRow(DataRow row)";
		CustomerTypeRow mappedObject = new CustomerTypeRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "CustomerType";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="CustomerTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="customerType_ID">The <c>CustomerType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="CustomerTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int customerType_ID)
	{
