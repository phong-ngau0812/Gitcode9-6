...
// <fileinfo name="Base\BNN_NewsCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_NewsCollectionBase
...
{	
	...
	public BNN_NewsCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_News";
	}

	public BNN_NewsCollectionBase() : base()
	{
		this.TABLENAME = "BNN_News";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_News</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_NewsRow"/> objects.</returns>
	public virtual BNN_NewsRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_News</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_News</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_News_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_NewsRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_NewsRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_NewsRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_NewsRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_NewsRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_NewsRow"/> objects.</returns>
	public BNN_NewsRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_NewsRow"/> objects.</returns>
	public virtual BNN_NewsRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_NewsRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_News_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_News_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_NewsRow"/> by the primary key.
	/// </summary>
	/// <param name="news_ID">The <c>News_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_NewsRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_NewsRow GetByPrimaryKey(int news_ID)
	{
		string LOCATION = "GetByPrimaryKey(int news_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_News_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "News_ID", news_ID);
			BNN_NewsRow[] tempArray = MapRecords(cmd);
		...
		public virtual BNN_NewsRow GetNewsCategory(int newsCategory_ID)
		{
			string LOCATION = "GetNewsCategory(int newsCategory_ID)";
			try
			{
				IDbCommand cmd = _db.CreateCommand("sp_GetTinChuyenNgang", CommandType.StoredProcedure);
		...
		/// <summary>
		/// Adds a new record into the <c>BNN_News</c> table.
		/// </summary>
		/// <param name="value">The <see cref="BNN_NewsRow"/> object to be inserted.</param>
		public virtual void Insert(BNN_NewsRow value)
	{
		string LOCATION = "Insert(BNN_NewsRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_News_Insert", CommandType.StoredProcedure);
					// NewsCategory_ID
			if (value.IsNewsCategory_IDNull)
				AddParameter(cmd, "NewsCategory_ID", DBNull.Value);
			else
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
						...
						value.News_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_News</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_NewsRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_NewsRow value)
	{	
		string LOCATION = "Update(BNN_NewsRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_News_Update", CommandType.StoredProcedure);
					// NewsCategory_ID
			if (value.IsNewsCategory_IDNull)
				AddParameter(cmd, "NewsCategory_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_News</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_NewsRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_NewsRow value)
		{
			string LOCATION = "Save(BNN_NewsRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_News_Save",CommandType.StoredProcedure);
					// NewsCategory_ID
				if (value.IsNewsCategory_IDNull)
					AddParameter(cmd, "NewsCategory_ID", DBNull.Value);
				else
					AddParameter(cmd, "NewsCategory_ID", (object)(value.NewsCategory_ID));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["News_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_News</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_NewsRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_NewsRow value)
	{
		return DeleteByPrimaryKey(value.News_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_News</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="news_ID">The <c>News_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int news_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int news_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_News_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "News_ID", news_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_News</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_News</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_News_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_News</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_News_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_NewsRow"/> objects.</returns>
	protected BNN_NewsRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_NewsRow"/> objects.</returns>
	protected BNN_NewsRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_NewsRow"/> objects.</returns>
	protected virtual BNN_NewsRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_NewsRow record = new BNN_NewsRow();
				recordList.Add(record);

					record.News_ID = Convert.ToInt32(reader.GetValue(news_IDColumnIndex));
					if(!reader.IsDBNull(newsCategory_IDColumnIndex))
		...
		return (BNN_NewsRow[])(recordList.ToArray(typeof(BNN_NewsRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_NewsRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_NewsRow"/> object.</returns>
	protected virtual BNN_NewsRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_NewsRow MapRow(DataRow row)";
		BNN_NewsRow mappedObject = new BNN_NewsRow();
	...
	/// <summary>
	/// Exist <see cref="BNN_NewsRow"/> by the primary key.
	/// </summary>
	/// <param name="news_ID">The <c>News_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_NewsRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int news_ID)
	{
