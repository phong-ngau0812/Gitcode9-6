...
// <fileinfo name="Base\TestingCertificatesCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class TestingCertificatesCollectionBase
...
{	
	...
	public const string UploadFileColumnName  = "UploadFile";
	...
	public TestingCertificatesCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "TestingCertificates";
	}

	public TestingCertificatesCollectionBase() : base()
	{
		this.TABLENAME = "TestingCertificates";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>TestingCertificates</c> table.
	/// </summary>
	/// <returns>An array of <see cref="TestingCertificatesRow"/> objects.</returns>
	public virtual TestingCertificatesRow[] GetAll()
	{
	...
	/// includes all records from the <c>TestingCertificates</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>TestingCertificates</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("TestingCertificates_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="TestingCertificatesRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="TestingCertificatesRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public TestingCertificatesRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			TestingCertificatesRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="TestingCertificatesRow"/> objects that 
	...
	/// <returns>An array of <see cref="TestingCertificatesRow"/> objects.</returns>
	public TestingCertificatesRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="TestingCertificatesRow"/> objects.</returns>
	public virtual TestingCertificatesRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			TestingCertificatesRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("TestingCertificates_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("TestingCertificates_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="TestingCertificatesRow"/> by the primary key.
	/// </summary>
	/// <param name="testingCertificates_ID">The <c>TestingCertificates_ID</c> column value.</param>
	/// <returns>An instance of <see cref="TestingCertificatesRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual TestingCertificatesRow GetByPrimaryKey(int testingCertificates_ID)
	{
		string LOCATION = "GetByPrimaryKey(int testingCertificates_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("TestingCertificates_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "TestingCertificates_ID", testingCertificates_ID);
			TestingCertificatesRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>TestingCertificates</c> table.
	/// </summary>
	/// <param name="value">The <see cref="TestingCertificatesRow"/> object to be inserted.</param>
	public virtual void Insert(TestingCertificatesRow value)
	{
		string LOCATION = "Insert(TestingCertificatesRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("TestingCertificates_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
			...
			if (value.IsNameNull )
				...
				// UploadFile
			if (value.IsUploadFileNull )
				AddParameter(cmd, "UploadFile", DBNull.Value);
			else
				AddParameter(cmd, "UploadFile", value.UploadFile);
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.TestingCertificates_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>TestingCertificates</c> table.
	/// </summary>
	/// <param name="value">The <see cref="TestingCertificatesRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(TestingCertificatesRow value)
	{	
		string LOCATION = "Update(TestingCertificatesRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("TestingCertificates_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>TestingCertificates</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="TestingCertificatesRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(TestingCertificatesRow value)
		{
			string LOCATION = "Save(TestingCertificatesRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("TestingCertificates_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
				...
				if (value.IsUploadFileNull)
					...
					AddParameter(cmd, "UploadFile", (object)(value.UploadFile));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["TestingCertificates_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>TestingCertificates</c> table.
	/// </summary>
	/// <param name="value">The <see cref="TestingCertificatesRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(TestingCertificatesRow value)
	{
		return DeleteByPrimaryKey(value.TestingCertificates_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>TestingCertificates</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="testingCertificates_ID">The <c>TestingCertificates_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int testingCertificates_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int testingCertificates_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("TestingCertificates_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "TestingCertificates_ID", testingCertificates_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>TestingCertificates</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>TestingCertificates</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("TestingCertificates_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>TestingCertificates</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("TestingCertificates_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="TestingCertificatesRow"/> objects.</returns>
	protected TestingCertificatesRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="TestingCertificatesRow"/> objects.</returns>
	protected TestingCertificatesRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="TestingCertificatesRow"/> objects.</returns>
	protected virtual TestingCertificatesRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// UploadFile
		int uploadFileColumnIndex = reader.GetOrdinal("UploadFile");
		// Description
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				TestingCertificatesRow record = new TestingCertificatesRow();
				recordList.Add(record);

					record.TestingCertificates_ID = Convert.ToInt32(reader.GetValue(testingCertificates_IDColumnIndex));
					...
					if(!reader.IsDBNull(uploadFileColumnIndex))
						record.UploadFile = Convert.ToString(reader.GetValue(uploadFileColumnIndex));
		...
		return (TestingCertificatesRow[])(recordList.ToArray(typeof(TestingCertificatesRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="TestingCertificatesRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="TestingCertificatesRow"/> object.</returns>
	protected virtual TestingCertificatesRow MapRow(DataRow row)
	{
		string LOCATION = "TestingCertificatesRow MapRow(DataRow row)";
		TestingCertificatesRow mappedObject = new TestingCertificatesRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "TestingCertificates_ID"
		dataColumn = dataTable.Columns["TestingCertificates_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.TestingCertificates_ID = (int)(row[dataColumn]);
		...
		// Column "UploadFile"
		dataColumn = dataTable.Columns["UploadFile"];
		if (! row.IsNull(dataColumn) )
			mappedObject.UploadFile = (string)(row[dataColumn]);
		// Column "Description"
	...
	/// the <c>TestingCertificates</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "TestingCertificates";
		DataColumn dataColumn;
		// Create the "TestingCertificates_ID" column
		dataColumn = dataTable.Columns.Add("TestingCertificates_ID", typeof(int));
		...
		// Create the "UploadFile" column
		dataColumn = dataTable.Columns.Add("UploadFile", typeof(string));
	...
	/// <summary>
	/// Exist <see cref="TestingCertificatesRow"/> by the primary key.
	/// </summary>
	/// <param name="testingCertificates_ID">The <c>TestingCertificates_ID</c> column value.</param>
	/// <returns>An instance of <see cref="TestingCertificatesRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int testingCertificates_ID)
	{
