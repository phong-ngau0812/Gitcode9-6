...
// <fileinfo name="Base\BNN_BrandRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="BNN_BrandRow"/> that 
/// represents a record in the <c>BNN_Brand</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="BNN_BrandRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class BNN_BrandRowBase
{
	/// _brand_ID
	private int _brand_ID;
	private bool _brand_IDNull = true;
	/// _title
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="BNN_BrandRowBase"/> class.
	/// </summary>
	public BNN_BrandRowBase():base()
	{
		// EMPTY
	}

		/// <summary>
		/// Gets or sets the <c>Brand_ID</c> column value.
		/// </summary>
		/// <value>The <c>Brand_ID</c> column value.</value>
	public int Brand_ID
	{
		get
		{
	...
	/// <summary>
	/// Indicates whether the <see cref="Brand_ID"/>
	...
	public override string ToString()
	{
		...
		dynStr.Append(":");
		// Brand_ID
		dynStr.Append("  Brand_ID=");
		if( IsBrand_IDNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.Brand_ID);
