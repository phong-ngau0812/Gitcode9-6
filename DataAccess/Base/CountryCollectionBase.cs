...
// <fileinfo name="Base\CountryCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class CountryCollectionBase
...
{	
	...
	public CountryCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Country";
	}

	public CountryCollectionBase() : base()
	{
		this.TABLENAME = "Country";     
	}
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Country_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="CountryRow"/> objects.</returns>
	public virtual CountryRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			CountryRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Country_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Country_GetPageAdHoc", CommandType.StoredProcedure);
	...
	public virtual CountryRow GetByPrimaryKey(int country_ID)
	{
		...
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Country_GetByPrimaryKey", CommandType.StoredProcedure);
	...
	public virtual void Insert(CountryRow value)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("Country_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
	...
	{	
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("Country_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Country</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="CountryRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(CountryRow value)
		{
			string LOCATION = "Save(CountryRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Country_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
	...
	public virtual bool DeleteByPrimaryKey(int country_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("Country_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Country_ID", country_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Country_DeleteAdHoc", CommandType.StoredProcedure);
	...
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Country_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="CountryRow"/> objects.</returns>
	protected virtual CountryRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
	...
	{
		string LOCATION = "CountryRow MapRow(DataRow row)";
	...
	/// <summary>
	/// Exist <see cref="CountryRow"/> by the primary key.
	/// </summary>
	/// <param name="country_ID">The <c>Country_ID</c> column value.</param>
	/// <returns>An instance of <see cref="CountryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
