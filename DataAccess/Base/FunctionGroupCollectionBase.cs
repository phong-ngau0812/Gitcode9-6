...
// <fileinfo name="Base\FunctionGroupCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class FunctionGroupCollectionBase
...
{	
	...
	public FunctionGroupCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "FunctionGroup";
	}

	public FunctionGroupCollectionBase() : base()
	{
		this.TABLENAME = "FunctionGroup";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>FunctionGroup</c> table.
	/// </summary>
	/// <returns>An array of <see cref="FunctionGroupRow"/> objects.</returns>
	public virtual FunctionGroupRow[] GetAll()
	{
	...
	/// includes all records from the <c>FunctionGroup</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>FunctionGroup</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("FunctionGroup_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="FunctionGroupRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="FunctionGroupRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public FunctionGroupRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			FunctionGroupRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="FunctionGroupRow"/> objects that 
	...
	/// <returns>An array of <see cref="FunctionGroupRow"/> objects.</returns>
	public FunctionGroupRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="FunctionGroupRow"/> objects.</returns>
	public virtual FunctionGroupRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			FunctionGroupRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("FunctionGroup_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("FunctionGroup_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="FunctionGroupRow"/> by the primary key.
	/// </summary>
	/// <param name="functionGroup_ID">The <c>FunctionGroup_ID</c> column value.</param>
	/// <returns>An instance of <see cref="FunctionGroupRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual FunctionGroupRow GetByPrimaryKey(int functionGroup_ID)
	{
		string LOCATION = "GetByPrimaryKey(int functionGroup_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("FunctionGroup_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "FunctionGroup_ID", functionGroup_ID);
			FunctionGroupRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>FunctionGroup</c> table.
	/// </summary>
	/// <param name="value">The <see cref="FunctionGroupRow"/> object to be inserted.</param>
	public virtual void Insert(FunctionGroupRow value)
	{
		string LOCATION = "Insert(FunctionGroupRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("FunctionGroup_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsTypeNull)
				...
				AddParameter(cmd, "Type", value.Type);
						...
						value.FunctionGroup_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>FunctionGroup</c> table.
	/// </summary>
	/// <param name="value">The <see cref="FunctionGroupRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(FunctionGroupRow value)
	{	
		string LOCATION = "Update(FunctionGroupRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("FunctionGroup_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>FunctionGroup</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="FunctionGroupRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(FunctionGroupRow value)
		{
			string LOCATION = "Save(FunctionGroupRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("FunctionGroup_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["FunctionGroup_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>FunctionGroup</c> table.
	/// </summary>
	/// <param name="value">The <see cref="FunctionGroupRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(FunctionGroupRow value)
	{
		return DeleteByPrimaryKey(value.FunctionGroup_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>FunctionGroup</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="functionGroup_ID">The <c>FunctionGroup_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int functionGroup_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int functionGroup_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("FunctionGroup_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "FunctionGroup_ID", functionGroup_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>FunctionGroup</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>FunctionGroup</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("FunctionGroup_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>FunctionGroup</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("FunctionGroup_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="FunctionGroupRow"/> objects.</returns>
	protected FunctionGroupRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="FunctionGroupRow"/> objects.</returns>
	protected FunctionGroupRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="FunctionGroupRow"/> objects.</returns>
	protected virtual FunctionGroupRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				FunctionGroupRow record = new FunctionGroupRow();
				recordList.Add(record);
					...
					if(!reader.IsDBNull(countColumnIndex))
						record.Count = Convert.ToInt32(reader.GetValue(countColumnIndex));
		...
		return (FunctionGroupRow[])(recordList.ToArray(typeof(FunctionGroupRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="FunctionGroupRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="FunctionGroupRow"/> object.</returns>
	protected virtual FunctionGroupRow MapRow(DataRow row)
	{
		string LOCATION = "FunctionGroupRow MapRow(DataRow row)";
		FunctionGroupRow mappedObject = new FunctionGroupRow();
		...
		if (! row.IsNull(dataColumn) )
			mappedObject.Count = (int)(row[dataColumn]);
		// Column "Type"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "FunctionGroup";
		DataColumn dataColumn;
		...
		dataColumn = dataTable.Columns.Add("Count", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="FunctionGroupRow"/> by the primary key.
	/// </summary>
	/// <param name="functionGroup_ID">The <c>FunctionGroup_ID</c> column value.</param>
	/// <returns>An instance of <see cref="FunctionGroupRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int functionGroup_ID)
	{
