...
// <fileinfo name="Base\QRCodeWarehouseRegister_ESCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodeWarehouseRegister_ESCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string QRCodeWarehouseRegister_IDColumnName  = "QRCodeWarehouseRegister_ID";
	...
	public QRCodeWarehouseRegister_ESCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodeWarehouseRegister_ES";
	}

	public QRCodeWarehouseRegister_ESCollectionBase() : base()
	{
		this.TABLENAME = "QRCodeWarehouseRegister_ES";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodeWarehouseRegister_ESRow"/> objects.</returns>
	public virtual QRCodeWarehouseRegister_ESRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodeWarehouseRegister_ES_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodeWarehouseRegister_ESRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodeWarehouseRegister_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodeWarehouseRegister_ESRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodeWarehouseRegister_ESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodeWarehouseRegister_ESRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegister_ESRow"/> objects.</returns>
	public QRCodeWarehouseRegister_ESRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegister_ESRow"/> objects.</returns>
	public virtual QRCodeWarehouseRegister_ESRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodeWarehouseRegister_ESRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_ES_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_ES_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodeWarehouseRegister_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeWarehouseRegister_ID">The <c>QRCodeWarehouseRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeWarehouseRegister_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodeWarehouseRegister_ESRow GetByPrimaryKey(int qRCodeWarehouseRegister_ID)
	{
		string LOCATION = "GetByPrimaryKey(int qRCodeWarehouseRegister_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_ES_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodeWarehouseRegister_ID", qRCodeWarehouseRegister_ID);
			QRCodeWarehouseRegister_ESRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWarehouseRegister_ESRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodeWarehouseRegister_ESRow value)
	{
		string LOCATION = "Insert(QRCodeWarehouseRegister_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_ES_Insert", CommandType.StoredProcedure);
					// QRCodePackage_ID
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.QRCodeWarehouseRegister_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWarehouseRegister_ESRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodeWarehouseRegister_ESRow value)
	{	
		string LOCATION = "Update(QRCodeWarehouseRegister_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_ES_Update", CommandType.StoredProcedure);
					// QRCodePackage_ID
			if (value.IsQRCodePackage_IDNull)
				AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
			else
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
					...
					AddParameter(cmd, "QRCodeWarehouseRegister_ID", value.QRCodeWarehouseRegister_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodeWarehouseRegister_ES</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodeWarehouseRegister_ESRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodeWarehouseRegister_ESRow value)
		{
			string LOCATION = "Save(QRCodeWarehouseRegister_ESRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodeWarehouseRegister_ES_Save",CommandType.StoredProcedure);
					// QRCodePackage_ID
				if (value.IsQRCodePackage_IDNull)
					AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["QRCodeWarehouseRegister_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWarehouseRegister_ESRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodeWarehouseRegister_ESRow value)
	{
		return DeleteByPrimaryKey(value.QRCodeWarehouseRegister_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodeWarehouseRegister_ES</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="qRCodeWarehouseRegister_ID">The <c>QRCodeWarehouseRegister_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int qRCodeWarehouseRegister_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int qRCodeWarehouseRegister_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_ES_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodeWarehouseRegister_ID", qRCodeWarehouseRegister_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodeWarehouseRegister_ES</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodeWarehouseRegister_ES</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_ES_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodeWarehouseRegister_ES_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegister_ESRow"/> objects.</returns>
	protected QRCodeWarehouseRegister_ESRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegister_ESRow"/> objects.</returns>
	protected QRCodeWarehouseRegister_ESRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodeWarehouseRegister_ESRow"/> objects.</returns>
	protected virtual QRCodeWarehouseRegister_ESRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		int qRCodeWarehouseRegister_IDColumnIndex = reader.GetOrdinal("QRCodeWarehouseRegister_ID");
		// QRCodePackage_ID
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodeWarehouseRegister_ESRow record = new QRCodeWarehouseRegister_ESRow();
				recordList.Add(record);

					record.QRCodeWarehouseRegister_ID = Convert.ToInt32(reader.GetValue(qRCodeWarehouseRegister_IDColumnIndex));
		...
		return (QRCodeWarehouseRegister_ESRow[])(recordList.ToArray(typeof(QRCodeWarehouseRegister_ESRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodeWarehouseRegister_ESRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodeWarehouseRegister_ESRow"/> object.</returns>
	protected virtual QRCodeWarehouseRegister_ESRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodeWarehouseRegister_ESRow MapRow(DataRow row)";
		QRCodeWarehouseRegister_ESRow mappedObject = new QRCodeWarehouseRegister_ESRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "QRCodeWarehouseRegister_ID"
		dataColumn = dataTable.Columns["QRCodeWarehouseRegister_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.QRCodeWarehouseRegister_ID = (int)(row[dataColumn]);
	...
	/// the <c>QRCodeWarehouseRegister_ES</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodeWarehouseRegister_ES";
		DataColumn dataColumn;
		// Create the "QRCodeWarehouseRegister_ID" column
		dataColumn = dataTable.Columns.Add("QRCodeWarehouseRegister_ID", typeof(int));
	...
	protected virtual IDbDataParameter AddParameter(IDbCommand cmd, String paramName, object value)
	{
		...
		switch(paramName)
		{
			case "QRCodeWarehouseRegister_ID":
	...
	/// <summary>
	/// Exist <see cref="QRCodeWarehouseRegister_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeWarehouseRegister_ID">The <c>QRCodeWarehouseRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeWarehouseRegister_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int qRCodeWarehouseRegister_ID)
	{
