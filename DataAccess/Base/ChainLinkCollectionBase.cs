...
// <fileinfo name="Base\ChainLinkCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ChainLinkCollectionBase
...
{	
	...
	public ChainLinkCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "ChainLink";
	}

	public ChainLinkCollectionBase() : base()
	{
		this.TABLENAME = "ChainLink";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>ChainLink</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ChainLinkRow"/> objects.</returns>
	public virtual ChainLinkRow[] GetAll()
	{
	...
	/// includes all records from the <c>ChainLink</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>ChainLink</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("ChainLink_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ChainLinkRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ChainLinkRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ChainLinkRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ChainLinkRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ChainLinkRow"/> objects that 
	...
	/// <returns>An array of <see cref="ChainLinkRow"/> objects.</returns>
	public ChainLinkRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ChainLinkRow"/> objects.</returns>
	public virtual ChainLinkRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ChainLinkRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ChainLink_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ChainLink_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ChainLinkRow"/> by the primary key.
	/// </summary>
	/// <param name="chainLink_ID">The <c>ChainLink_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ChainLinkRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ChainLinkRow GetByPrimaryKey(int chainLink_ID)
	{
		string LOCATION = "GetByPrimaryKey(int chainLink_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("ChainLink_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "ChainLink_ID", chainLink_ID);
			ChainLinkRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>ChainLink</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ChainLinkRow"/> object to be inserted.</param>
	public virtual void Insert(ChainLinkRow value)
	{
		string LOCATION = "Insert(ChainLinkRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ChainLink_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsSortNull)
				...
				AddParameter(cmd, "Sort", value.Sort);
						...
						value.ChainLink_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>ChainLink</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ChainLinkRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ChainLinkRow value)
	{	
		string LOCATION = "Update(ChainLinkRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ChainLink_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>ChainLink</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ChainLinkRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ChainLinkRow value)
		{
			string LOCATION = "Save(ChainLinkRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("ChainLink_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["ChainLink_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>ChainLink</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ChainLinkRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ChainLinkRow value)
	{
		return DeleteByPrimaryKey(value.ChainLink_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>ChainLink</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="chainLink_ID">The <c>ChainLink_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int chainLink_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int chainLink_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ChainLink_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "ChainLink_ID", chainLink_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>ChainLink</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>ChainLink</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ChainLink_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>ChainLink</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("ChainLink_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ChainLinkRow"/> objects.</returns>
	protected ChainLinkRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ChainLinkRow"/> objects.</returns>
	protected ChainLinkRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ChainLinkRow"/> objects.</returns>
	protected virtual ChainLinkRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ChainLinkRow record = new ChainLinkRow();
		...
		return (ChainLinkRow[])(recordList.ToArray(typeof(ChainLinkRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ChainLinkRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ChainLinkRow"/> object.</returns>
	protected virtual ChainLinkRow MapRow(DataRow row)
	{
		string LOCATION = "ChainLinkRow MapRow(DataRow row)";
		ChainLinkRow mappedObject = new ChainLinkRow();
	...
	/// <summary>
	/// Exist <see cref="ChainLinkRow"/> by the primary key.
	/// </summary>
	/// <param name="chainLink_ID">The <c>ChainLink_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ChainLinkRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int chainLink_ID)
	{
