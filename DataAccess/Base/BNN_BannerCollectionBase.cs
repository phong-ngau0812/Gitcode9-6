...
// <fileinfo name="Base\BNN_BannerCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_BannerCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string Banner_IDColumnName  = "Banner_ID";
	public const string PositionBanner_IDColumnName  = "PositionBanner_ID";
	...
	public BNN_BannerCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_Banner";
	}

	public BNN_BannerCollectionBase() : base()
	{
		this.TABLENAME = "BNN_Banner";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_Banner</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_BannerRow"/> objects.</returns>
	public virtual BNN_BannerRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_Banner</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_Banner</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_Banner_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_BannerRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_BannerRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_BannerRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_BannerRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_BannerRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_BannerRow"/> objects.</returns>
	public BNN_BannerRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_BannerRow"/> objects.</returns>
	public virtual BNN_BannerRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_BannerRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Banner_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Banner_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_BannerRow"/> by the primary key.
	/// </summary>
	/// <param name="banner_ID">The <c>Banner_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_BannerRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_BannerRow GetByPrimaryKey(int banner_ID)
	{
		string LOCATION = "GetByPrimaryKey(int banner_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_Banner_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Banner_ID", banner_ID);
			BNN_BannerRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_Banner</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BannerRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_BannerRow value)
	{
		string LOCATION = "Insert(BNN_BannerRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Banner_Insert", CommandType.StoredProcedure);
					// PositionBanner_ID
			if (value.IsPositionBanner_IDNull)
				AddParameter(cmd, "PositionBanner_ID", DBNull.Value);
			else
				AddParameter(cmd, "PositionBanner_ID", value.PositionBanner_ID);
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
						...
						value.Banner_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_Banner</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BannerRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_BannerRow value)
	{	
		string LOCATION = "Update(BNN_BannerRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Banner_Update", CommandType.StoredProcedure);
					// PositionBanner_ID
			if (value.IsPositionBanner_IDNull)
				AddParameter(cmd, "PositionBanner_ID", DBNull.Value);
			else
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
					...
					AddParameter(cmd, "Banner_ID", value.Banner_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_Banner</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_BannerRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_BannerRow value)
		{
			string LOCATION = "Save(BNN_BannerRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_Banner_Save",CommandType.StoredProcedure);
					// PositionBanner_ID
				if (value.IsPositionBanner_IDNull)
					AddParameter(cmd, "PositionBanner_ID", DBNull.Value);
				else
					AddParameter(cmd, "PositionBanner_ID", (object)(value.PositionBanner_ID));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Banner_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_Banner</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BannerRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_BannerRow value)
	{
		return DeleteByPrimaryKey(value.Banner_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_Banner</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="banner_ID">The <c>Banner_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int banner_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int banner_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Banner_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Banner_ID", banner_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_Banner</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_Banner</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Banner_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_Banner</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_Banner_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_BannerRow"/> objects.</returns>
	protected BNN_BannerRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_BannerRow"/> objects.</returns>
	protected BNN_BannerRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_BannerRow"/> objects.</returns>
	protected virtual BNN_BannerRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// Banner_ID
		int banner_IDColumnIndex = reader.GetOrdinal("Banner_ID");
		// PositionBanner_ID
		int positionBanner_IDColumnIndex = reader.GetOrdinal("PositionBanner_ID");
		// Title
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_BannerRow record = new BNN_BannerRow();
				recordList.Add(record);

					record.Banner_ID = Convert.ToInt32(reader.GetValue(banner_IDColumnIndex));
					if(!reader.IsDBNull(positionBanner_IDColumnIndex))
						record.PositionBanner_ID = Convert.ToInt32(reader.GetValue(positionBanner_IDColumnIndex));
		...
		return (BNN_BannerRow[])(recordList.ToArray(typeof(BNN_BannerRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_BannerRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_BannerRow"/> object.</returns>
	protected virtual BNN_BannerRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_BannerRow MapRow(DataRow row)";
		BNN_BannerRow mappedObject = new BNN_BannerRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "Banner_ID"
		dataColumn = dataTable.Columns["Banner_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Banner_ID = (int)(row[dataColumn]);
		// Column "PositionBanner_ID"
		dataColumn = dataTable.Columns["PositionBanner_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.PositionBanner_ID = (int)(row[dataColumn]);
		// Column "Title"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_Banner";
		DataColumn dataColumn;
		// Create the "Banner_ID" column
		dataColumn = dataTable.Columns.Add("Banner_ID", typeof(int));
		dataColumn.AllowDBNull = false;
		dataColumn.ReadOnly = true;
		dataColumn.Unique = true;
		dataColumn.AutoIncrement = true;
		// Create the "PositionBanner_ID" column
		dataColumn = dataTable.Columns.Add("PositionBanner_ID", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="BNN_BannerRow"/> by the primary key.
	/// </summary>
	/// <param name="banner_ID">The <c>Banner_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_BannerRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int banner_ID)
	{
