...
// <fileinfo name="Base\BusinessTypeCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BusinessTypeCollectionBase
...
{	
	...
	public BusinessTypeCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BusinessType";
	}

	public BusinessTypeCollectionBase() : base()
	{
		this.TABLENAME = "BusinessType";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BusinessType</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BusinessTypeRow"/> objects.</returns>
	public virtual BusinessTypeRow[] GetAll()
	{
	...
	/// includes all records from the <c>BusinessType</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BusinessType</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BusinessType_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BusinessTypeRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BusinessTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BusinessTypeRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BusinessTypeRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BusinessTypeRow"/> objects that 
	...
	/// <returns>An array of <see cref="BusinessTypeRow"/> objects.</returns>
	public BusinessTypeRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BusinessTypeRow"/> objects.</returns>
	public virtual BusinessTypeRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BusinessTypeRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BusinessType_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BusinessType_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BusinessTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="businessType_ID">The <c>BusinessType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BusinessTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BusinessTypeRow GetByPrimaryKey(int businessType_ID)
	{
		string LOCATION = "GetByPrimaryKey(int businessType_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BusinessType_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "BusinessType_ID", businessType_ID);
			BusinessTypeRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BusinessType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BusinessTypeRow"/> object to be inserted.</param>
	public virtual void Insert(BusinessTypeRow value)
	{
		string LOCATION = "Insert(BusinessTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BusinessType_Insert", CommandType.StoredProcedure);
					// Branch_ID
			...
			if (value.IsStatusNull)
				...
				AddParameter(cmd, "Status", value.Status);
						...
						value.BusinessType_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BusinessType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BusinessTypeRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BusinessTypeRow value)
	{	
		string LOCATION = "Update(BusinessTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BusinessType_Update", CommandType.StoredProcedure);
					// Branch_ID
			if (value.IsBranch_IDNull)
				AddParameter(cmd, "Branch_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BusinessType</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BusinessTypeRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BusinessTypeRow value)
		{
			string LOCATION = "Save(BusinessTypeRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BusinessType_Save",CommandType.StoredProcedure);
					// Branch_ID
				if (value.IsBranch_IDNull)
					AddParameter(cmd, "Branch_ID", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["BusinessType_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BusinessType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BusinessTypeRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BusinessTypeRow value)
	{
		return DeleteByPrimaryKey(value.BusinessType_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BusinessType</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="businessType_ID">The <c>BusinessType_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int businessType_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int businessType_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BusinessType_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "BusinessType_ID", businessType_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BusinessType</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BusinessType</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BusinessType_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BusinessType</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BusinessType_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BusinessTypeRow"/> objects.</returns>
	protected BusinessTypeRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BusinessTypeRow"/> objects.</returns>
	protected BusinessTypeRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BusinessTypeRow"/> objects.</returns>
	protected virtual BusinessTypeRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BusinessTypeRow record = new BusinessTypeRow();
		...
		return (BusinessTypeRow[])(recordList.ToArray(typeof(BusinessTypeRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BusinessTypeRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BusinessTypeRow"/> object.</returns>
	protected virtual BusinessTypeRow MapRow(DataRow row)
	{
		string LOCATION = "BusinessTypeRow MapRow(DataRow row)";
		BusinessTypeRow mappedObject = new BusinessTypeRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BusinessType";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="BusinessTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="businessType_ID">The <c>BusinessType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BusinessTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int businessType_ID)
	{
