...
// <fileinfo name="Base\BNN_RegionCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_RegionCollectionBase
...
{	
	...
	public const string ImageSvgColumnName  = "ImageSvg";
	...
	public BNN_RegionCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_Region";
	}

	public BNN_RegionCollectionBase() : base()
	{
		this.TABLENAME = "BNN_Region";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_Region</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_RegionRow"/> objects.</returns>
	public virtual BNN_RegionRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_Region</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_Region</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_Region_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_RegionRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_RegionRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_RegionRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_RegionRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_RegionRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_RegionRow"/> objects.</returns>
	public BNN_RegionRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_RegionRow"/> objects.</returns>
	public virtual BNN_RegionRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_RegionRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Region_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Region_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_RegionRow"/> by the primary key.
	/// </summary>
	/// <param name="region_ID">The <c>Region_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_RegionRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_RegionRow GetByPrimaryKey(int region_ID)
	{
		string LOCATION = "GetByPrimaryKey(int region_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_Region_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Region_ID", region_ID);
			BNN_RegionRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_Region</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_RegionRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_RegionRow value)
	{
		string LOCATION = "Insert(BNN_RegionRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Region_Insert", CommandType.StoredProcedure);
					// Title
			...
			if (value.IsImageNull )
				...
				// ImageSvg
			if (value.IsImageSvgNull )
				AddParameter(cmd, "ImageSvg", DBNull.Value);
			else
				AddParameter(cmd, "ImageSvg", value.ImageSvg);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_Region</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_RegionRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_RegionRow value)
	{	
		string LOCATION = "Update(BNN_RegionRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Region_Update", CommandType.StoredProcedure);
					// Title
			if (value.IsTitleNull)
				AddParameter(cmd, "Title", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_Region</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_RegionRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_RegionRow value)
		{
			string LOCATION = "Save(BNN_RegionRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_Region_Save",CommandType.StoredProcedure);
					// Title
				if (value.IsTitleNull)
					AddParameter(cmd, "Title", DBNull.Value);
				else
				...
				if (value.IsImageSvgNull)
					...
					AddParameter(cmd, "ImageSvg", (object)(value.ImageSvg));
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_Region</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_RegionRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_RegionRow value)
	{
		return DeleteByPrimaryKey(value.Region_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_Region</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int region_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Region_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Region_ID", region_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_Region</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_Region</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Region_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_Region</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_Region_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_RegionRow"/> objects.</returns>
	protected BNN_RegionRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_RegionRow"/> objects.</returns>
	protected BNN_RegionRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_RegionRow"/> objects.</returns>
	protected virtual BNN_RegionRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// ImageSvg
		int imageSvgColumnIndex = reader.GetOrdinal("ImageSvg");
		// CreateDate
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_RegionRow record = new BNN_RegionRow();
				recordList.Add(record);
					...
					if(!reader.IsDBNull(imageSvgColumnIndex))
						record.ImageSvg = Convert.ToString(reader.GetValue(imageSvgColumnIndex));
		...
		return (BNN_RegionRow[])(recordList.ToArray(typeof(BNN_RegionRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_RegionRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_RegionRow"/> object.</returns>
	protected virtual BNN_RegionRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_RegionRow MapRow(DataRow row)";
		BNN_RegionRow mappedObject = new BNN_RegionRow();
		...
		// Column "ImageSvg"
		dataColumn = dataTable.Columns["ImageSvg"];
		if (! row.IsNull(dataColumn) )
			mappedObject.ImageSvg = (string)(row[dataColumn]);
		// Column "CreateDate"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_Region";
		DataColumn dataColumn;
		...
		dataColumn.MaxLength = 500;
		// Create the "ImageSvg" column
		dataColumn = dataTable.Columns.Add("ImageSvg", typeof(string));
		dataColumn.MaxLength = 1073741823;
	...
	/// <summary>
	/// Exist <see cref="BNN_RegionRow"/> by the primary key.
	/// </summary>
	/// <param name="region_ID">The <c>Region_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_RegionRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
