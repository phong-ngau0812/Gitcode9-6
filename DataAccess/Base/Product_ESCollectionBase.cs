...
// <fileinfo name="Base\Product_ESCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class Product_ESCollectionBase
...
{	
	...
	public Product_ESCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Product_ES";
	}

	public Product_ESCollectionBase() : base()
	{
		this.TABLENAME = "Product_ES";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>Product_ES</c> table.
	/// </summary>
	/// <returns>An array of <see cref="Product_ESRow"/> objects.</returns>
	public virtual Product_ESRow[] GetAll()
	{
	...
	/// includes all records from the <c>Product_ES</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>Product_ES</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Product_ES_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="Product_ESRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="Product_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public Product_ESRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			Product_ESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="Product_ESRow"/> objects that 
	...
	/// <returns>An array of <see cref="Product_ESRow"/> objects.</returns>
	public Product_ESRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="Product_ESRow"/> objects.</returns>
	public virtual Product_ESRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			Product_ESRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Product_ES_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Product_ES_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="Product_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="product_ID">The <c>Product_ID</c> column value.</param>
	/// <returns>An instance of <see cref="Product_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual Product_ESRow GetByPrimaryKey(int product_ID)
	{
		string LOCATION = "GetByPrimaryKey(int product_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Product_ES_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Product_ID", product_ID);
			Product_ESRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>Product_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="Product_ESRow"/> object to be inserted.</param>
	public virtual void Insert(Product_ESRow value)
	{
		string LOCATION = "Insert(Product_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Product_ES_Insert", CommandType.StoredProcedure);
					// Store_ID
	...
	/// <summary>
	/// Updates a record in the <c>Product_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="Product_ESRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(Product_ESRow value)
	{	
		string LOCATION = "Update(Product_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Product_ES_Update", CommandType.StoredProcedure);
					// Store_ID
			if (value.IsStore_IDNull)
				AddParameter(cmd, "Store_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Product_ES</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="Product_ESRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(Product_ESRow value)
		{
			string LOCATION = "Save(Product_ESRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Product_ES_Save",CommandType.StoredProcedure);
					// Store_ID
				if (value.IsStore_IDNull)
					AddParameter(cmd, "Store_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>Product_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="Product_ESRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(Product_ESRow value)
	{
		return DeleteByPrimaryKey(value.Product_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>Product_ES</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int product_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("Product_ES_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Product_ID", product_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>Product_ES</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>Product_ES</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Product_ES_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>Product_ES</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Product_ES_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="Product_ESRow"/> objects.</returns>
	protected Product_ESRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="Product_ESRow"/> objects.</returns>
	protected Product_ESRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="Product_ESRow"/> objects.</returns>
	protected virtual Product_ESRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				Product_ESRow record = new Product_ESRow();
		...
		return (Product_ESRow[])(recordList.ToArray(typeof(Product_ESRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="Product_ESRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="Product_ESRow"/> object.</returns>
	protected virtual Product_ESRow MapRow(DataRow row)
	{
		string LOCATION = "Product_ESRow MapRow(DataRow row)";
		Product_ESRow mappedObject = new Product_ESRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "Product_ES";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="Product_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="product_ID">The <c>Product_ID</c> column value.</param>
	/// <returns>An instance of <see cref="Product_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
