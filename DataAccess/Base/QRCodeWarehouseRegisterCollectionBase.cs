...
// <fileinfo name="Base\QRCodeWarehouseRegisterCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodeWarehouseRegisterCollectionBase
...
{	
	...
	public QRCodeWarehouseRegisterCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodeWarehouseRegister";
	}

	public QRCodeWarehouseRegisterCollectionBase() : base()
	{
		this.TABLENAME = "QRCodeWarehouseRegister";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodeWarehouseRegisterRow"/> objects.</returns>
	public virtual QRCodeWarehouseRegisterRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodeWarehouseRegister_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodeWarehouseRegisterRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodeWarehouseRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodeWarehouseRegisterRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodeWarehouseRegisterRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodeWarehouseRegisterRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegisterRow"/> objects.</returns>
	public QRCodeWarehouseRegisterRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegisterRow"/> objects.</returns>
	public virtual QRCodeWarehouseRegisterRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodeWarehouseRegisterRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodeWarehouseRegisterRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeWarehouseRegister_ID">The <c>QRCodeWarehouseRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeWarehouseRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodeWarehouseRegisterRow GetByPrimaryKey(int qRCodeWarehouseRegister_ID)
	{
		string LOCATION = "GetByPrimaryKey(int qRCodeWarehouseRegister_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodeWarehouseRegister_ID", qRCodeWarehouseRegister_ID);
			QRCodeWarehouseRegisterRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWarehouseRegisterRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodeWarehouseRegisterRow value)
	{
		string LOCATION = "Insert(QRCodeWarehouseRegisterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_Insert", CommandType.StoredProcedure);
					// QRCodePackage_ID
	...
	/// <summary>
	/// Updates a record in the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWarehouseRegisterRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodeWarehouseRegisterRow value)
	{	
		string LOCATION = "Update(QRCodeWarehouseRegisterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_Update", CommandType.StoredProcedure);
					// QRCodePackage_ID
			if (value.IsQRCodePackage_IDNull)
				AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodeWarehouseRegister</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodeWarehouseRegisterRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodeWarehouseRegisterRow value)
		{
			string LOCATION = "Save(QRCodeWarehouseRegisterRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodeWarehouseRegister_Save",CommandType.StoredProcedure);
					// QRCodePackage_ID
				if (value.IsQRCodePackage_IDNull)
					AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWarehouseRegisterRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodeWarehouseRegisterRow value)
	{
		return DeleteByPrimaryKey(value.QRCodeWarehouseRegister_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodeWarehouseRegister</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int qRCodeWarehouseRegister_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodeWarehouseRegister_ID", qRCodeWarehouseRegister_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodeWarehouseRegister</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodeWarehouseRegister</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWarehouseRegister_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodeWarehouseRegister_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegisterRow"/> objects.</returns>
	protected QRCodeWarehouseRegisterRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodeWarehouseRegisterRow"/> objects.</returns>
	protected QRCodeWarehouseRegisterRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodeWarehouseRegisterRow"/> objects.</returns>
	protected virtual QRCodeWarehouseRegisterRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodeWarehouseRegisterRow record = new QRCodeWarehouseRegisterRow();
		...
		return (QRCodeWarehouseRegisterRow[])(recordList.ToArray(typeof(QRCodeWarehouseRegisterRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodeWarehouseRegisterRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodeWarehouseRegisterRow"/> object.</returns>
	protected virtual QRCodeWarehouseRegisterRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodeWarehouseRegisterRow MapRow(DataRow row)";
		QRCodeWarehouseRegisterRow mappedObject = new QRCodeWarehouseRegisterRow();
	...
	/// the <c>QRCodeWarehouseRegister</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodeWarehouseRegister";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="QRCodeWarehouseRegisterRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeWarehouseRegister_ID">The <c>QRCodeWarehouseRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeWarehouseRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
