...
// <fileinfo name="Base\ProductTypeCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ProductTypeCollectionBase
...
{	
	...
	public ProductTypeCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "ProductType";
	}

	public ProductTypeCollectionBase() : base()
	{
		this.TABLENAME = "ProductType";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>ProductType</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ProductTypeRow"/> objects.</returns>
	public virtual ProductTypeRow[] GetAll()
	{
	...
	/// includes all records from the <c>ProductType</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>ProductType</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("ProductType_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ProductTypeRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ProductTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ProductTypeRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ProductTypeRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ProductTypeRow"/> objects that 
	...
	/// <returns>An array of <see cref="ProductTypeRow"/> objects.</returns>
	public ProductTypeRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ProductTypeRow"/> objects.</returns>
	public virtual ProductTypeRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ProductTypeRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductType_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductType_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ProductTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="productType_ID">The <c>ProductType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ProductTypeRow GetByPrimaryKey(int productType_ID)
	{
		string LOCATION = "GetByPrimaryKey(int productType_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("ProductType_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "ProductType_ID", productType_ID);
			ProductTypeRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>ProductType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductTypeRow"/> object to be inserted.</param>
	public virtual void Insert(ProductTypeRow value)
	{
		string LOCATION = "Insert(ProductTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductType_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.ProductType_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>ProductType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductTypeRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ProductTypeRow value)
	{	
		string LOCATION = "Update(ProductTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductType_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>ProductType</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ProductTypeRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ProductTypeRow value)
		{
			string LOCATION = "Save(ProductTypeRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("ProductType_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["ProductType_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>ProductType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductTypeRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ProductTypeRow value)
	{
		return DeleteByPrimaryKey(value.ProductType_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>ProductType</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="productType_ID">The <c>ProductType_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int productType_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int productType_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductType_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "ProductType_ID", productType_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>ProductType</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>ProductType</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductType_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>ProductType</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("ProductType_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ProductTypeRow"/> objects.</returns>
	protected ProductTypeRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ProductTypeRow"/> objects.</returns>
	protected ProductTypeRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ProductTypeRow"/> objects.</returns>
	protected virtual ProductTypeRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ProductTypeRow record = new ProductTypeRow();
		...
		return (ProductTypeRow[])(recordList.ToArray(typeof(ProductTypeRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ProductTypeRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ProductTypeRow"/> object.</returns>
	protected virtual ProductTypeRow MapRow(DataRow row)
	{
		string LOCATION = "ProductTypeRow MapRow(DataRow row)";
		ProductTypeRow mappedObject = new ProductTypeRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "ProductType";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="ProductTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="productType_ID">The <c>ProductType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int productType_ID)
	{
