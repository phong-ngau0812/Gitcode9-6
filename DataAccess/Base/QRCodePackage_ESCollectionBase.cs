...
// <fileinfo name="Base\QRCodePackage_ESCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodePackage_ESCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string QRCodePackage_IDColumnName  = "QRCodePackage_ID";
	public const string QRCodePackageType_IDColumnName  = "QRCodePackageType_ID";
	...
	public const string AudioPublicColumnName  = "AudioPublic";
	public const string AudioSoldColumnName  = "AudioSold";
	public const string AudioIDEColumnName  = "AudioIDE";
	public const string MessagePublicColumnName  = "MessagePublic";
	public const string MessageSoldColumnName  = "MessageSold";
	public const string MessageIDEColumnName  = "MessageIDE";
	...
	public QRCodePackage_ESCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodePackage_ES";
	}

	public QRCodePackage_ESCollectionBase() : base()
	{
		this.TABLENAME = "QRCodePackage_ES";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodePackage_ES</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodePackage_ESRow"/> objects.</returns>
	public virtual QRCodePackage_ESRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodePackage_ES</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodePackage_ES</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodePackage_ES_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodePackage_ESRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodePackage_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodePackage_ESRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodePackage_ESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodePackage_ESRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodePackage_ESRow"/> objects.</returns>
	public QRCodePackage_ESRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodePackage_ESRow"/> objects.</returns>
	public virtual QRCodePackage_ESRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodePackage_ESRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_ES_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_ES_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodePackage_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePackage_ID">The <c>QRCodePackage_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePackage_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodePackage_ESRow GetByPrimaryKey(int qRCodePackage_ID)
	{
		string LOCATION = "GetByPrimaryKey(int qRCodePackage_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_ES_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodePackage_ID", qRCodePackage_ID);
			QRCodePackage_ESRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodePackage_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackage_ESRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodePackage_ESRow value)
	{
		string LOCATION = "Insert(QRCodePackage_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackage_ES_Insert", CommandType.StoredProcedure);
					// QRCodePackageType_ID
			if (value.IsQRCodePackageType_IDNull)
				AddParameter(cmd, "QRCodePackageType_ID", DBNull.Value);
			else
				AddParameter(cmd, "QRCodePackageType_ID", value.QRCodePackageType_ID);
			...
			if (value.IsFarmGroupNameNull )
				...
				// AudioPublic
			if (value.IsAudioPublicNull)
				AddParameter(cmd, "AudioPublic", DBNull.Value);
			else
				AddParameter(cmd, "AudioPublic", value.AudioPublic);
			
				// AudioSold
			if (value.IsAudioSoldNull)
				AddParameter(cmd, "AudioSold", DBNull.Value);
			else
				AddParameter(cmd, "AudioSold", value.AudioSold);
			
				// AudioIDE
			if (value.IsAudioIDENull)
				AddParameter(cmd, "AudioIDE", DBNull.Value);
			else
				AddParameter(cmd, "AudioIDE", value.AudioIDE);
			
				// MessagePublic
			if (value.IsMessagePublicNull)
				AddParameter(cmd, "MessagePublic", DBNull.Value);
			else
				AddParameter(cmd, "MessagePublic", value.MessagePublic);
			
				// MessageSold
			if (value.IsMessageSoldNull)
				AddParameter(cmd, "MessageSold", DBNull.Value);
			else
				AddParameter(cmd, "MessageSold", value.MessageSold);
			
				// MessageIDE
			if (value.IsMessageIDENull)
				AddParameter(cmd, "MessageIDE", DBNull.Value);
			else
				AddParameter(cmd, "MessageIDE", value.MessageIDE);
			
						value.QRCodePackage_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>QRCodePackage_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackage_ESRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodePackage_ESRow value)
	{	
		string LOCATION = "Update(QRCodePackage_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackage_ES_Update", CommandType.StoredProcedure);
					// QRCodePackageType_ID
			if (value.IsQRCodePackageType_IDNull)
				AddParameter(cmd, "QRCodePackageType_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodePackage_ES</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodePackage_ESRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodePackage_ESRow value)
		{
			string LOCATION = "Save(QRCodePackage_ESRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodePackage_ES_Save",CommandType.StoredProcedure);
					// QRCodePackageType_ID
				if (value.IsQRCodePackageType_IDNull)
					AddParameter(cmd, "QRCodePackageType_ID", DBNull.Value);
				else
					AddParameter(cmd, "QRCodePackageType_ID", (object)(value.QRCodePackageType_ID));
				...
				if (value.IsAudioPublicNull)
					...
					AddParameter(cmd, "AudioPublic", (object)(value.AudioPublic));
				
					// AudioSold
				if (value.IsAudioSoldNull)
					AddParameter(cmd, "AudioSold", DBNull.Value);
				else
					AddParameter(cmd, "AudioSold", (object)(value.AudioSold));
				
					// AudioIDE
				if (value.IsAudioIDENull)
					AddParameter(cmd, "AudioIDE", DBNull.Value);
				else
					AddParameter(cmd, "AudioIDE", (object)(value.AudioIDE));
				
					// MessagePublic
				if (value.IsMessagePublicNull)
					AddParameter(cmd, "MessagePublic", DBNull.Value);
				else
					AddParameter(cmd, "MessagePublic", (object)(value.MessagePublic));
				
					// MessageSold
				if (value.IsMessageSoldNull)
					AddParameter(cmd, "MessageSold", DBNull.Value);
				else
					AddParameter(cmd, "MessageSold", (object)(value.MessageSold));
				
					// MessageIDE
				if (value.IsMessageIDENull)
					AddParameter(cmd, "MessageIDE", DBNull.Value);
				else
					AddParameter(cmd, "MessageIDE", (object)(value.MessageIDE));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["QRCodePackage_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodePackage_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackage_ESRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodePackage_ESRow value)
	{
		return DeleteByPrimaryKey(value.QRCodePackage_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodePackage_ES</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="qRCodePackage_ID">The <c>QRCodePackage_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int qRCodePackage_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int qRCodePackage_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackage_ES_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodePackage_ID", qRCodePackage_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodePackage_ES</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodePackage_ES</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_ES_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodePackage_ES</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodePackage_ES_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodePackage_ESRow"/> objects.</returns>
	protected QRCodePackage_ESRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodePackage_ESRow"/> objects.</returns>
	protected QRCodePackage_ESRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodePackage_ESRow"/> objects.</returns>
	protected virtual QRCodePackage_ESRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// QRCodePackageType_ID
		int qRCodePackageType_IDColumnIndex = reader.GetOrdinal("QRCodePackageType_ID");
		// Product_ID
		...
		// AudioPublic
		int audioPublicColumnIndex = reader.GetOrdinal("AudioPublic");
		// AudioSold
		int audioSoldColumnIndex = reader.GetOrdinal("AudioSold");
		// AudioIDE
		int audioIDEColumnIndex = reader.GetOrdinal("AudioIDE");
		// MessagePublic
		int messagePublicColumnIndex = reader.GetOrdinal("MessagePublic");
		// MessageSold
		int messageSoldColumnIndex = reader.GetOrdinal("MessageSold");
		// MessageIDE
		int messageIDEColumnIndex = reader.GetOrdinal("MessageIDE");
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodePackage_ESRow record = new QRCodePackage_ESRow();
				recordList.Add(record);

					record.QRCodePackage_ID = Convert.ToInt32(reader.GetValue(qRCodePackage_IDColumnIndex));
					if(!reader.IsDBNull(qRCodePackageType_IDColumnIndex))
						record.QRCodePackageType_ID = Convert.ToInt32(reader.GetValue(qRCodePackageType_IDColumnIndex));
					...
					if(!reader.IsDBNull(audioPublicColumnIndex))
						record.AudioPublic = Convert.ToInt32(reader.GetValue(audioPublicColumnIndex));
					if(!reader.IsDBNull(audioSoldColumnIndex))
						record.AudioSold = Convert.ToInt32(reader.GetValue(audioSoldColumnIndex));
					if(!reader.IsDBNull(audioIDEColumnIndex))
						record.AudioIDE = Convert.ToInt32(reader.GetValue(audioIDEColumnIndex));
					if(!reader.IsDBNull(messagePublicColumnIndex))
						record.MessagePublic = Convert.ToInt32(reader.GetValue(messagePublicColumnIndex));
					if(!reader.IsDBNull(messageSoldColumnIndex))
						record.MessageSold = Convert.ToInt32(reader.GetValue(messageSoldColumnIndex));
					if(!reader.IsDBNull(messageIDEColumnIndex))
						record.MessageIDE = Convert.ToInt32(reader.GetValue(messageIDEColumnIndex));
		...
		return (QRCodePackage_ESRow[])(recordList.ToArray(typeof(QRCodePackage_ESRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodePackage_ESRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodePackage_ESRow"/> object.</returns>
	protected virtual QRCodePackage_ESRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodePackage_ESRow MapRow(DataRow row)";
		QRCodePackage_ESRow mappedObject = new QRCodePackage_ESRow();
		...
		// Column "QRCodePackageType_ID"
		dataColumn = dataTable.Columns["QRCodePackageType_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.QRCodePackageType_ID = (int)(row[dataColumn]);
		// Column "Product_ID"
		...
		// Column "AudioPublic"
		dataColumn = dataTable.Columns["AudioPublic"];
		if (! row.IsNull(dataColumn) )
			mappedObject.AudioPublic = (int)(row[dataColumn]);
		// Column "AudioSold"
		dataColumn = dataTable.Columns["AudioSold"];
		if (! row.IsNull(dataColumn) )
			mappedObject.AudioSold = (int)(row[dataColumn]);
		// Column "AudioIDE"
		dataColumn = dataTable.Columns["AudioIDE"];
		if (! row.IsNull(dataColumn) )
			mappedObject.AudioIDE = (int)(row[dataColumn]);
		// Column "MessagePublic"
		dataColumn = dataTable.Columns["MessagePublic"];
		if (! row.IsNull(dataColumn) )
			mappedObject.MessagePublic = (int)(row[dataColumn]);
		// Column "MessageSold"
		dataColumn = dataTable.Columns["MessageSold"];
		if (! row.IsNull(dataColumn) )
			mappedObject.MessageSold = (int)(row[dataColumn]);
		// Column "MessageIDE"
		dataColumn = dataTable.Columns["MessageIDE"];
		if (! row.IsNull(dataColumn) )
			mappedObject.MessageIDE = (int)(row[dataColumn]);
		return mappedObject;
	}

	/// <summary>
	/// Creates a <see cref="System.Data.DataTable"/> object for 
	/// the <c>QRCodePackage_ES</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodePackage_ES";
		DataColumn dataColumn;
		...
		// Create the "QRCodePackageType_ID" column
		dataColumn = dataTable.Columns.Add("QRCodePackageType_ID", typeof(int));
		...
		dataColumn.MaxLength = 500;
		// Create the "AudioPublic" column
		dataColumn = dataTable.Columns.Add("AudioPublic", typeof(int));
		// Create the "AudioSold" column
		dataColumn = dataTable.Columns.Add("AudioSold", typeof(int));
		// Create the "AudioIDE" column
		dataColumn = dataTable.Columns.Add("AudioIDE", typeof(int));
		// Create the "MessagePublic" column
		dataColumn = dataTable.Columns.Add("MessagePublic", typeof(int));
		// Create the "MessageSold" column
		dataColumn = dataTable.Columns.Add("MessageSold", typeof(int));
		// Create the "MessageIDE" column
		dataColumn = dataTable.Columns.Add("MessageIDE", typeof(int));
		return dataTable;
	}
	...
	/// <summary>
	/// Exist <see cref="QRCodePackage_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePackage_ID">The <c>QRCodePackage_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePackage_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int qRCodePackage_ID)
	{
