...
// <fileinfo name="Base\ContactCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ContactCollectionBase
...
{	
	...
	public ContactCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Contact";
	}

	public ContactCollectionBase() : base()
	{
		this.TABLENAME = "Contact";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>Contact</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ContactRow"/> objects.</returns>
	public virtual ContactRow[] GetAll()
	{
	...
	/// includes all records from the <c>Contact</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>Contact</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Contact_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ContactRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ContactRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ContactRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ContactRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ContactRow"/> objects that 
	...
	/// <returns>An array of <see cref="ContactRow"/> objects.</returns>
	public ContactRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ContactRow"/> objects.</returns>
	public virtual ContactRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ContactRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Contact_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Contact_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ContactRow"/> by the primary key.
	/// </summary>
	/// <param name="contact_ID">The <c>Contact_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ContactRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ContactRow GetByPrimaryKey(int contact_ID)
	{
		string LOCATION = "GetByPrimaryKey(int contact_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Contact_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Contact_ID", contact_ID);
			ContactRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>Contact</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ContactRow"/> object to be inserted.</param>
	public virtual void Insert(ContactRow value)
	{
		string LOCATION = "Insert(ContactRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Contact_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
	...
	/// <summary>
	/// Updates a record in the <c>Contact</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ContactRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ContactRow value)
	{	
		string LOCATION = "Update(ContactRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Contact_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Contact</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ContactRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ContactRow value)
		{
			string LOCATION = "Save(ContactRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Contact_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>Contact</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ContactRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ContactRow value)
	{
		return DeleteByPrimaryKey(value.Contact_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>Contact</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int contact_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("Contact_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Contact_ID", contact_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>Contact</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>Contact</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Contact_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>Contact</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Contact_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ContactRow"/> objects.</returns>
	protected ContactRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ContactRow"/> objects.</returns>
	protected ContactRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ContactRow"/> objects.</returns>
	protected virtual ContactRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ContactRow record = new ContactRow();
		...
		return (ContactRow[])(recordList.ToArray(typeof(ContactRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ContactRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ContactRow"/> object.</returns>
	protected virtual ContactRow MapRow(DataRow row)
	{
		string LOCATION = "ContactRow MapRow(DataRow row)";
		ContactRow mappedObject = new ContactRow();
	...
	/// <summary>
	/// Exist <see cref="ContactRow"/> by the primary key.
	/// </summary>
	/// <param name="contact_ID">The <c>Contact_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ContactRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
