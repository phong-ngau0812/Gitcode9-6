...
// <fileinfo name="Base\ProductBrandRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="ProductBrandRow"/> that 
/// represents a record in the <c>ProductBrand</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="ProductBrandRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class ProductBrandRowBase
{
	/// _productBrand_ID
	...
	private bool _rank_IDNull = true;
	/// _productBrandRole_ID
	private int _productBrandRole_ID;
	private bool _productBrandRole_IDNull = true;
	/// _sales_ID
	private System.Guid _sales_ID;
	private bool _sales_IDNull = true;
	/// _contractSigningDate
	private System.DateTime _contractSigningDate;
	private bool _contractSigningDateNull = true;
	/// _productCount
	private int _productCount;
	private bool _productCountNull = true;
	/// _stampCount
	private int _stampCount;
	private bool _stampCountNull = true;
	/// _youtube
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="ProductBrandRowBase"/> class.
	/// </summary>
	public ProductBrandRowBase():base()
	{
		// EMPTY
	}
	...
	public bool IsBusinessType_IDNull
	{
		...
		/// <summary>
		/// Gets or sets the <c>Rank_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>Rank_ID</c> column value.</value>
	public int Rank_ID
	{
		get
		{
	...
	/// <summary>
	/// Indicates whether the <see cref="Rank_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsRank_IDNull
	{
		...
		/// <summary>
		/// Gets or sets the <c>ProductBrandRole_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductBrandRole_ID</c> column value.</value>
	public int ProductBrandRole_ID
	{
		get
		{
			if (IsProductBrandRole_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productBrandRole_ID;
		}
		set
		{
			_productBrandRole_IDNull = false;
			_productBrandRole_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductBrandRole_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductBrandRole_IDNull
	{
		get
		{
			return _productBrandRole_IDNull;
		}
		set
		{
			_productBrandRole_IDNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>Sales_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>Sales_ID</c> column value.</value>
	public System.Guid Sales_ID
	{
		get
		{
			if (IsSales_IDNull)
	...
	/// <summary>
	/// Indicates whether the <see cref="Sales_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsSales_IDNull
	{
		...
		/// <summary>
		/// Gets or sets the <c>ContractSigningDate</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ContractSigningDate</c> column value.</value>
	public System.DateTime ContractSigningDate
	{
		get
		{
			if (IsContractSigningDateNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _contractSigningDate;
		}
		set
		{
			_contractSigningDateNull = false;
			_contractSigningDate = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ContractSigningDate"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsContractSigningDateNull
	{
		get
		{
			return _contractSigningDateNull;
		}
		set
		{
			_contractSigningDateNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>ProductCount</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductCount</c> column value.</value>
	public int ProductCount
	{
		get
		{
			if (IsProductCountNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productCount;
		}
		set
		{
			_productCountNull = false;
			_productCount = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductCount"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductCountNull
	{
		get
		{
			return _productCountNull;
		}
		set
		{
			_productCountNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>StampCount</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>StampCount</c> column value.</value>
	public int StampCount
	{
		...
		set
		{
			_stampCountNull = false;
			_stampCount = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="StampCount"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsStampCountNull
	{
		get
		{
			return _stampCountNull;
		}
		set
		{
			_stampCountNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		// Rank_ID
		dynStr.Append("  Rank_ID=");
		if( IsRank_IDNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.Rank_ID);
		// ProductBrandRole_ID
		dynStr.Append("  ProductBrandRole_ID=");
		if( IsProductBrandRole_IDNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ProductBrandRole_ID);
		// Sales_ID
		dynStr.Append("  Sales_ID=");
		if( IsSales_IDNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.Sales_ID);
		// ContractSigningDate
		dynStr.Append("  ContractSigningDate=");
		if( IsContractSigningDateNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ContractSigningDate);
		// ProductCount
		dynStr.Append("  ProductCount=");
		if( IsProductCountNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ProductCount);
		// StampCount
		dynStr.Append("  StampCount=");
		if( IsStampCountNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.StampCount);
		// Youtube
