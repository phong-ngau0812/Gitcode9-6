...
// <fileinfo name="Base\QRCodePackageCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodePackageCollectionBase
...
{	
	...
	public QRCodePackageCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodePackage";
	}

	public QRCodePackageCollectionBase() : base()
	{
		this.TABLENAME = "QRCodePackage";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodePackage</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodePackageRow"/> objects.</returns>
	public virtual QRCodePackageRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodePackage</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodePackage</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodePackage_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodePackageRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodePackageRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodePackageRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodePackageRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodePackageRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodePackageRow"/> objects.</returns>
	public QRCodePackageRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodePackageRow"/> objects.</returns>
	public virtual QRCodePackageRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodePackageRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodePackageRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePackage_ID">The <c>QRCodePackage_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePackageRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodePackageRow GetByPrimaryKey(int qRCodePackage_ID)
	{
		string LOCATION = "GetByPrimaryKey(int qRCodePackage_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodePackage_ID", qRCodePackage_ID);
			QRCodePackageRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodePackage</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackageRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodePackageRow value)
	{
		string LOCATION = "Insert(QRCodePackageRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackage_Insert", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Updates a record in the <c>QRCodePackage</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackageRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodePackageRow value)
	{	
		string LOCATION = "Update(QRCodePackageRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackage_Update", CommandType.StoredProcedure);
					// QRCodePackageType_ID
			if (value.IsQRCodePackageType_IDNull)
				AddParameter(cmd, "QRCodePackageType_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodePackage</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodePackageRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodePackageRow value)
		{
			string LOCATION = "Save(QRCodePackageRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodePackage_Save",CommandType.StoredProcedure);
					// QRCodePackageType_ID
				if (value.IsQRCodePackageType_IDNull)
					AddParameter(cmd, "QRCodePackageType_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodePackage</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackageRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodePackageRow value)
	{
		return DeleteByPrimaryKey(value.QRCodePackage_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodePackage</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int qRCodePackage_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackage_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodePackage_ID", qRCodePackage_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodePackage</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodePackage</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackage_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodePackage</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodePackage_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodePackageRow"/> objects.</returns>
	protected QRCodePackageRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodePackageRow"/> objects.</returns>
	protected QRCodePackageRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodePackageRow"/> objects.</returns>
	protected virtual QRCodePackageRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodePackageRow record = new QRCodePackageRow();
		...
		return (QRCodePackageRow[])(recordList.ToArray(typeof(QRCodePackageRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodePackageRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodePackageRow"/> object.</returns>
	protected virtual QRCodePackageRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodePackageRow MapRow(DataRow row)";
		QRCodePackageRow mappedObject = new QRCodePackageRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodePackage";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="QRCodePackageRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePackage_ID">The <c>QRCodePackage_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePackageRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
