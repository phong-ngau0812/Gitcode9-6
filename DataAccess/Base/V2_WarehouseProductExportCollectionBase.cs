...
// <fileinfo name="Base\V2_WarehouseProductExportCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class V2_WarehouseProductExportCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string WarehouseProductExport_IDColumnName  = "WarehouseProductExport_ID";
	...
	public V2_WarehouseProductExportCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "V2_WarehouseProductExport";
	}

	public V2_WarehouseProductExportCollectionBase() : base()
	{
		this.TABLENAME = "V2_WarehouseProductExport";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	/// <returns>An array of <see cref="V2_WarehouseProductExportRow"/> objects.</returns>
	public virtual V2_WarehouseProductExportRow[] GetAll()
	{
	...
	/// includes all records from the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("V2_WarehouseProductExport_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="V2_WarehouseProductExportRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="V2_WarehouseProductExportRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public V2_WarehouseProductExportRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			V2_WarehouseProductExportRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="V2_WarehouseProductExportRow"/> objects that 
	...
	/// <returns>An array of <see cref="V2_WarehouseProductExportRow"/> objects.</returns>
	public V2_WarehouseProductExportRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="V2_WarehouseProductExportRow"/> objects.</returns>
	public virtual V2_WarehouseProductExportRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			V2_WarehouseProductExportRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("V2_WarehouseProductExport_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("V2_WarehouseProductExport_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="V2_WarehouseProductExportRow"/> by the primary key.
	/// </summary>
	/// <param name="task_ID">The <c>Task_ID</c> column value.</param>
	/// <returns>An instance of <see cref="V2_WarehouseProductExportRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual V2_WarehouseProductExportRow GetByPrimaryKey(int task_ID)
	{
		string LOCATION = "GetByPrimaryKey(int task_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("V2_WarehouseProductExport_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Task_ID", task_ID);
			V2_WarehouseProductExportRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	/// <param name="value">The <see cref="V2_WarehouseProductExportRow"/> object to be inserted.</param>
	public virtual void Insert(V2_WarehouseProductExportRow value)
	{
		string LOCATION = "Insert(V2_WarehouseProductExportRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("V2_WarehouseProductExport_Insert", CommandType.StoredProcedure);
					// ProductPackage_ID
			...
			if (value.IsWarehouse_IDNull)
				...
				// Task_ID
			if (value.IsTask_IDNull )
				AddParameter(cmd, "Task_ID", DBNull.Value);
			else
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.WarehouseProductExport_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	/// <param name="value">The <see cref="V2_WarehouseProductExportRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(V2_WarehouseProductExportRow value)
	{	
		string LOCATION = "Update(V2_WarehouseProductExportRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("V2_WarehouseProductExport_Update", CommandType.StoredProcedure);
					// ProductPackage_ID
			if (value.IsProductPackage_IDNull)
				AddParameter(cmd, "ProductPackage_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>V2_WarehouseProductExport</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="V2_WarehouseProductExportRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(V2_WarehouseProductExportRow value)
		{
			string LOCATION = "Save(V2_WarehouseProductExportRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("V2_WarehouseProductExport_Save",CommandType.StoredProcedure);
					// ProductPackage_ID
				if (value.IsProductPackage_IDNull)
					AddParameter(cmd, "ProductPackage_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	/// <param name="value">The <see cref="V2_WarehouseProductExportRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(V2_WarehouseProductExportRow value)
	{
		return DeleteByPrimaryKey(value.Task_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>V2_WarehouseProductExport</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int task_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("V2_WarehouseProductExport_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Task_ID", task_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>V2_WarehouseProductExport</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>V2_WarehouseProductExport</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("V2_WarehouseProductExport_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("V2_WarehouseProductExport_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="V2_WarehouseProductExportRow"/> objects.</returns>
	protected V2_WarehouseProductExportRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="V2_WarehouseProductExportRow"/> objects.</returns>
	protected V2_WarehouseProductExportRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="V2_WarehouseProductExportRow"/> objects.</returns>
	protected virtual V2_WarehouseProductExportRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		int warehouseProductExport_IDColumnIndex = reader.GetOrdinal("WarehouseProductExport_ID");
		// ProductPackage_ID
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				V2_WarehouseProductExportRow record = new V2_WarehouseProductExportRow();
				recordList.Add(record);

					record.WarehouseProductExport_ID = Convert.ToInt32(reader.GetValue(warehouseProductExport_IDColumnIndex));
		...
		return (V2_WarehouseProductExportRow[])(recordList.ToArray(typeof(V2_WarehouseProductExportRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="V2_WarehouseProductExportRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="V2_WarehouseProductExportRow"/> object.</returns>
	protected virtual V2_WarehouseProductExportRow MapRow(DataRow row)
	{
		string LOCATION = "V2_WarehouseProductExportRow MapRow(DataRow row)";
		V2_WarehouseProductExportRow mappedObject = new V2_WarehouseProductExportRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "WarehouseProductExport_ID"
		dataColumn = dataTable.Columns["WarehouseProductExport_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.WarehouseProductExport_ID = (int)(row[dataColumn]);
	...
	/// the <c>V2_WarehouseProductExport</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "V2_WarehouseProductExport";
		DataColumn dataColumn;
		// Create the "WarehouseProductExport_ID" column
		dataColumn = dataTable.Columns.Add("WarehouseProductExport_ID", typeof(int));
	...
	protected virtual IDbDataParameter AddParameter(IDbCommand cmd, String paramName, object value)
	{
		...
		switch(paramName)
		{
			case "WarehouseProductExport_ID":
	...
	/// <summary>
	/// Exist <see cref="V2_WarehouseProductExportRow"/> by the primary key.
	/// </summary>
	/// <param name="task_ID">The <c>Task_ID</c> column value.</param>
	/// <returns>An instance of <see cref="V2_WarehouseProductExportRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
