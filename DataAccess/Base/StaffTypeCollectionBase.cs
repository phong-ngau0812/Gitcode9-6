...
// <fileinfo name="Base\StaffTypeCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class StaffTypeCollectionBase
...
{	
	...
	public StaffTypeCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "StaffType";
	}

	public StaffTypeCollectionBase() : base()
	{
		this.TABLENAME = "StaffType";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>StaffType</c> table.
	/// </summary>
	/// <returns>An array of <see cref="StaffTypeRow"/> objects.</returns>
	public virtual StaffTypeRow[] GetAll()
	{
	...
	/// includes all records from the <c>StaffType</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>StaffType</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("StaffType_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="StaffTypeRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="StaffTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public StaffTypeRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			StaffTypeRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="StaffTypeRow"/> objects that 
	...
	/// <returns>An array of <see cref="StaffTypeRow"/> objects.</returns>
	public StaffTypeRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="StaffTypeRow"/> objects.</returns>
	public virtual StaffTypeRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			StaffTypeRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("StaffType_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("StaffType_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="StaffTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="staffType_ID">The <c>StaffType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="StaffTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual StaffTypeRow GetByPrimaryKey(int staffType_ID)
	{
		string LOCATION = "GetByPrimaryKey(int staffType_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("StaffType_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "StaffType_ID", staffType_ID);
			StaffTypeRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>StaffType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="StaffTypeRow"/> object to be inserted.</param>
	public virtual void Insert(StaffTypeRow value)
	{
		string LOCATION = "Insert(StaffTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("StaffType_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsSortNull)
				...
				AddParameter(cmd, "Sort", value.Sort);
						...
						value.StaffType_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>StaffType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="StaffTypeRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(StaffTypeRow value)
	{	
		string LOCATION = "Update(StaffTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("StaffType_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>StaffType</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="StaffTypeRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(StaffTypeRow value)
		{
			string LOCATION = "Save(StaffTypeRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("StaffType_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["StaffType_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>StaffType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="StaffTypeRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(StaffTypeRow value)
	{
		return DeleteByPrimaryKey(value.StaffType_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>StaffType</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="staffType_ID">The <c>StaffType_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int staffType_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int staffType_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("StaffType_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "StaffType_ID", staffType_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>StaffType</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>StaffType</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("StaffType_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>StaffType</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("StaffType_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="StaffTypeRow"/> objects.</returns>
	protected StaffTypeRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="StaffTypeRow"/> objects.</returns>
	protected StaffTypeRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="StaffTypeRow"/> objects.</returns>
	protected virtual StaffTypeRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				StaffTypeRow record = new StaffTypeRow();
		...
		return (StaffTypeRow[])(recordList.ToArray(typeof(StaffTypeRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="StaffTypeRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="StaffTypeRow"/> object.</returns>
	protected virtual StaffTypeRow MapRow(DataRow row)
	{
		string LOCATION = "StaffTypeRow MapRow(DataRow row)";
		StaffTypeRow mappedObject = new StaffTypeRow();
	...
	/// <summary>
	/// Exist <see cref="StaffTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="staffType_ID">The <c>StaffType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="StaffTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int staffType_ID)
	{
