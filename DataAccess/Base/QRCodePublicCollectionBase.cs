...
// <fileinfo name="Base\QRCodePublicCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodePublicCollectionBase
...
{	
	...
	public QRCodePublicCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodePublic";
	}

	public QRCodePublicCollectionBase() : base()
	{
		this.TABLENAME = "QRCodePublic";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodePublic</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodePublicRow"/> objects.</returns>
	public virtual QRCodePublicRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodePublic</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodePublic</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodePublic_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodePublicRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodePublicRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodePublicRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodePublicRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodePublicRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodePublicRow"/> objects.</returns>
	public QRCodePublicRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodePublicRow"/> objects.</returns>
	public virtual QRCodePublicRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodePublicRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePublic_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePublic_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodePublicRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePublicContent">The <c>QRCodePublicContent</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePublicRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodePublicRow GetByPrimaryKey(string qRCodePublicContent)
	{
		string LOCATION = "GetByPrimaryKey(string qRCodePublicContent)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodePublic_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodePublicContent", qRCodePublicContent);
			QRCodePublicRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodePublic</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePublicRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodePublicRow value)
	{
		string LOCATION = "Insert(QRCodePublicRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePublic_Insert", CommandType.StoredProcedure);
					// QRCodePublicContent
	...
	/// <summary>
	/// Updates a record in the <c>QRCodePublic</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePublicRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodePublicRow value)
	{	
		string LOCATION = "Update(QRCodePublicRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePublic_Update", CommandType.StoredProcedure);
					// SerialNumber
			if (value.IsSerialNumberNull)
				AddParameter(cmd, "SerialNumber", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodePublic</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodePublicRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodePublicRow value)
		{
			string LOCATION = "Save(QRCodePublicRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodePublic_Save",CommandType.StoredProcedure);
					// SerialNumber
				if (value.IsSerialNumberNull)
					AddParameter(cmd, "SerialNumber", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodePublic</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePublicRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodePublicRow value)
	{
		return DeleteByPrimaryKey(value.QRCodePublicContent);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodePublic</c> table using
	...
	public virtual bool DeleteByPrimaryKey(string qRCodePublicContent)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePublic_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodePublicContent", qRCodePublicContent);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodePublic</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodePublic</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePublic_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodePublic</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodePublic_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodePublicRow"/> objects.</returns>
	protected QRCodePublicRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodePublicRow"/> objects.</returns>
	protected QRCodePublicRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodePublicRow"/> objects.</returns>
	protected virtual QRCodePublicRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodePublicRow record = new QRCodePublicRow();
		...
		return (QRCodePublicRow[])(recordList.ToArray(typeof(QRCodePublicRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodePublicRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodePublicRow"/> object.</returns>
	protected virtual QRCodePublicRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodePublicRow MapRow(DataRow row)";
		QRCodePublicRow mappedObject = new QRCodePublicRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodePublic";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="QRCodePublicRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePublicContent">The <c>QRCodePublicContent</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePublicRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
