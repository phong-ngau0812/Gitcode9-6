...
// <fileinfo name="Base\QRCodeLocationRegisterCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodeLocationRegisterCollectionBase
...
{	
	...
	public QRCodeLocationRegisterCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodeLocationRegister";
	}

	public QRCodeLocationRegisterCollectionBase() : base()
	{
		this.TABLENAME = "QRCodeLocationRegister";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodeLocationRegisterRow"/> objects.</returns>
	public virtual QRCodeLocationRegisterRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodeLocationRegister_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodeLocationRegisterRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodeLocationRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodeLocationRegisterRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodeLocationRegisterRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodeLocationRegisterRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodeLocationRegisterRow"/> objects.</returns>
	public QRCodeLocationRegisterRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodeLocationRegisterRow"/> objects.</returns>
	public virtual QRCodeLocationRegisterRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodeLocationRegisterRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeLocationRegister_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeLocationRegister_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodeLocationRegisterRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeLocationRegister_ID">The <c>QRCodeLocationRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeLocationRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodeLocationRegisterRow GetByPrimaryKey(int qRCodeLocationRegister_ID)
	{
		string LOCATION = "GetByPrimaryKey(int qRCodeLocationRegister_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodeLocationRegister_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodeLocationRegister_ID", qRCodeLocationRegister_ID);
			QRCodeLocationRegisterRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeLocationRegisterRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodeLocationRegisterRow value)
	{
		string LOCATION = "Insert(QRCodeLocationRegisterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeLocationRegister_Insert", CommandType.StoredProcedure);
					// QRCodePackage_ID
	...
	/// <summary>
	/// Updates a record in the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeLocationRegisterRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodeLocationRegisterRow value)
	{	
		string LOCATION = "Update(QRCodeLocationRegisterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeLocationRegister_Update", CommandType.StoredProcedure);
					// QRCodePackage_ID
			if (value.IsQRCodePackage_IDNull)
				AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodeLocationRegister</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodeLocationRegisterRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodeLocationRegisterRow value)
		{
			string LOCATION = "Save(QRCodeLocationRegisterRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodeLocationRegister_Save",CommandType.StoredProcedure);
					// QRCodePackage_ID
				if (value.IsQRCodePackage_IDNull)
					AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeLocationRegisterRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodeLocationRegisterRow value)
	{
		return DeleteByPrimaryKey(value.QRCodeLocationRegister_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodeLocationRegister</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int qRCodeLocationRegister_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeLocationRegister_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodeLocationRegister_ID", qRCodeLocationRegister_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodeLocationRegister</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodeLocationRegister</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeLocationRegister_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodeLocationRegister_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodeLocationRegisterRow"/> objects.</returns>
	protected QRCodeLocationRegisterRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodeLocationRegisterRow"/> objects.</returns>
	protected QRCodeLocationRegisterRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodeLocationRegisterRow"/> objects.</returns>
	protected virtual QRCodeLocationRegisterRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodeLocationRegisterRow record = new QRCodeLocationRegisterRow();
		...
		return (QRCodeLocationRegisterRow[])(recordList.ToArray(typeof(QRCodeLocationRegisterRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodeLocationRegisterRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodeLocationRegisterRow"/> object.</returns>
	protected virtual QRCodeLocationRegisterRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodeLocationRegisterRow MapRow(DataRow row)";
		QRCodeLocationRegisterRow mappedObject = new QRCodeLocationRegisterRow();
	...
	/// the <c>QRCodeLocationRegister</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodeLocationRegister";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="QRCodeLocationRegisterRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeLocationRegister_ID">The <c>QRCodeLocationRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeLocationRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
