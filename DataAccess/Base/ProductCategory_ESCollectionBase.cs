...
// <fileinfo name="Base\ProductCategory_ESCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ProductCategory_ESCollectionBase
...
{	
	...
	public ProductCategory_ESCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "ProductCategory_ES";
	}

	public ProductCategory_ESCollectionBase() : base()
	{
		this.TABLENAME = "ProductCategory_ES";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>ProductCategory_ES</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ProductCategory_ESRow"/> objects.</returns>
	public virtual ProductCategory_ESRow[] GetAll()
	{
	...
	/// includes all records from the <c>ProductCategory_ES</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>ProductCategory_ES</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("ProductCategory_ES_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ProductCategory_ESRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ProductCategory_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ProductCategory_ESRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ProductCategory_ESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ProductCategory_ESRow"/> objects that 
	...
	/// <returns>An array of <see cref="ProductCategory_ESRow"/> objects.</returns>
	public ProductCategory_ESRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ProductCategory_ESRow"/> objects.</returns>
	public virtual ProductCategory_ESRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ProductCategory_ESRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductCategory_ES_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductCategory_ES_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ProductCategory_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="productCategory_ID">The <c>ProductCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductCategory_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ProductCategory_ESRow GetByPrimaryKey(int productCategory_ID)
	{
		string LOCATION = "GetByPrimaryKey(int productCategory_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("ProductCategory_ES_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "ProductCategory_ID", productCategory_ID);
			ProductCategory_ESRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>ProductCategory_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductCategory_ESRow"/> object to be inserted.</param>
	public virtual void Insert(ProductCategory_ESRow value)
	{
		string LOCATION = "Insert(ProductCategory_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductCategory_ES_Insert", CommandType.StoredProcedure);
					// Parent_ID
	...
	/// <summary>
	/// Updates a record in the <c>ProductCategory_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductCategory_ESRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ProductCategory_ESRow value)
	{	
		string LOCATION = "Update(ProductCategory_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductCategory_ES_Update", CommandType.StoredProcedure);
					// Parent_ID
			if (value.IsParent_IDNull)
				AddParameter(cmd, "Parent_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>ProductCategory_ES</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ProductCategory_ESRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ProductCategory_ESRow value)
		{
			string LOCATION = "Save(ProductCategory_ESRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("ProductCategory_ES_Save",CommandType.StoredProcedure);
					// Parent_ID
				if (value.IsParent_IDNull)
					AddParameter(cmd, "Parent_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>ProductCategory_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductCategory_ESRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ProductCategory_ESRow value)
	{
		return DeleteByPrimaryKey(value.ProductCategory_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>ProductCategory_ES</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int productCategory_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductCategory_ES_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "ProductCategory_ID", productCategory_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>ProductCategory_ES</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>ProductCategory_ES</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductCategory_ES_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>ProductCategory_ES</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("ProductCategory_ES_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ProductCategory_ESRow"/> objects.</returns>
	protected ProductCategory_ESRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ProductCategory_ESRow"/> objects.</returns>
	protected ProductCategory_ESRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ProductCategory_ESRow"/> objects.</returns>
	protected virtual ProductCategory_ESRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ProductCategory_ESRow record = new ProductCategory_ESRow();
		...
		return (ProductCategory_ESRow[])(recordList.ToArray(typeof(ProductCategory_ESRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ProductCategory_ESRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ProductCategory_ESRow"/> object.</returns>
	protected virtual ProductCategory_ESRow MapRow(DataRow row)
	{
		string LOCATION = "ProductCategory_ESRow MapRow(DataRow row)";
		ProductCategory_ESRow mappedObject = new ProductCategory_ESRow();
	...
	/// the <c>ProductCategory_ES</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "ProductCategory_ES";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="ProductCategory_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="productCategory_ID">The <c>ProductCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductCategory_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
