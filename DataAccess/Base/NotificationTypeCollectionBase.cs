...
// <fileinfo name="Base\NotificationTypeCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class NotificationTypeCollectionBase
...
{	
	...
	public NotificationTypeCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "NotificationType";
	}

	public NotificationTypeCollectionBase() : base()
	{
		this.TABLENAME = "NotificationType";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>NotificationType</c> table.
	/// </summary>
	/// <returns>An array of <see cref="NotificationTypeRow"/> objects.</returns>
	public virtual NotificationTypeRow[] GetAll()
	{
	...
	/// includes all records from the <c>NotificationType</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>NotificationType</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("NotificationType_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="NotificationTypeRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="NotificationTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public NotificationTypeRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			NotificationTypeRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="NotificationTypeRow"/> objects that 
	...
	/// <returns>An array of <see cref="NotificationTypeRow"/> objects.</returns>
	public NotificationTypeRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="NotificationTypeRow"/> objects.</returns>
	public virtual NotificationTypeRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			NotificationTypeRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("NotificationType_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("NotificationType_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="NotificationTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="notificationType_ID">The <c>NotificationType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="NotificationTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual NotificationTypeRow GetByPrimaryKey(int notificationType_ID)
	{
		string LOCATION = "GetByPrimaryKey(int notificationType_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("NotificationType_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "NotificationType_ID", notificationType_ID);
			NotificationTypeRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>NotificationType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="NotificationTypeRow"/> object to be inserted.</param>
	public virtual void Insert(NotificationTypeRow value)
	{
		string LOCATION = "Insert(NotificationTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("NotificationType_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsParent_IDNull)
				...
				AddParameter(cmd, "Parent_ID", value.Parent_ID);
						...
						value.NotificationType_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>NotificationType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="NotificationTypeRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(NotificationTypeRow value)
	{	
		string LOCATION = "Update(NotificationTypeRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("NotificationType_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>NotificationType</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="NotificationTypeRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(NotificationTypeRow value)
		{
			string LOCATION = "Save(NotificationTypeRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("NotificationType_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["NotificationType_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>NotificationType</c> table.
	/// </summary>
	/// <param name="value">The <see cref="NotificationTypeRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(NotificationTypeRow value)
	{
		return DeleteByPrimaryKey(value.NotificationType_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>NotificationType</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="notificationType_ID">The <c>NotificationType_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int notificationType_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int notificationType_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("NotificationType_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "NotificationType_ID", notificationType_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>NotificationType</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>NotificationType</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("NotificationType_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>NotificationType</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("NotificationType_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="NotificationTypeRow"/> objects.</returns>
	protected NotificationTypeRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="NotificationTypeRow"/> objects.</returns>
	protected NotificationTypeRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="NotificationTypeRow"/> objects.</returns>
	protected virtual NotificationTypeRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				NotificationTypeRow record = new NotificationTypeRow();
		...
		return (NotificationTypeRow[])(recordList.ToArray(typeof(NotificationTypeRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="NotificationTypeRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="NotificationTypeRow"/> object.</returns>
	protected virtual NotificationTypeRow MapRow(DataRow row)
	{
		string LOCATION = "NotificationTypeRow MapRow(DataRow row)";
		NotificationTypeRow mappedObject = new NotificationTypeRow();
	...
	/// the <c>NotificationType</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "NotificationType";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="NotificationTypeRow"/> by the primary key.
	/// </summary>
	/// <param name="notificationType_ID">The <c>NotificationType_ID</c> column value.</param>
	/// <returns>An instance of <see cref="NotificationTypeRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int notificationType_ID)
	{
