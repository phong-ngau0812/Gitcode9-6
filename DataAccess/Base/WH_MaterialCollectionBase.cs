...
// <fileinfo name="Base\WH_MaterialCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class WH_MaterialCollectionBase
...
{	
	...
	public const string MaterialBrand_IDColumnName  = "MaterialBrand_ID";
	...
	public const string PackingTypeColumnName  = "PackingType";
	public const string ActiveIngredientColumnName  = "ActiveIngredient";
	...
	public const string GIAIColumnName  = "GIAI";
	...
	public WH_MaterialCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "WH_Material";
	}

	public WH_MaterialCollectionBase() : base()
	{
		this.TABLENAME = "WH_Material";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>WH_Material</c> table.
	/// </summary>
	/// <returns>An array of <see cref="WH_MaterialRow"/> objects.</returns>
	public virtual WH_MaterialRow[] GetAll()
	{
	...
	/// includes all records from the <c>WH_Material</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>WH_Material</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("WH_Material_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="WH_MaterialRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="WH_MaterialRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public WH_MaterialRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			WH_MaterialRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="WH_MaterialRow"/> objects that 
	...
	/// <returns>An array of <see cref="WH_MaterialRow"/> objects.</returns>
	public WH_MaterialRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="WH_MaterialRow"/> objects.</returns>
	public virtual WH_MaterialRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			WH_MaterialRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("WH_Material_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("WH_Material_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="WH_MaterialRow"/> by the primary key.
	/// </summary>
	/// <param name="material_ID">The <c>Material_ID</c> column value.</param>
	/// <returns>An instance of <see cref="WH_MaterialRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual WH_MaterialRow GetByPrimaryKey(int material_ID)
	{
		string LOCATION = "GetByPrimaryKey(int material_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("WH_Material_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Material_ID", material_ID);
			WH_MaterialRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>WH_Material</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WH_MaterialRow"/> object to be inserted.</param>
	public virtual void Insert(WH_MaterialRow value)
	{
		string LOCATION = "Insert(WH_MaterialRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("WH_Material_Insert", CommandType.StoredProcedure);
					// MaterialCategory_ID
			if (value.IsMaterialCategory_IDNull)
				...
				// MaterialBrand_ID
			if (value.IsMaterialBrand_IDNull)
				AddParameter(cmd, "MaterialBrand_ID", DBNull.Value);
			else
				AddParameter(cmd, "MaterialBrand_ID", value.MaterialBrand_ID);
			...
			if (value.IsNameNull )
				...
				// Country
			if (value.IsCountryNull )
				AddParameter(cmd, "Country", DBNull.Value);
			else
			...
			if (value.IsUnitNull )
				...
				// PackingType
			if (value.IsPackingTypeNull )
				AddParameter(cmd, "PackingType", DBNull.Value);
			else
				AddParameter(cmd, "PackingType", value.PackingType);
			
				// ActiveIngredient
			if (value.IsActiveIngredientNull )
				AddParameter(cmd, "ActiveIngredient", DBNull.Value);
			else
				AddParameter(cmd, "ActiveIngredient", value.ActiveIngredient);
			...
			if (value.IsLastEditByNull)
				...
				// GIAI
			if (value.IsGIAINull )
				AddParameter(cmd, "GIAI", DBNull.Value);
			else
				AddParameter(cmd, "GIAI", value.GIAI);
			
						value.Material_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>WH_Material</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WH_MaterialRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(WH_MaterialRow value)
	{	
		string LOCATION = "Update(WH_MaterialRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("WH_Material_Update", CommandType.StoredProcedure);
					// MaterialCategory_ID
			if (value.IsMaterialCategory_IDNull)
				AddParameter(cmd, "MaterialCategory_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>WH_Material</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="WH_MaterialRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(WH_MaterialRow value)
		{
			string LOCATION = "Save(WH_MaterialRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("WH_Material_Save",CommandType.StoredProcedure);
					// MaterialCategory_ID
				if (value.IsMaterialCategory_IDNull)
					AddParameter(cmd, "MaterialCategory_ID", DBNull.Value);
				else
				...
				if (value.IsMaterialBrand_IDNull)
					...
					AddParameter(cmd, "MaterialBrand_ID", (object)(value.MaterialBrand_ID));
				...
				if (value.IsCountryNull)
					...
					AddParameter(cmd, "Country", (object)(value.Country));
				...
				if (value.IsPackingTypeNull)
					...
					AddParameter(cmd, "PackingType", (object)(value.PackingType));
				
					// ActiveIngredient
				if (value.IsActiveIngredientNull)
					AddParameter(cmd, "ActiveIngredient", DBNull.Value);
				else
					AddParameter(cmd, "ActiveIngredient", (object)(value.ActiveIngredient));
				...
				if (value.IsGIAINull)
					...
					AddParameter(cmd, "GIAI", (object)(value.GIAI));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Material_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>WH_Material</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WH_MaterialRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(WH_MaterialRow value)
	{
		return DeleteByPrimaryKey(value.Material_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>WH_Material</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="material_ID">The <c>Material_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int material_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int material_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("WH_Material_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Material_ID", material_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>WH_Material</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>WH_Material</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("WH_Material_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>WH_Material</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("WH_Material_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="WH_MaterialRow"/> objects.</returns>
	protected WH_MaterialRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="WH_MaterialRow"/> objects.</returns>
	protected WH_MaterialRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="WH_MaterialRow"/> objects.</returns>
	protected virtual WH_MaterialRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// MaterialBrand_ID
		int materialBrand_IDColumnIndex = reader.GetOrdinal("MaterialBrand_ID");
		// ProductBrand_ID
		...
		// PackingType
		int packingTypeColumnIndex = reader.GetOrdinal("PackingType");
		// ActiveIngredient
		int activeIngredientColumnIndex = reader.GetOrdinal("ActiveIngredient");
		// IsolationDay
		...
		// GIAI
		int giaiColumnIndex = reader.GetOrdinal("GIAI");
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				WH_MaterialRow record = new WH_MaterialRow();
				recordList.Add(record);
					...
					if(!reader.IsDBNull(materialCategory_IDColumnIndex))
						record.MaterialCategory_ID = Convert.ToInt32(reader.GetValue(materialCategory_IDColumnIndex));
					if(!reader.IsDBNull(materialBrand_IDColumnIndex))
						record.MaterialBrand_ID = Convert.ToInt32(reader.GetValue(materialBrand_IDColumnIndex));
					...
					if(!reader.IsDBNull(warehouse_IDColumnIndex))
						record.Warehouse_ID = Convert.ToString(reader.GetValue(warehouse_IDColumnIndex));
					...
					if(!reader.IsDBNull(packingTypeColumnIndex))
						record.PackingType = Convert.ToString(reader.GetValue(packingTypeColumnIndex));
					if(!reader.IsDBNull(activeIngredientColumnIndex))
						record.ActiveIngredient = Convert.ToString(reader.GetValue(activeIngredientColumnIndex));
					...
					if(!reader.IsDBNull(giaiColumnIndex))
						record.GIAI = Convert.ToString(reader.GetValue(giaiColumnIndex));
		...
		return (WH_MaterialRow[])(recordList.ToArray(typeof(WH_MaterialRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="WH_MaterialRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="WH_MaterialRow"/> object.</returns>
	protected virtual WH_MaterialRow MapRow(DataRow row)
	{
		string LOCATION = "WH_MaterialRow MapRow(DataRow row)";
		WH_MaterialRow mappedObject = new WH_MaterialRow();
		...
		if (! row.IsNull(dataColumn) )
			mappedObject.MaterialCategory_ID = (int)(row[dataColumn]);
		// Column "MaterialBrand_ID"
		dataColumn = dataTable.Columns["MaterialBrand_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.MaterialBrand_ID = (int)(row[dataColumn]);
		...
		if (! row.IsNull(dataColumn) )
			mappedObject.Warehouse_ID = (string)(row[dataColumn]);
		// Column "Code"
		...
		// Column "PackingType"
		dataColumn = dataTable.Columns["PackingType"];
		if (! row.IsNull(dataColumn) )
			mappedObject.PackingType = (string)(row[dataColumn]);
		// Column "ActiveIngredient"
		dataColumn = dataTable.Columns["ActiveIngredient"];
		if (! row.IsNull(dataColumn) )
			mappedObject.ActiveIngredient = (string)(row[dataColumn]);
		// Column "IsolationDay"
		...
		// Column "GIAI"
		dataColumn = dataTable.Columns["GIAI"];
		if (! row.IsNull(dataColumn) )
			mappedObject.GIAI = (string)(row[dataColumn]);
		return mappedObject;
	}

	/// <summary>
	/// Creates a <see cref="System.Data.DataTable"/> object for 
	/// the <c>WH_Material</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "WH_Material";
		DataColumn dataColumn;
		...
		dataColumn = dataTable.Columns.Add("MaterialCategory_ID", typeof(int));
		// Create the "MaterialBrand_ID" column
		dataColumn = dataTable.Columns.Add("MaterialBrand_ID", typeof(int));
		...
		dataColumn = dataTable.Columns.Add("Warehouse_ID", typeof(string));
		...
		dataColumn = dataTable.Columns.Add("Country", typeof(string));
		dataColumn.MaxLength = 500;
		...
		dataColumn.MaxLength = 50;
		// Create the "PackingType" column
		dataColumn = dataTable.Columns.Add("PackingType", typeof(string));
		dataColumn.MaxLength = 2000;
		// Create the "ActiveIngredient" column
		dataColumn = dataTable.Columns.Add("ActiveIngredient", typeof(string));
		dataColumn.MaxLength = 2000;
		...
		// Create the "GIAI" column
		dataColumn = dataTable.Columns.Add("GIAI", typeof(string));
		dataColumn.MaxLength = 500;
		return dataTable;
	}
	...
	/// <summary>
	/// Exist <see cref="WH_MaterialRow"/> by the primary key.
	/// </summary>
	/// <param name="material_ID">The <c>Material_ID</c> column value.</param>
	/// <returns>An instance of <see cref="WH_MaterialRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int material_ID)
	{
