...
// <fileinfo name="Base\ProductChangeRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="ProductChangeRow"/> that 
/// represents a record in the <c>ProductChange</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="ProductChangeRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class ProductChangeRowBase
{
	/// _productChange_ID
	private int _productChange_ID;
	private bool _productChange_IDNull = true;
	/// _product_ID
	...
	/// _productChange_Note
	private string _productChange_Note;
	private bool _productChange_NoteNull = true;
	/// _productChange_By
	private System.Guid _productChange_By;
	private bool _productChange_ByNull = true;
	/// _productChange_Approved
	private System.Guid _productChange_Approved;
	private bool _productChange_ApprovedNull = true;
	/// _productChange_Date
	private System.DateTime _productChange_Date;
	private bool _productChange_DateNull = true;
	/// _productChange_DateApproved
	private System.DateTime _productChange_DateApproved;
	private bool _productChange_DateApprovedNull = true;
	/// _productChange_Status
	private int _productChange_Status;
	private bool _productChange_StatusNull = true;
	/// _productChange_ApprovedNote
	private string _productChange_ApprovedNote;
	private bool _productChange_ApprovedNoteNull = true;


// Instance fields
	
	/// <summary>
	/// Initializes a new instance of the <see cref="ProductChangeRowBase"/> class.
	/// </summary>
	public ProductChangeRowBase():base()
	{
		// EMPTY
	}

		/// <summary>
		/// Gets or sets the <c>ProductChange_ID</c> column value.
		/// </summary>
		/// <value>The <c>ProductChange_ID</c> column value.</value>
	public int ProductChange_ID
	{
		get
		{
			if(IsProductChange_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_ID;
		}
		set
		{
			_productChange_IDNull = false;
			_productChange_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_IDNull
	{
		get
		{
			return _productChange_IDNull;
		}
		set
		{
			_productChange_IDNull = value;
		}	
	}
	...
	public bool IsStoryNull
	{
		...
		/// <summary>
		/// Gets or sets the <c>ProductChange_Note</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductChange_Note</c> column value.</value>
	public string ProductChange_Note
	{
		get
		{
			if(IsProductChange_NoteNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_Note;
		}
		set
		{
			_productChange_NoteNull = false;
			_productChange_Note = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_Note"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_NoteNull
	{
		get
		{
			return _productChange_NoteNull;
		}
		set
		{
			_productChange_NoteNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>ProductChange_By</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductChange_By</c> column value.</value>
	public System.Guid ProductChange_By
	{
		get
		{
			if (IsProductChange_ByNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_By;
		}
		set
		{
			_productChange_ByNull = false;
			_productChange_By = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_By"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_ByNull
	{
		get
		{
			return _productChange_ByNull;
		}
		set
		{
			_productChange_ByNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>ProductChange_Approved</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductChange_Approved</c> column value.</value>
	public System.Guid ProductChange_Approved
	{
		get
		{
			if (IsProductChange_ApprovedNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_Approved;
		}
		set
		{
			_productChange_ApprovedNull = false;
			_productChange_Approved = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_Approved"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_ApprovedNull
	{
		get
		{
			return _productChange_ApprovedNull;
		}
		set
		{
			_productChange_ApprovedNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>ProductChange_Date</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductChange_Date</c> column value.</value>
	public System.DateTime ProductChange_Date
	{
		get
		{
			if (IsProductChange_DateNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_Date;
		}
		set
		{
			_productChange_DateNull = false;
			_productChange_Date = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_Date"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_DateNull
	{
		get
		{
			return _productChange_DateNull;
		}
		set
		{
			_productChange_DateNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>ProductChange_DateApproved</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductChange_DateApproved</c> column value.</value>
	public System.DateTime ProductChange_DateApproved
	{
		get
		{
			if (IsProductChange_DateApprovedNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_DateApproved;
		}
		set
		{
			_productChange_DateApprovedNull = false;
			_productChange_DateApproved = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_DateApproved"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_DateApprovedNull
	{
		get
		{
			return _productChange_DateApprovedNull;
		}
		set
		{
			_productChange_DateApprovedNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>ProductChange_Status</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductChange_Status</c> column value.</value>
	public int ProductChange_Status
	{
		get
		{
			if (IsProductChange_StatusNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_Status;
		}
		set
		{
			_productChange_StatusNull = false;
			_productChange_Status = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_Status"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_StatusNull
	{
		get
		{
			return _productChange_StatusNull;
		}
		set
		{
			_productChange_StatusNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>ProductChange_ApprovedNote</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ProductChange_ApprovedNote</c> column value.</value>
	public string ProductChange_ApprovedNote
	{
		get
		{
			if(IsProductChange_ApprovedNoteNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _productChange_ApprovedNote;
		}
		set
		{
			_productChange_ApprovedNoteNull = false;
			_productChange_ApprovedNote = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="ProductChange_ApprovedNote"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsProductChange_ApprovedNoteNull
	{
		get
		{
			return _productChange_ApprovedNoteNull;
		}
		set
		{
			_productChange_ApprovedNoteNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		dynStr.Append(":");
		// ProductChange_ID
		dynStr.Append("  ProductChange_ID=");
		if( IsProductChange_IDNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.ProductChange_ID);
		...
		// ProductChange_Note
		dynStr.Append("  ProductChange_Note=");
		if( IsProductChange_NoteNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.ProductChange_Note);
		

		// ProductChange_By
		dynStr.Append("  ProductChange_By=");
		if( IsProductChange_ByNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ProductChange_By);
		// ProductChange_Approved
		dynStr.Append("  ProductChange_Approved=");
		if( IsProductChange_ApprovedNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ProductChange_Approved);
		// ProductChange_Date
		dynStr.Append("  ProductChange_Date=");
		if( IsProductChange_DateNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ProductChange_Date);
		// ProductChange_DateApproved
		dynStr.Append("  ProductChange_DateApproved=");
		if( IsProductChange_DateApprovedNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ProductChange_DateApproved);
		// ProductChange_Status
		dynStr.Append("  ProductChange_Status=");
		if( IsProductChange_StatusNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.ProductChange_Status);
		// ProductChange_ApprovedNote
		dynStr.Append("  ProductChange_ApprovedNote=");
		if( IsProductChange_ApprovedNoteNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.ProductChange_ApprovedNote);
