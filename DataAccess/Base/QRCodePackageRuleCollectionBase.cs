...
// <fileinfo name="Base\QRCodePackageRuleCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodePackageRuleCollectionBase
...
{	
	...
	public QRCodePackageRuleCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodePackageRule";
	}

	public QRCodePackageRuleCollectionBase() : base()
	{
		this.TABLENAME = "QRCodePackageRule";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodePackageRule</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodePackageRuleRow"/> objects.</returns>
	public virtual QRCodePackageRuleRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodePackageRule</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodePackageRule</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodePackageRule_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodePackageRuleRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodePackageRuleRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodePackageRuleRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodePackageRuleRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodePackageRuleRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodePackageRuleRow"/> objects.</returns>
	public QRCodePackageRuleRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodePackageRuleRow"/> objects.</returns>
	public virtual QRCodePackageRuleRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodePackageRuleRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackageRule_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackageRule_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodePackageRuleRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePackageRule_ID">The <c>QRCodePackageRule_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePackageRuleRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodePackageRuleRow GetByPrimaryKey(int qRCodePackageRule_ID)
	{
		string LOCATION = "GetByPrimaryKey(int qRCodePackageRule_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodePackageRule_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodePackageRule_ID", qRCodePackageRule_ID);
			QRCodePackageRuleRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodePackageRule</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackageRuleRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodePackageRuleRow value)
	{
		string LOCATION = "Insert(QRCodePackageRuleRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackageRule_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
	...
	/// <summary>
	/// Updates a record in the <c>QRCodePackageRule</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackageRuleRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodePackageRuleRow value)
	{	
		string LOCATION = "Update(QRCodePackageRuleRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackageRule_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodePackageRule</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodePackageRuleRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodePackageRuleRow value)
		{
			string LOCATION = "Save(QRCodePackageRuleRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodePackageRule_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodePackageRule</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodePackageRuleRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodePackageRuleRow value)
	{
		return DeleteByPrimaryKey(value.QRCodePackageRule_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodePackageRule</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int qRCodePackageRule_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodePackageRule_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodePackageRule_ID", qRCodePackageRule_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodePackageRule</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodePackageRule</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodePackageRule_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodePackageRule</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodePackageRule_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodePackageRuleRow"/> objects.</returns>
	protected QRCodePackageRuleRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodePackageRuleRow"/> objects.</returns>
	protected QRCodePackageRuleRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodePackageRuleRow"/> objects.</returns>
	protected virtual QRCodePackageRuleRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodePackageRuleRow record = new QRCodePackageRuleRow();
		...
		return (QRCodePackageRuleRow[])(recordList.ToArray(typeof(QRCodePackageRuleRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodePackageRuleRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodePackageRuleRow"/> object.</returns>
	protected virtual QRCodePackageRuleRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodePackageRuleRow MapRow(DataRow row)";
		QRCodePackageRuleRow mappedObject = new QRCodePackageRuleRow();
	...
	/// the <c>QRCodePackageRule</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodePackageRule";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="QRCodePackageRuleRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodePackageRule_ID">The <c>QRCodePackageRule_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodePackageRuleRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
