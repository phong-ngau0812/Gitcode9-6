...
// <fileinfo name="Base\WarehouseCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class WarehouseCollectionBase
...
{	
	...
	public WarehouseCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Warehouse";
	}

	public WarehouseCollectionBase() : base()
	{
		this.TABLENAME = "Warehouse";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>Warehouse</c> table.
	/// </summary>
	/// <returns>An array of <see cref="WarehouseRow"/> objects.</returns>
	public virtual WarehouseRow[] GetAll()
	{
	...
	/// includes all records from the <c>Warehouse</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>Warehouse</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Warehouse_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="WarehouseRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="WarehouseRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public WarehouseRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			WarehouseRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="WarehouseRow"/> objects that 
	...
	/// <returns>An array of <see cref="WarehouseRow"/> objects.</returns>
	public WarehouseRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="WarehouseRow"/> objects.</returns>
	public virtual WarehouseRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			WarehouseRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Warehouse_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Warehouse_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="WarehouseRow"/> by the primary key.
	/// </summary>
	/// <param name="warehouse_ID">The <c>Warehouse_ID</c> column value.</param>
	/// <returns>An instance of <see cref="WarehouseRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual WarehouseRow GetByPrimaryKey(int warehouse_ID)
	{
		string LOCATION = "GetByPrimaryKey(int warehouse_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Warehouse_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Warehouse_ID", warehouse_ID);
			WarehouseRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>Warehouse</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WarehouseRow"/> object to be inserted.</param>
	public virtual void Insert(WarehouseRow value)
	{
		string LOCATION = "Insert(WarehouseRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Warehouse_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
	...
	/// <summary>
	/// Updates a record in the <c>Warehouse</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WarehouseRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(WarehouseRow value)
	{	
		string LOCATION = "Update(WarehouseRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Warehouse_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Warehouse</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="WarehouseRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(WarehouseRow value)
		{
			string LOCATION = "Save(WarehouseRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Warehouse_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>Warehouse</c> table.
	/// </summary>
	/// <param name="value">The <see cref="WarehouseRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(WarehouseRow value)
	{
		return DeleteByPrimaryKey(value.Warehouse_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>Warehouse</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int warehouse_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("Warehouse_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Warehouse_ID", warehouse_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>Warehouse</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>Warehouse</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Warehouse_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>Warehouse</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Warehouse_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="WarehouseRow"/> objects.</returns>
	protected WarehouseRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="WarehouseRow"/> objects.</returns>
	protected WarehouseRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="WarehouseRow"/> objects.</returns>
	protected virtual WarehouseRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				WarehouseRow record = new WarehouseRow();
		...
		return (WarehouseRow[])(recordList.ToArray(typeof(WarehouseRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="WarehouseRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="WarehouseRow"/> object.</returns>
	protected virtual WarehouseRow MapRow(DataRow row)
	{
		string LOCATION = "WarehouseRow MapRow(DataRow row)";
		WarehouseRow mappedObject = new WarehouseRow();
	...
	/// <summary>
	/// Exist <see cref="WarehouseRow"/> by the primary key.
	/// </summary>
	/// <param name="warehouse_ID">The <c>Warehouse_ID</c> column value.</param>
	/// <returns>An instance of <see cref="WarehouseRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
