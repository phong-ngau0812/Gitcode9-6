...
// <fileinfo name="Base\TestingCertificatesRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="TestingCertificatesRow"/> that 
/// represents a record in the <c>TestingCertificates</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="TestingCertificatesRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class TestingCertificatesRowBase
{
	/// _testingCertificates_ID
	private int _testingCertificates_ID;
	...
	private bool _uploadFileNull = true;
	/// _description
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="TestingCertificatesRowBase"/> class.
	/// </summary>
	public TestingCertificatesRowBase():base()
	{
		// EMPTY
	}
	...
	public int TestingCertificates_ID
	{
		get
		{
	...
	public bool IsNameNull
	{
		...
		/// <summary>
		/// Gets or sets the <c>UploadFile</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>UploadFile</c> column value.</value>
	public string UploadFile
	{
		...
		set
		{
			_uploadFileNull = false;
			_uploadFile = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="UploadFile"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsUploadFileNull
	{
		get
		{
			return _uploadFileNull;
		}
		set
		{
			_uploadFileNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		// UploadFile
		dynStr.Append("  UploadFile=");
		if( IsUploadFileNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.UploadFile);
