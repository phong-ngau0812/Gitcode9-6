...
// <fileinfo name="Base\AccountTypeRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="AccountTypeRow"/> that 
/// represents a record in the <c>AccountType</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="AccountTypeRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class AccountTypeRowBase
{
	/// _accountType_ID
	private int _accountType_ID;
	private bool _accountType_IDNull = true;
	/// _name
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="AccountTypeRowBase"/> class.
	/// </summary>
	public AccountTypeRowBase():base()
	{
		// EMPTY
	}

		/// <summary>
		/// Gets or sets the <c>AccountType_ID</c> column value.
		/// </summary>
		/// <value>The <c>AccountType_ID</c> column value.</value>
	public int AccountType_ID
	{
		get
		{
			if(IsAccountType_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _accountType_ID;
		}
		set
		{
			_accountType_IDNull = false;
			_accountType_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="AccountType_ID"/>
	...
	public bool IsAccountType_IDNull
	{
		get
		{
			return _accountType_IDNull;
		}
		set
		{
			_accountType_IDNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		dynStr.Append(":");
		// AccountType_ID
		dynStr.Append("  AccountType_ID=");
		if( IsAccountType_IDNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.AccountType_ID);
