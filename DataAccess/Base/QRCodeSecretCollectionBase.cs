...
// <fileinfo name="Base\QRCodeSecretCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodeSecretCollectionBase
...
{	
	...
	public QRCodeSecretCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodeSecret";
	}

	public QRCodeSecretCollectionBase() : base()
	{
		this.TABLENAME = "QRCodeSecret";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodeSecret</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodeSecretRow"/> objects.</returns>
	public virtual QRCodeSecretRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodeSecret</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodeSecret</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodeSecret_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodeSecretRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodeSecretRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodeSecretRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodeSecretRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodeSecretRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodeSecretRow"/> objects.</returns>
	public QRCodeSecretRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodeSecretRow"/> objects.</returns>
	public virtual QRCodeSecretRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodeSecretRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeSecret_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeSecret_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodeSecretRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeSecretContent">The <c>QRCodeSecretContent</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeSecretRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodeSecretRow GetByPrimaryKey(string qRCodeSecretContent)
	{
		string LOCATION = "GetByPrimaryKey(string qRCodeSecretContent)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodeSecret_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodeSecretContent", qRCodeSecretContent);
			QRCodeSecretRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodeSecret</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeSecretRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodeSecretRow value)
	{
		string LOCATION = "Insert(QRCodeSecretRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeSecret_Insert", CommandType.StoredProcedure);
					// QRCodeSecretContent
	...
	/// <summary>
	/// Updates a record in the <c>QRCodeSecret</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeSecretRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodeSecretRow value)
	{	
		string LOCATION = "Update(QRCodeSecretRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeSecret_Update", CommandType.StoredProcedure);
					// QRCodePublicContent
			if (value.IsQRCodePublicContentNull)
				AddParameter(cmd, "QRCodePublicContent", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodeSecret</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodeSecretRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodeSecretRow value)
		{
			string LOCATION = "Save(QRCodeSecretRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodeSecret_Save",CommandType.StoredProcedure);
					// QRCodePublicContent
				if (value.IsQRCodePublicContentNull)
					AddParameter(cmd, "QRCodePublicContent", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodeSecret</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeSecretRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodeSecretRow value)
	{
		return DeleteByPrimaryKey(value.QRCodeSecretContent);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodeSecret</c> table using
	...
	public virtual bool DeleteByPrimaryKey(string qRCodeSecretContent)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeSecret_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodeSecretContent", qRCodeSecretContent);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodeSecret</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodeSecret</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeSecret_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodeSecret</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodeSecret_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodeSecretRow"/> objects.</returns>
	protected QRCodeSecretRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodeSecretRow"/> objects.</returns>
	protected QRCodeSecretRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodeSecretRow"/> objects.</returns>
	protected virtual QRCodeSecretRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodeSecretRow record = new QRCodeSecretRow();
		...
		return (QRCodeSecretRow[])(recordList.ToArray(typeof(QRCodeSecretRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodeSecretRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodeSecretRow"/> object.</returns>
	protected virtual QRCodeSecretRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodeSecretRow MapRow(DataRow row)";
		QRCodeSecretRow mappedObject = new QRCodeSecretRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodeSecret";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="QRCodeSecretRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeSecretContent">The <c>QRCodeSecretContent</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeSecretRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
