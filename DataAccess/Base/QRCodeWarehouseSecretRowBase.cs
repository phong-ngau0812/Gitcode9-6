...
// <fileinfo name="Base\QRCodeWarehouseSecretRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="QRCodeWarehouseSecretRow"/> that 
/// represents a record in the <c>QRCodeWarehouseSecret</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="QRCodeWarehouseSecretRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class QRCodeWarehouseSecretRowBase
{
	/// _QRCodeWarehouseSecretContent
	private string _QRCodeWarehouseSecretContent;
	private bool _QRCodeWarehouseSecretContentNull = true;
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="QRCodeWarehouseSecretRowBase"/> class.
	/// </summary>
	public QRCodeWarehouseSecretRowBase():base()
	{
		// EMPTY
	}

		/// <summary>
		/// Gets or sets the <c>QRCodeWarehouseSecretContent</c> column value.
		/// </summary>
		/// <value>The <c>QRCodeWarehouseSecretContent</c> column value.</value>
	public string QRCodeWarehouseSecretContent
	{
		get
		{
			if(IsQRCodeWarehouseSecretContentNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _QRCodeWarehouseSecretContent;
		}
		set
		{
			_QRCodeWarehouseSecretContentNull = false;
			_QRCodeWarehouseSecretContent = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="QRCodeWarehouseSecretContent"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsQRCodeWarehouseSecretContentNull
	{
		get
		{
			return _QRCodeWarehouseSecretContentNull;
		}
		set
		{
			_QRCodeWarehouseSecretContentNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		dynStr.Append("  QRCodeWarehouseSecretContent=");
		if( IsQRCodeWarehouseSecretContentNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.QRCodeWarehouseSecretContent);
