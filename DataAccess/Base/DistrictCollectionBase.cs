...
// <fileinfo name="Base\DistrictCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class DistrictCollectionBase
...
{	
	...
	public DistrictCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "District";
	}

	public DistrictCollectionBase() : base()
	{
		this.TABLENAME = "District";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>District</c> table.
	/// </summary>
	...
	/// includes all records from the <c>District</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>District</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("District_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="DistrictRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="DistrictRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public DistrictRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			DistrictRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <returns>An array of <see cref="DistrictRow"/> objects.</returns>
	public DistrictRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="DistrictRow"/> objects.</returns>
	public virtual DistrictRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			DistrictRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("District_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("District_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="DistrictRow"/> by the primary key.
	/// </summary>
	/// <param name="district_ID">The <c>District_ID</c> column value.</param>
	/// <returns>An instance of <see cref="DistrictRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual DistrictRow GetByPrimaryKey(int district_ID)
	{
		string LOCATION = "GetByPrimaryKey(int district_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("District_GetByPrimaryKey", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Adds a new record into the <c>District</c> table.
	/// </summary>
	/// <param name="value">The <see cref="DistrictRow"/> object to be inserted.</param>
	public virtual void Insert(DistrictRow value)
	{
		string LOCATION = "Insert(DistrictRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("District_Insert", CommandType.StoredProcedure);
					// District_ID
	...
	/// <summary>
	/// Updates a record in the <c>District</c> table.
	/// </summary>
	/// <param name="value">The <see cref="DistrictRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(DistrictRow value)
	{	
		string LOCATION = "Update(DistrictRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("District_Update", CommandType.StoredProcedure);
					// Location_ID
			if (value.IsLocation_IDNull)
				AddParameter(cmd, "Location_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>District</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="DistrictRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(DistrictRow value)
		{
			string LOCATION = "Save(DistrictRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("District_Save",CommandType.StoredProcedure);
					// Location_ID
				if (value.IsLocation_IDNull)
					AddParameter(cmd, "Location_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>District</c> table.
	/// </summary>
	/// <param name="value">The <see cref="DistrictRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(DistrictRow value)
	{
		return DeleteByPrimaryKey(value.District_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>District</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int district_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("District_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "District_ID", district_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>District</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>District</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("District_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>District</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("District_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="DistrictRow"/> objects.</returns>
	protected virtual DistrictRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="DistrictRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="DistrictRow"/> object.</returns>
	protected virtual DistrictRow MapRow(DataRow row)
	{
		string LOCATION = "DistrictRow MapRow(DataRow row)";
		DistrictRow mappedObject = new DistrictRow();
	...
	/// <summary>
	/// Exist <see cref="DistrictRow"/> by the primary key.
	/// </summary>
	/// <param name="district_ID">The <c>District_ID</c> column value.</param>
	/// <returns>An instance of <see cref="DistrictRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int district_ID)
	{
