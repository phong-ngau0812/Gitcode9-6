...
// <fileinfo name="Base\QRCodeSecret_ESRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="QRCodeSecret_ESRow"/> that 
/// represents a record in the <c>QRCodeSecret_ES</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="QRCodeSecret_ESRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class QRCodeSecret_ESRowBase
{
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="QRCodeSecret_ESRowBase"/> class.
	/// </summary>
	public QRCodeSecret_ESRowBase():base()
	{
		// EMPTY
	}
