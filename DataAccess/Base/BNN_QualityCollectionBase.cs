...
// <fileinfo name="Base\BNN_QualityCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_QualityCollectionBase
...
{	
	...
	public BNN_QualityCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_Quality";
	}

	public BNN_QualityCollectionBase() : base()
	{
		this.TABLENAME = "BNN_Quality";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_Quality</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_QualityRow"/> objects.</returns>
	public virtual BNN_QualityRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_Quality</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_Quality</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_Quality_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_QualityRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_QualityRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_QualityRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_QualityRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_QualityRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_QualityRow"/> objects.</returns>
	public BNN_QualityRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_QualityRow"/> objects.</returns>
	public virtual BNN_QualityRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_QualityRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Quality_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Quality_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_QualityRow"/> by the primary key.
	/// </summary>
	/// <param name="quality_ID">The <c>Quality_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_QualityRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_QualityRow GetByPrimaryKey(int quality_ID)
	{
		string LOCATION = "GetByPrimaryKey(int quality_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_Quality_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Quality_ID", quality_ID);
			BNN_QualityRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_Quality</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_QualityRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_QualityRow value)
	{
		string LOCATION = "Insert(BNN_QualityRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Quality_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
						...
						value.Quality_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_Quality</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_QualityRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_QualityRow value)
	{	
		string LOCATION = "Update(BNN_QualityRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Quality_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_Quality</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_QualityRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_QualityRow value)
		{
			string LOCATION = "Save(BNN_QualityRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_Quality_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Quality_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_Quality</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_QualityRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_QualityRow value)
	{
		return DeleteByPrimaryKey(value.Quality_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_Quality</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="quality_ID">The <c>Quality_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int quality_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int quality_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Quality_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Quality_ID", quality_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_Quality</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_Quality</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Quality_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_Quality</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_Quality_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_QualityRow"/> objects.</returns>
	protected BNN_QualityRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_QualityRow"/> objects.</returns>
	protected BNN_QualityRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_QualityRow"/> objects.</returns>
	protected virtual BNN_QualityRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_QualityRow record = new BNN_QualityRow();
		...
		return (BNN_QualityRow[])(recordList.ToArray(typeof(BNN_QualityRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_QualityRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_QualityRow"/> object.</returns>
	protected virtual BNN_QualityRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_QualityRow MapRow(DataRow row)";
		BNN_QualityRow mappedObject = new BNN_QualityRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_Quality";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="BNN_QualityRow"/> by the primary key.
	/// </summary>
	/// <param name="quality_ID">The <c>Quality_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_QualityRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int quality_ID)
	{
