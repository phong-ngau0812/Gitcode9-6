...
// <fileinfo name="Base\BNN_FeedbackRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="BNN_FeedbackRow"/> that 
/// represents a record in the <c>BNN_Feedback</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="BNN_FeedbackRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class BNN_FeedbackRowBase
{
	/// _feedback_ID
	private int _feedback_ID;
	private bool _feedback_IDNull = true;
	/// _name
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="BNN_FeedbackRowBase"/> class.
	/// </summary>
	public BNN_FeedbackRowBase():base()
	{
		// EMPTY
	}
	...
	public int Feedback_ID
	{
		get
		{
			if(IsFeedback_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _feedback_ID;
		}
		set
		{
			_feedback_IDNull = false;
			_feedback_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="Feedback_ID"/>
	...
	public bool IsFeedback_IDNull
	{
		get
		{
			return _feedback_IDNull;
		}
		set
		{
			_feedback_IDNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		if( IsFeedback_IDNull)
			...
			dynStr.Append(this.Feedback_ID);
