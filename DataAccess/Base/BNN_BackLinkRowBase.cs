...
// <fileinfo name="Base\BNN_BackLinkRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="BNN_BackLinkRow"/> that 
/// represents a record in the <c>BNN_BackLink</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="BNN_BackLinkRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class BNN_BackLinkRowBase
{
	/// _backLink_ID
	private int _backLink_ID;
	private bool _backLink_IDNull = true;
	/// _title
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="BNN_BackLinkRowBase"/> class.
	/// </summary>
	public BNN_BackLinkRowBase():base()
	{
		// EMPTY
	}

		/// <summary>
		/// Gets or sets the <c>BackLink_ID</c> column value.
		/// </summary>
		/// <value>The <c>BackLink_ID</c> column value.</value>
	public int BackLink_ID
	{
		get
		{
			if(IsBackLink_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _backLink_ID;
		}
		set
		{
			_backLink_IDNull = false;
			_backLink_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="BackLink_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsBackLink_IDNull
	{
		get
		{
			return _backLink_IDNull;
		}
		set
		{
			_backLink_IDNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		dynStr.Append(":");
		// BackLink_ID
		dynStr.Append("  BackLink_ID=");
		if( IsBackLink_IDNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.BackLink_ID);
