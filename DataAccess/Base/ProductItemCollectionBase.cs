...
// <fileinfo name="Base\ProductItemCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ProductItemCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string ProductItem_IDColumnName  = "ProductItem_ID";
	...
	public ProductItemCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "ProductItem";
	}

	public ProductItemCollectionBase() : base()
	{
		this.TABLENAME = "ProductItem";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>ProductItem</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ProductItemRow"/> objects.</returns>
	public virtual ProductItemRow[] GetAll()
	{
	...
	/// includes all records from the <c>ProductItem</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>ProductItem</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("ProductItem_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ProductItemRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ProductItemRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ProductItemRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ProductItemRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ProductItemRow"/> objects that 
	...
	/// <returns>An array of <see cref="ProductItemRow"/> objects.</returns>
	public ProductItemRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ProductItemRow"/> objects.</returns>
	public virtual ProductItemRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ProductItemRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductItem_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductItem_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ProductItemRow"/> by the primary key.
	/// </summary>
	/// <param name="productItem_ID">The <c>ProductItem_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductItemRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ProductItemRow GetByPrimaryKey(int productItem_ID)
	{
		string LOCATION = "GetByPrimaryKey(int productItem_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("ProductItem_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "ProductItem_ID", productItem_ID);
			ProductItemRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>ProductItem</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductItemRow"/> object to be inserted.</param>
	public virtual void Insert(ProductItemRow value)
	{
		string LOCATION = "Insert(ProductItemRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductItem_Insert", CommandType.StoredProcedure);
					// ProductPackage_ID
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.ProductItem_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>ProductItem</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductItemRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ProductItemRow value)
	{	
		string LOCATION = "Update(ProductItemRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductItem_Update", CommandType.StoredProcedure);
					// ProductPackage_ID
			if (value.IsProductPackage_IDNull)
				AddParameter(cmd, "ProductPackage_ID", DBNull.Value);
			else
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
					...
					AddParameter(cmd, "ProductItem_ID", value.ProductItem_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>ProductItem</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ProductItemRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ProductItemRow value)
		{
			string LOCATION = "Save(ProductItemRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("ProductItem_Save",CommandType.StoredProcedure);
					// ProductPackage_ID
				if (value.IsProductPackage_IDNull)
					AddParameter(cmd, "ProductPackage_ID", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["ProductItem_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>ProductItem</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductItemRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ProductItemRow value)
	{
		return DeleteByPrimaryKey(value.ProductItem_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>ProductItem</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="productItem_ID">The <c>ProductItem_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int productItem_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int productItem_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductItem_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "ProductItem_ID", productItem_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>ProductItem</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>ProductItem</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductItem_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>ProductItem</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("ProductItem_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ProductItemRow"/> objects.</returns>
	protected ProductItemRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ProductItemRow"/> objects.</returns>
	protected ProductItemRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ProductItemRow"/> objects.</returns>
	protected virtual ProductItemRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// ProductItem_ID
		int productItem_IDColumnIndex = reader.GetOrdinal("ProductItem_ID");
		// ProductPackage_ID
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ProductItemRow record = new ProductItemRow();
				recordList.Add(record);

					record.ProductItem_ID = Convert.ToInt32(reader.GetValue(productItem_IDColumnIndex));
		...
		return (ProductItemRow[])(recordList.ToArray(typeof(ProductItemRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ProductItemRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ProductItemRow"/> object.</returns>
	protected virtual ProductItemRow MapRow(DataRow row)
	{
		string LOCATION = "ProductItemRow MapRow(DataRow row)";
		ProductItemRow mappedObject = new ProductItemRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "ProductItem_ID"
		dataColumn = dataTable.Columns["ProductItem_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.ProductItem_ID = (int)(row[dataColumn]);
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "ProductItem";
		DataColumn dataColumn;
		// Create the "ProductItem_ID" column
		dataColumn = dataTable.Columns.Add("ProductItem_ID", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="ProductItemRow"/> by the primary key.
	/// </summary>
	/// <param name="productItem_ID">The <c>ProductItem_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductItemRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int productItem_ID)
	{
