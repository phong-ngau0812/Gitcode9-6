...
// <fileinfo name="Base\BNN_ProductCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_ProductCollectionBase
...
{	
	...
	public BNN_ProductCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_Product";
	}

	public BNN_ProductCollectionBase() : base()
	{
		this.TABLENAME = "BNN_Product";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_Product</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_ProductRow"/> objects.</returns>
	public virtual BNN_ProductRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_Product</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_Product</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_Product_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_ProductRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_ProductRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_ProductRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_ProductRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_ProductRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_ProductRow"/> objects.</returns>
	public BNN_ProductRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_ProductRow"/> objects.</returns>
	public virtual BNN_ProductRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_ProductRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Product_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Product_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_ProductRow"/> by the primary key.
	/// </summary>
	/// <param name="product_ID">The <c>Product_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_ProductRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_ProductRow GetByPrimaryKey(int product_ID)
	{
		string LOCATION = "GetByPrimaryKey(int product_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_Product_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Product_ID", product_ID);
			BNN_ProductRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_Product</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_ProductRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_ProductRow value)
	{
		string LOCATION = "Insert(BNN_ProductRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Product_Insert", CommandType.StoredProcedure);
					// Location_ID
	...
	/// <summary>
	/// Updates a record in the <c>BNN_Product</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_ProductRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_ProductRow value)
	{	
		string LOCATION = "Update(BNN_ProductRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Product_Update", CommandType.StoredProcedure);
					// Location_ID
			if (value.IsLocation_IDNull)
				AddParameter(cmd, "Location_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_Product</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_ProductRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_ProductRow value)
		{
			string LOCATION = "Save(BNN_ProductRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_Product_Save",CommandType.StoredProcedure);
					// Location_ID
				if (value.IsLocation_IDNull)
					AddParameter(cmd, "Location_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_Product</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_ProductRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_ProductRow value)
	{
		return DeleteByPrimaryKey(value.Product_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_Product</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int product_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Product_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Product_ID", product_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_Product</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_Product</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Product_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_Product</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_Product_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_ProductRow"/> objects.</returns>
	protected BNN_ProductRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_ProductRow"/> objects.</returns>
	protected BNN_ProductRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_ProductRow"/> objects.</returns>
	protected virtual BNN_ProductRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_ProductRow record = new BNN_ProductRow();
		...
		return (BNN_ProductRow[])(recordList.ToArray(typeof(BNN_ProductRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_ProductRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_ProductRow"/> object.</returns>
	protected virtual BNN_ProductRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_ProductRow MapRow(DataRow row)";
		BNN_ProductRow mappedObject = new BNN_ProductRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_Product";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="BNN_ProductRow"/> by the primary key.
	/// </summary>
	/// <param name="product_ID">The <c>Product_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_ProductRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
