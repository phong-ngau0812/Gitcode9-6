...
// <fileinfo name="Base\DiscountCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class DiscountCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string Discount_IDColumnName  = "Discount_ID";
	...
	public const string PercentColumnName  = "Percent";
	...
	public DiscountCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Discount";
	}

	public DiscountCollectionBase() : base()
	{
		this.TABLENAME = "Discount";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>Discount</c> table.
	/// </summary>
	/// <returns>An array of <see cref="DiscountRow"/> objects.</returns>
	public virtual DiscountRow[] GetAll()
	{
	...
	/// includes all records from the <c>Discount</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>Discount</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Discount_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="DiscountRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="DiscountRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public DiscountRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			DiscountRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="DiscountRow"/> objects that 
	...
	/// <returns>An array of <see cref="DiscountRow"/> objects.</returns>
	public DiscountRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="DiscountRow"/> objects.</returns>
	public virtual DiscountRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			DiscountRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Discount_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Discount_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="DiscountRow"/> by the primary key.
	/// </summary>
	/// <param name="discount_ID">The <c>Discount_ID</c> column value.</param>
	/// <returns>An instance of <see cref="DiscountRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual DiscountRow GetByPrimaryKey(int discount_ID)
	{
		string LOCATION = "GetByPrimaryKey(int discount_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Discount_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Discount_ID", discount_ID);
			DiscountRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>Discount</c> table.
	/// </summary>
	/// <param name="value">The <see cref="DiscountRow"/> object to be inserted.</param>
	public virtual void Insert(DiscountRow value)
	{
		string LOCATION = "Insert(DiscountRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Discount_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
			...
			if (value.IsSortNull)
				...
				// Percent
			if (value.IsPercentNull)
				AddParameter(cmd, "Percent", DBNull.Value);
			else
				AddParameter(cmd, "Percent", value.Percent);
			
						value.Discount_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>Discount</c> table.
	/// </summary>
	/// <param name="value">The <see cref="DiscountRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(DiscountRow value)
	{	
		string LOCATION = "Update(DiscountRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Discount_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
			...
			if (value.IsPercentNull)
				...
				AddParameter(cmd, "Percent", value.Percent);
					...
					AddParameter(cmd, "Discount_ID", value.Discount_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Discount</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="DiscountRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(DiscountRow value)
		{
			string LOCATION = "Save(DiscountRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Discount_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
				...
				if (value.IsPercentNull)
					...
					AddParameter(cmd, "Percent", (object)(value.Percent));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Discount_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>Discount</c> table.
	/// </summary>
	/// <param name="value">The <see cref="DiscountRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(DiscountRow value)
	{
		return DeleteByPrimaryKey(value.Discount_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>Discount</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="discount_ID">The <c>Discount_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int discount_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int discount_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Discount_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Discount_ID", discount_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>Discount</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>Discount</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Discount_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>Discount</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Discount_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="DiscountRow"/> objects.</returns>
	protected DiscountRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="DiscountRow"/> objects.</returns>
	protected DiscountRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="DiscountRow"/> objects.</returns>
	protected virtual DiscountRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// Discount_ID
		int discount_IDColumnIndex = reader.GetOrdinal("Discount_ID");
		// ProductBrand_ID
		...
		// Percent
		int percentColumnIndex = reader.GetOrdinal("Percent");
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				DiscountRow record = new DiscountRow();
				recordList.Add(record);

					record.Discount_ID = Convert.ToInt32(reader.GetValue(discount_IDColumnIndex));
					...
					if(!reader.IsDBNull(percentColumnIndex))
						record.Percent = Convert.ToInt32(reader.GetValue(percentColumnIndex));
		...
		return (DiscountRow[])(recordList.ToArray(typeof(DiscountRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="DiscountRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="DiscountRow"/> object.</returns>
	protected virtual DiscountRow MapRow(DataRow row)
	{
		string LOCATION = "DiscountRow MapRow(DataRow row)";
		DiscountRow mappedObject = new DiscountRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "Discount_ID"
		dataColumn = dataTable.Columns["Discount_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Discount_ID = (int)(row[dataColumn]);
		...
		// Column "Percent"
		dataColumn = dataTable.Columns["Percent"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Percent = (int)(row[dataColumn]);
		return mappedObject;
	}

	/// <summary>
	/// Creates a <see cref="System.Data.DataTable"/> object for 
	/// the <c>Discount</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "Discount";
		DataColumn dataColumn;
		// Create the "Discount_ID" column
		dataColumn = dataTable.Columns.Add("Discount_ID", typeof(int));
		...
		dataColumn = dataTable.Columns.Add("Percent", typeof(int));
		return dataTable;
	}
	...
	/// <summary>
	/// Exist <see cref="DiscountRow"/> by the primary key.
	/// </summary>
	/// <param name="discount_ID">The <c>Discount_ID</c> column value.</param>
	/// <returns>An instance of <see cref="DiscountRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int discount_ID)
	{
