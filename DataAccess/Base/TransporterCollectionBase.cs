...
// <fileinfo name="Base\TransporterCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class TransporterCollectionBase
...
{	
	...
	public const string SSCCColumnName  = "SSCC";
	...
	public TransporterCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Transporter";
	}

	public TransporterCollectionBase() : base()
	{
		this.TABLENAME = "Transporter";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>Transporter</c> table.
	/// </summary>
	/// <returns>An array of <see cref="TransporterRow"/> objects.</returns>
	public virtual TransporterRow[] GetAll()
	{
	...
	/// includes all records from the <c>Transporter</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>Transporter</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Transporter_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="TransporterRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="TransporterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public TransporterRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			TransporterRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="TransporterRow"/> objects that 
	...
	/// <returns>An array of <see cref="TransporterRow"/> objects.</returns>
	public TransporterRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="TransporterRow"/> objects.</returns>
	public virtual TransporterRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			TransporterRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Transporter_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Transporter_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="TransporterRow"/> by the primary key.
	/// </summary>
	/// <param name="transporter_ID">The <c>Transporter_ID</c> column value.</param>
	/// <returns>An instance of <see cref="TransporterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual TransporterRow GetByPrimaryKey(int transporter_ID)
	{
		string LOCATION = "GetByPrimaryKey(int transporter_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Transporter_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Transporter_ID", transporter_ID);
			TransporterRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>Transporter</c> table.
	/// </summary>
	/// <param name="value">The <see cref="TransporterRow"/> object to be inserted.</param>
	public virtual void Insert(TransporterRow value)
	{
		string LOCATION = "Insert(TransporterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Transporter_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
			...
			if (value.IsSortNull)
				...
				// SSCC
			if (value.IsSSCCNull )
				AddParameter(cmd, "SSCC", DBNull.Value);
			else
				AddParameter(cmd, "SSCC", value.SSCC);
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.Transporter_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>Transporter</c> table.
	/// </summary>
	/// <param name="value">The <see cref="TransporterRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(TransporterRow value)
	{	
		string LOCATION = "Update(TransporterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Transporter_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Transporter</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="TransporterRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(TransporterRow value)
		{
			string LOCATION = "Save(TransporterRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Transporter_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
				...
				if (value.IsSSCCNull)
					...
					AddParameter(cmd, "SSCC", (object)(value.SSCC));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Transporter_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>Transporter</c> table.
	/// </summary>
	/// <param name="value">The <see cref="TransporterRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(TransporterRow value)
	{
		return DeleteByPrimaryKey(value.Transporter_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>Transporter</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="transporter_ID">The <c>Transporter_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int transporter_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int transporter_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Transporter_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Transporter_ID", transporter_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>Transporter</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>Transporter</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Transporter_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>Transporter</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Transporter_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="TransporterRow"/> objects.</returns>
	protected TransporterRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="TransporterRow"/> objects.</returns>
	protected TransporterRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="TransporterRow"/> objects.</returns>
	protected virtual TransporterRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// SSCC
		int ssccColumnIndex = reader.GetOrdinal("SSCC");
		// CreateBy
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				TransporterRow record = new TransporterRow();
				recordList.Add(record);
					...
					if(!reader.IsDBNull(ssccColumnIndex))
						record.SSCC = Convert.ToString(reader.GetValue(ssccColumnIndex));
		...
		return (TransporterRow[])(recordList.ToArray(typeof(TransporterRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="TransporterRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="TransporterRow"/> object.</returns>
	protected virtual TransporterRow MapRow(DataRow row)
	{
		string LOCATION = "TransporterRow MapRow(DataRow row)";
		TransporterRow mappedObject = new TransporterRow();
		...
		// Column "SSCC"
		dataColumn = dataTable.Columns["SSCC"];
		if (! row.IsNull(dataColumn) )
			mappedObject.SSCC = (string)(row[dataColumn]);
		// Column "CreateBy"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "Transporter";
		DataColumn dataColumn;
		...
		// Create the "SSCC" column
		dataColumn = dataTable.Columns.Add("SSCC", typeof(string));
		dataColumn.MaxLength = 500;
	...
	/// <summary>
	/// Exist <see cref="TransporterRow"/> by the primary key.
	/// </summary>
	/// <param name="transporter_ID">The <c>Transporter_ID</c> column value.</param>
	/// <returns>An instance of <see cref="TransporterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int transporter_ID)
	{
