...
// <fileinfo name="Base\SMSMessageCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class SMSMessageCollectionBase
...
{	
	...
	public SMSMessageCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "SMSMessage";
	}

	public SMSMessageCollectionBase() : base()
	{
		this.TABLENAME = "SMSMessage";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>SMSMessage</c> table.
	/// </summary>
	/// <returns>An array of <see cref="SMSMessageRow"/> objects.</returns>
	public virtual SMSMessageRow[] GetAll()
	{
	...
	/// includes all records from the <c>SMSMessage</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>SMSMessage</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("SMSMessage_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="SMSMessageRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="SMSMessageRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public SMSMessageRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			SMSMessageRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="SMSMessageRow"/> objects that 
	...
	/// <returns>An array of <see cref="SMSMessageRow"/> objects.</returns>
	public SMSMessageRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="SMSMessageRow"/> objects.</returns>
	public virtual SMSMessageRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			SMSMessageRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("SMSMessage_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("SMSMessage_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="SMSMessageRow"/> by the primary key.
	/// </summary>
	/// <param name="sMSMessage_ID">The <c>SMSMessage_ID</c> column value.</param>
	/// <returns>An instance of <see cref="SMSMessageRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual SMSMessageRow GetByPrimaryKey(int sMSMessage_ID)
	{
		string LOCATION = "GetByPrimaryKey(int sMSMessage_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("SMSMessage_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "SMSMessage_ID", sMSMessage_ID);
			SMSMessageRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>SMSMessage</c> table.
	/// </summary>
	/// <param name="value">The <see cref="SMSMessageRow"/> object to be inserted.</param>
	public virtual void Insert(SMSMessageRow value)
	{
		string LOCATION = "Insert(SMSMessageRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("SMSMessage_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
			...
			if (value.IsCanDeleteNull)
				...
				AddParameter(cmd, "CanDelete", value.CanDelete);
						...
						value.SMSMessage_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>SMSMessage</c> table.
	/// </summary>
	/// <param name="value">The <see cref="SMSMessageRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(SMSMessageRow value)
	{	
		string LOCATION = "Update(SMSMessageRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("SMSMessage_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>SMSMessage</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="SMSMessageRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(SMSMessageRow value)
		{
			string LOCATION = "Save(SMSMessageRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("SMSMessage_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["SMSMessage_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>SMSMessage</c> table.
	/// </summary>
	/// <param name="value">The <see cref="SMSMessageRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(SMSMessageRow value)
	{
		return DeleteByPrimaryKey(value.SMSMessage_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>SMSMessage</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="sMSMessage_ID">The <c>SMSMessage_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int sMSMessage_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int sMSMessage_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("SMSMessage_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "SMSMessage_ID", sMSMessage_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>SMSMessage</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>SMSMessage</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("SMSMessage_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>SMSMessage</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("SMSMessage_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="SMSMessageRow"/> objects.</returns>
	protected SMSMessageRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="SMSMessageRow"/> objects.</returns>
	protected SMSMessageRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="SMSMessageRow"/> objects.</returns>
	protected virtual SMSMessageRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				SMSMessageRow record = new SMSMessageRow();
		...
		return (SMSMessageRow[])(recordList.ToArray(typeof(SMSMessageRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="SMSMessageRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="SMSMessageRow"/> object.</returns>
	protected virtual SMSMessageRow MapRow(DataRow row)
	{
		string LOCATION = "SMSMessageRow MapRow(DataRow row)";
		SMSMessageRow mappedObject = new SMSMessageRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "SMSMessage";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="SMSMessageRow"/> by the primary key.
	/// </summary>
	/// <param name="sMSMessage_ID">The <c>SMSMessage_ID</c> column value.</param>
	/// <returns>An instance of <see cref="SMSMessageRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int sMSMessage_ID)
	{
