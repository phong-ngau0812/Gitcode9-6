...
// <fileinfo name="Base\BNN_BrandCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_BrandCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string Brand_IDColumnName  = "Brand_ID";
	...
	public BNN_BrandCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_Brand";
	}

	public BNN_BrandCollectionBase() : base()
	{
		this.TABLENAME = "BNN_Brand";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_Brand</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_BrandRow"/> objects.</returns>
	public virtual BNN_BrandRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_Brand</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_Brand</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_Brand_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_BrandRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_BrandRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_BrandRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_BrandRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_BrandRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_BrandRow"/> objects.</returns>
	public BNN_BrandRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_BrandRow"/> objects.</returns>
	public virtual BNN_BrandRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_BrandRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Brand_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Brand_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_BrandRow"/> by the primary key.
	/// </summary>
	/// <param name="brand_ID">The <c>Brand_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_BrandRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_BrandRow GetByPrimaryKey(int brand_ID)
	{
		string LOCATION = "GetByPrimaryKey(int brand_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_Brand_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Brand_ID", brand_ID);
			BNN_BrandRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_Brand</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BrandRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_BrandRow value)
	{
		string LOCATION = "Insert(BNN_BrandRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Brand_Insert", CommandType.StoredProcedure);
					// Title
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
						...
						value.Brand_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_Brand</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BrandRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_BrandRow value)
	{	
		string LOCATION = "Update(BNN_BrandRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Brand_Update", CommandType.StoredProcedure);
					// Title
			if (value.IsTitleNull)
				AddParameter(cmd, "Title", DBNull.Value);
			else
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
					...
					AddParameter(cmd, "Brand_ID", value.Brand_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_Brand</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_BrandRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_BrandRow value)
		{
			string LOCATION = "Save(BNN_BrandRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_Brand_Save",CommandType.StoredProcedure);
					// Title
				if (value.IsTitleNull)
					AddParameter(cmd, "Title", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Brand_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_Brand</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BrandRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_BrandRow value)
	{
		return DeleteByPrimaryKey(value.Brand_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_Brand</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="brand_ID">The <c>Brand_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int brand_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int brand_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_Brand_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Brand_ID", brand_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_Brand</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_Brand</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_Brand_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_Brand</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_Brand_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_BrandRow"/> objects.</returns>
	protected BNN_BrandRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_BrandRow"/> objects.</returns>
	protected BNN_BrandRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_BrandRow"/> objects.</returns>
	protected virtual BNN_BrandRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// Brand_ID
		int brand_IDColumnIndex = reader.GetOrdinal("Brand_ID");
		// Title
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_BrandRow record = new BNN_BrandRow();
				recordList.Add(record);

					record.Brand_ID = Convert.ToInt32(reader.GetValue(brand_IDColumnIndex));
		...
		return (BNN_BrandRow[])(recordList.ToArray(typeof(BNN_BrandRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_BrandRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_BrandRow"/> object.</returns>
	protected virtual BNN_BrandRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_BrandRow MapRow(DataRow row)";
		BNN_BrandRow mappedObject = new BNN_BrandRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "Brand_ID"
		dataColumn = dataTable.Columns["Brand_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Brand_ID = (int)(row[dataColumn]);
		// Column "Title"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_Brand";
		DataColumn dataColumn;
		// Create the "Brand_ID" column
		dataColumn = dataTable.Columns.Add("Brand_ID", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="BNN_BrandRow"/> by the primary key.
	/// </summary>
	/// <param name="brand_ID">The <c>Brand_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_BrandRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int brand_ID)
	{
