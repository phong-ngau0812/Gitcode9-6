...
// <fileinfo name="Base\Warehouse_ESCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class Warehouse_ESCollectionBase
...
{	
	...
	public Warehouse_ESCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "Warehouse_ES";
	}

	public Warehouse_ESCollectionBase() : base()
	{
		this.TABLENAME = "Warehouse_ES";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>Warehouse_ES</c> table.
	/// </summary>
	/// <returns>An array of <see cref="Warehouse_ESRow"/> objects.</returns>
	public virtual Warehouse_ESRow[] GetAll()
	{
	...
	/// includes all records from the <c>Warehouse_ES</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>Warehouse_ES</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("Warehouse_ES_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="Warehouse_ESRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="Warehouse_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public Warehouse_ESRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			Warehouse_ESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="Warehouse_ESRow"/> objects that 
	...
	/// <returns>An array of <see cref="Warehouse_ESRow"/> objects.</returns>
	public Warehouse_ESRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="Warehouse_ESRow"/> objects.</returns>
	public virtual Warehouse_ESRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			Warehouse_ESRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Warehouse_ES_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Warehouse_ES_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="Warehouse_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="warehouse_ID">The <c>Warehouse_ID</c> column value.</param>
	/// <returns>An instance of <see cref="Warehouse_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual Warehouse_ESRow GetByPrimaryKey(int warehouse_ID)
	{
		string LOCATION = "GetByPrimaryKey(int warehouse_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("Warehouse_ES_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Warehouse_ID", warehouse_ID);
			Warehouse_ESRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>Warehouse_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="Warehouse_ESRow"/> object to be inserted.</param>
	public virtual void Insert(Warehouse_ESRow value)
	{
		string LOCATION = "Insert(Warehouse_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Warehouse_ES_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.Warehouse_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>Warehouse_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="Warehouse_ESRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(Warehouse_ESRow value)
	{	
		string LOCATION = "Update(Warehouse_ESRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Warehouse_ES_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>Warehouse_ES</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="Warehouse_ESRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(Warehouse_ESRow value)
		{
			string LOCATION = "Save(Warehouse_ESRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("Warehouse_ES_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Warehouse_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>Warehouse_ES</c> table.
	/// </summary>
	/// <param name="value">The <see cref="Warehouse_ESRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(Warehouse_ESRow value)
	{
		return DeleteByPrimaryKey(value.Warehouse_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>Warehouse_ES</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="warehouse_ID">The <c>Warehouse_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int warehouse_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int warehouse_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("Warehouse_ES_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Warehouse_ID", warehouse_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>Warehouse_ES</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>Warehouse_ES</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("Warehouse_ES_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>Warehouse_ES</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("Warehouse_ES_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="Warehouse_ESRow"/> objects.</returns>
	protected Warehouse_ESRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="Warehouse_ESRow"/> objects.</returns>
	protected Warehouse_ESRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="Warehouse_ESRow"/> objects.</returns>
	protected virtual Warehouse_ESRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				Warehouse_ESRow record = new Warehouse_ESRow();
		...
		return (Warehouse_ESRow[])(recordList.ToArray(typeof(Warehouse_ESRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="Warehouse_ESRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="Warehouse_ESRow"/> object.</returns>
	protected virtual Warehouse_ESRow MapRow(DataRow row)
	{
		string LOCATION = "Warehouse_ESRow MapRow(DataRow row)";
		Warehouse_ESRow mappedObject = new Warehouse_ESRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "Warehouse_ES";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="Warehouse_ESRow"/> by the primary key.
	/// </summary>
	/// <param name="warehouse_ID">The <c>Warehouse_ID</c> column value.</param>
	/// <returns>An instance of <see cref="Warehouse_ESRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int warehouse_ID)
	{
