...
// <fileinfo name="Base\BNN_BackLinkCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_BackLinkCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string BackLink_IDColumnName  = "BackLink_ID";
	...
	public BNN_BackLinkCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_BackLink";
	}

	public BNN_BackLinkCollectionBase() : base()
	{
		this.TABLENAME = "BNN_BackLink";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_BackLink</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_BackLinkRow"/> objects.</returns>
	public virtual BNN_BackLinkRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_BackLink</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_BackLink</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_BackLink_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_BackLinkRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_BackLinkRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_BackLinkRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_BackLinkRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_BackLinkRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_BackLinkRow"/> objects.</returns>
	public BNN_BackLinkRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_BackLinkRow"/> objects.</returns>
	public virtual BNN_BackLinkRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_BackLinkRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_BackLink_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_BackLink_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_BackLinkRow"/> by the primary key.
	/// </summary>
	/// <param name="backLink_ID">The <c>BackLink_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_BackLinkRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_BackLinkRow GetByPrimaryKey(int backLink_ID)
	{
		string LOCATION = "GetByPrimaryKey(int backLink_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_BackLink_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "BackLink_ID", backLink_ID);
			BNN_BackLinkRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_BackLink</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BackLinkRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_BackLinkRow value)
	{
		string LOCATION = "Insert(BNN_BackLinkRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_BackLink_Insert", CommandType.StoredProcedure);
					// Title
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
						...
						value.BackLink_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_BackLink</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BackLinkRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_BackLinkRow value)
	{	
		string LOCATION = "Update(BNN_BackLinkRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_BackLink_Update", CommandType.StoredProcedure);
					// Title
			if (value.IsTitleNull)
				AddParameter(cmd, "Title", DBNull.Value);
			else
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
					...
					AddParameter(cmd, "BackLink_ID", value.BackLink_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_BackLink</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_BackLinkRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_BackLinkRow value)
		{
			string LOCATION = "Save(BNN_BackLinkRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_BackLink_Save",CommandType.StoredProcedure);
					// Title
				if (value.IsTitleNull)
					AddParameter(cmd, "Title", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["BackLink_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_BackLink</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_BackLinkRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_BackLinkRow value)
	{
		return DeleteByPrimaryKey(value.BackLink_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_BackLink</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="backLink_ID">The <c>BackLink_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int backLink_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int backLink_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_BackLink_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "BackLink_ID", backLink_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_BackLink</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_BackLink</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_BackLink_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_BackLink</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_BackLink_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_BackLinkRow"/> objects.</returns>
	protected BNN_BackLinkRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_BackLinkRow"/> objects.</returns>
	protected BNN_BackLinkRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_BackLinkRow"/> objects.</returns>
	protected virtual BNN_BackLinkRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// BackLink_ID
		int backLink_IDColumnIndex = reader.GetOrdinal("BackLink_ID");
		// Title
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_BackLinkRow record = new BNN_BackLinkRow();
				recordList.Add(record);

					record.BackLink_ID = Convert.ToInt32(reader.GetValue(backLink_IDColumnIndex));
		...
		return (BNN_BackLinkRow[])(recordList.ToArray(typeof(BNN_BackLinkRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_BackLinkRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_BackLinkRow"/> object.</returns>
	protected virtual BNN_BackLinkRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_BackLinkRow MapRow(DataRow row)";
		BNN_BackLinkRow mappedObject = new BNN_BackLinkRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "BackLink_ID"
		dataColumn = dataTable.Columns["BackLink_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.BackLink_ID = (int)(row[dataColumn]);
		// Column "Title"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_BackLink";
		DataColumn dataColumn;
		// Create the "BackLink_ID" column
		dataColumn = dataTable.Columns.Add("BackLink_ID", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="BNN_BackLinkRow"/> by the primary key.
	/// </summary>
	/// <param name="backLink_ID">The <c>BackLink_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_BackLinkRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int backLink_ID)
	{
