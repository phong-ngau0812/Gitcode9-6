...
// <fileinfo name="Base\QRCodeWorkshopRegisterCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class QRCodeWorkshopRegisterCollectionBase
...
{	
	...
	public QRCodeWorkshopRegisterCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "QRCodeWorkshopRegister";
	}

	public QRCodeWorkshopRegisterCollectionBase() : base()
	{
		this.TABLENAME = "QRCodeWorkshopRegister";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	/// <returns>An array of <see cref="QRCodeWorkshopRegisterRow"/> objects.</returns>
	public virtual QRCodeWorkshopRegisterRow[] GetAll()
	{
	...
	/// includes all records from the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("QRCodeWorkshopRegister_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="QRCodeWorkshopRegisterRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="QRCodeWorkshopRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public QRCodeWorkshopRegisterRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			QRCodeWorkshopRegisterRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="QRCodeWorkshopRegisterRow"/> objects that 
	...
	/// <returns>An array of <see cref="QRCodeWorkshopRegisterRow"/> objects.</returns>
	public QRCodeWorkshopRegisterRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="QRCodeWorkshopRegisterRow"/> objects.</returns>
	public virtual QRCodeWorkshopRegisterRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			QRCodeWorkshopRegisterRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWorkshopRegister_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWorkshopRegister_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="QRCodeWorkshopRegisterRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeWorkshopRegister_ID">The <c>QRCodeWorkshopRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeWorkshopRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual QRCodeWorkshopRegisterRow GetByPrimaryKey(int qRCodeWorkshopRegister_ID)
	{
		string LOCATION = "GetByPrimaryKey(int qRCodeWorkshopRegister_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("QRCodeWorkshopRegister_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "QRCodeWorkshopRegister_ID", qRCodeWorkshopRegister_ID);
			QRCodeWorkshopRegisterRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWorkshopRegisterRow"/> object to be inserted.</param>
	public virtual void Insert(QRCodeWorkshopRegisterRow value)
	{
		string LOCATION = "Insert(QRCodeWorkshopRegisterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWorkshopRegister_Insert", CommandType.StoredProcedure);
					// QRCodePackage_ID
	...
	/// <summary>
	/// Updates a record in the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWorkshopRegisterRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(QRCodeWorkshopRegisterRow value)
	{	
		string LOCATION = "Update(QRCodeWorkshopRegisterRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWorkshopRegister_Update", CommandType.StoredProcedure);
					// QRCodePackage_ID
			if (value.IsQRCodePackage_IDNull)
				AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>QRCodeWorkshopRegister</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="QRCodeWorkshopRegisterRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(QRCodeWorkshopRegisterRow value)
		{
			string LOCATION = "Save(QRCodeWorkshopRegisterRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("QRCodeWorkshopRegister_Save",CommandType.StoredProcedure);
					// QRCodePackage_ID
				if (value.IsQRCodePackage_IDNull)
					AddParameter(cmd, "QRCodePackage_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	/// <param name="value">The <see cref="QRCodeWorkshopRegisterRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(QRCodeWorkshopRegisterRow value)
	{
		return DeleteByPrimaryKey(value.QRCodeWorkshopRegister_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>QRCodeWorkshopRegister</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int qRCodeWorkshopRegister_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("QRCodeWorkshopRegister_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "QRCodeWorkshopRegister_ID", qRCodeWorkshopRegister_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>QRCodeWorkshopRegister</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>QRCodeWorkshopRegister</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("QRCodeWorkshopRegister_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("QRCodeWorkshopRegister_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="QRCodeWorkshopRegisterRow"/> objects.</returns>
	protected QRCodeWorkshopRegisterRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="QRCodeWorkshopRegisterRow"/> objects.</returns>
	protected QRCodeWorkshopRegisterRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="QRCodeWorkshopRegisterRow"/> objects.</returns>
	protected virtual QRCodeWorkshopRegisterRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				QRCodeWorkshopRegisterRow record = new QRCodeWorkshopRegisterRow();
		...
		return (QRCodeWorkshopRegisterRow[])(recordList.ToArray(typeof(QRCodeWorkshopRegisterRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="QRCodeWorkshopRegisterRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="QRCodeWorkshopRegisterRow"/> object.</returns>
	protected virtual QRCodeWorkshopRegisterRow MapRow(DataRow row)
	{
		string LOCATION = "QRCodeWorkshopRegisterRow MapRow(DataRow row)";
		QRCodeWorkshopRegisterRow mappedObject = new QRCodeWorkshopRegisterRow();
	...
	/// the <c>QRCodeWorkshopRegister</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "QRCodeWorkshopRegister";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="QRCodeWorkshopRegisterRow"/> by the primary key.
	/// </summary>
	/// <param name="qRCodeWorkshopRegister_ID">The <c>QRCodeWorkshopRegister_ID</c> column value.</param>
	/// <returns>An instance of <see cref="QRCodeWorkshopRegisterRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
