...
// <fileinfo name="Base\ProductColorCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ProductColorCollectionBase
...
{	
	...
	public ProductColorCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "ProductColor";
	}

	public ProductColorCollectionBase() : base()
	{
		this.TABLENAME = "ProductColor";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>ProductColor</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ProductColorRow"/> objects.</returns>
	public virtual ProductColorRow[] GetAll()
	{
	...
	/// includes all records from the <c>ProductColor</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>ProductColor</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("ProductColor_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ProductColorRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ProductColorRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ProductColorRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ProductColorRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ProductColorRow"/> objects that 
	...
	/// <returns>An array of <see cref="ProductColorRow"/> objects.</returns>
	public ProductColorRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ProductColorRow"/> objects.</returns>
	public virtual ProductColorRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ProductColorRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductColor_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductColor_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ProductColorRow"/> by the primary key.
	/// </summary>
	/// <param name="color_ID">The <c>Color_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductColorRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ProductColorRow GetByPrimaryKey(int color_ID)
	{
		string LOCATION = "GetByPrimaryKey(int color_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("ProductColor_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "Color_ID", color_ID);
			ProductColorRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>ProductColor</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductColorRow"/> object to be inserted.</param>
	public virtual void Insert(ProductColorRow value)
	{
		string LOCATION = "Insert(ProductColorRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductColor_Insert", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull )
			...
			if (value.IsLastEditDateNull)
				...
				AddParameter(cmd, "LastEditDate", value.LastEditDate);
						...
						value.Color_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>ProductColor</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductColorRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ProductColorRow value)
	{	
		string LOCATION = "Update(ProductColorRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductColor_Update", CommandType.StoredProcedure);
					// Name
			if (value.IsNameNull)
				AddParameter(cmd, "Name", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>ProductColor</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ProductColorRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ProductColorRow value)
		{
			string LOCATION = "Save(ProductColorRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("ProductColor_Save",CommandType.StoredProcedure);
					// Name
				if (value.IsNameNull)
					AddParameter(cmd, "Name", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Color_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>ProductColor</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductColorRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ProductColorRow value)
	{
		return DeleteByPrimaryKey(value.Color_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>ProductColor</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="color_ID">The <c>Color_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int color_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int color_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductColor_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "Color_ID", color_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>ProductColor</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>ProductColor</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductColor_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>ProductColor</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("ProductColor_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ProductColorRow"/> objects.</returns>
	protected ProductColorRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ProductColorRow"/> objects.</returns>
	protected ProductColorRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ProductColorRow"/> objects.</returns>
	protected virtual ProductColorRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ProductColorRow record = new ProductColorRow();
		...
		return (ProductColorRow[])(recordList.ToArray(typeof(ProductColorRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ProductColorRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ProductColorRow"/> object.</returns>
	protected virtual ProductColorRow MapRow(DataRow row)
	{
		string LOCATION = "ProductColorRow MapRow(DataRow row)";
		ProductColorRow mappedObject = new ProductColorRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "ProductColor";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="ProductColorRow"/> by the primary key.
	/// </summary>
	/// <param name="color_ID">The <c>Color_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductColorRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int color_ID)
	{
