...
// <fileinfo name="Base\BNN_NewsCategoryRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="BNN_NewsCategoryRow"/> that 
/// represents a record in the <c>BNN_NewsCategory</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="BNN_NewsCategoryRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class BNN_NewsCategoryRowBase
{
	/// _newsCategory_ID
	private int _newsCategory_ID;
	private bool _newsCategory_IDNull = true;
	/// _parent_ID
...
// Instance fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="BNN_NewsCategoryRowBase"/> class.
	/// </summary>
	public BNN_NewsCategoryRowBase():base()
	{
		// EMPTY
	}

		/// <summary>
		/// Gets or sets the <c>NewsCategory_ID</c> column value.
		/// </summary>
		/// <value>The <c>NewsCategory_ID</c> column value.</value>
	public int NewsCategory_ID
	{
		get
		{
			if(IsNewsCategory_IDNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _newsCategory_ID;
		}
		set
		{
			_newsCategory_IDNull = false;
			_newsCategory_ID = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="NewsCategory_ID"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsNewsCategory_IDNull
	{
		get
		{
			return _newsCategory_IDNull;
		}
		set
		{
			_newsCategory_IDNull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		dynStr.Append(":");
		// NewsCategory_ID
		dynStr.Append("  NewsCategory_ID=");
		if( IsNewsCategory_IDNull)
			dynStr.Append("<NULL>");
		else
			dynStr.Append(this.NewsCategory_ID);
