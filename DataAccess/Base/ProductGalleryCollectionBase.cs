...
// <fileinfo name="Base\ProductGalleryCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ProductGalleryCollectionBase
...
{	
	...
	public ProductGalleryCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "ProductGallery";
	}

	public ProductGalleryCollectionBase() : base()
	{
		this.TABLENAME = "ProductGallery";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>ProductGallery</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ProductGalleryRow"/> objects.</returns>
	public virtual ProductGalleryRow[] GetAll()
	{
	...
	/// includes all records from the <c>ProductGallery</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>ProductGallery</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("ProductGallery_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ProductGalleryRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ProductGalleryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ProductGalleryRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ProductGalleryRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ProductGalleryRow"/> objects that 
	...
	/// <returns>An array of <see cref="ProductGalleryRow"/> objects.</returns>
	public ProductGalleryRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ProductGalleryRow"/> objects.</returns>
	public virtual ProductGalleryRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ProductGalleryRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductGallery_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductGallery_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ProductGalleryRow"/> by the primary key.
	/// </summary>
	/// <param name="productGallery_ID">The <c>ProductGallery_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductGalleryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ProductGalleryRow GetByPrimaryKey(int productGallery_ID)
	{
		string LOCATION = "GetByPrimaryKey(int productGallery_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("ProductGallery_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "ProductGallery_ID", productGallery_ID);
			ProductGalleryRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>ProductGallery</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductGalleryRow"/> object to be inserted.</param>
	public virtual void Insert(ProductGalleryRow value)
	{
		string LOCATION = "Insert(ProductGalleryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductGallery_Insert", CommandType.StoredProcedure);
					// Product_ID
	...
	/// <summary>
	/// Updates a record in the <c>ProductGallery</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductGalleryRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ProductGalleryRow value)
	{	
		string LOCATION = "Update(ProductGalleryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductGallery_Update", CommandType.StoredProcedure);
					// Product_ID
			if (value.IsProduct_IDNull)
				AddParameter(cmd, "Product_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>ProductGallery</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ProductGalleryRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ProductGalleryRow value)
		{
			string LOCATION = "Save(ProductGalleryRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("ProductGallery_Save",CommandType.StoredProcedure);
					// Product_ID
				if (value.IsProduct_IDNull)
					AddParameter(cmd, "Product_ID", DBNull.Value);
				else
	...
	/// <summary>
	/// Deletes the specified object from the <c>ProductGallery</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductGalleryRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ProductGalleryRow value)
	{
		return DeleteByPrimaryKey(value.ProductGallery_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>ProductGallery</c> table using
	...
	public virtual bool DeleteByPrimaryKey(int productGallery_ID)
	{
		...
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductGallery_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "ProductGallery_ID", productGallery_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>ProductGallery</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>ProductGallery</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductGallery_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>ProductGallery</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("ProductGallery_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ProductGalleryRow"/> objects.</returns>
	protected ProductGalleryRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ProductGalleryRow"/> objects.</returns>
	protected ProductGalleryRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ProductGalleryRow"/> objects.</returns>
	protected virtual ProductGalleryRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ProductGalleryRow record = new ProductGalleryRow();
		...
		return (ProductGalleryRow[])(recordList.ToArray(typeof(ProductGalleryRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ProductGalleryRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ProductGalleryRow"/> object.</returns>
	protected virtual ProductGalleryRow MapRow(DataRow row)
	{
		string LOCATION = "ProductGalleryRow MapRow(DataRow row)";
		ProductGalleryRow mappedObject = new ProductGalleryRow();
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "ProductGallery";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="ProductGalleryRow"/> by the primary key.
	/// </summary>
	/// <param name="productGallery_ID">The <c>ProductGallery_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductGalleryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
