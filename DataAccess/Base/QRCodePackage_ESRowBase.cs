...
// <fileinfo name="Base\QRCodePackage_ESRowBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// <summary>
/// The base class for <see cref="QRCodePackage_ESRow"/> that 
/// represents a record in the <c>QRCodePackage_ES</c> table.
/// </summary>
/// <remarks>
/// Do not change this source code manually. Update the <see cref="QRCodePackage_ESRow"/>
/// class if you need to add or change some functionality.
/// </remarks>
public abstract class QRCodePackage_ESRowBase
{
	/// _qRCodePackage_ID
	...
	/// _audioPublic
	private int _audioPublic;
	private bool _audioPublicNull = true;
	/// _audioSold
	private int _audioSold;
	private bool _audioSoldNull = true;
	/// _audioIDE
	private int _audioIDE;
	private bool _audioIDENull = true;
	/// _messagePublic
	private int _messagePublic;
	private bool _messagePublicNull = true;
	/// _messageSold
	private int _messageSold;
	private bool _messageSoldNull = true;
	/// _messageIDE
	private int _messageIDE;
	private bool _messageIDENull = true;


// Instance fields
	
	/// <summary>
	/// Initializes a new instance of the <see cref="QRCodePackage_ESRowBase"/> class.
	/// </summary>
	public QRCodePackage_ESRowBase():base()
	{
		// EMPTY
	}
	...
	public bool IsFarmGroupNameNull
	{
		...
		/// <summary>
		/// Gets or sets the <c>AudioPublic</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>AudioPublic</c> column value.</value>
	public int AudioPublic
	{
		get
		{
			if (IsAudioPublicNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _audioPublic;
		}
		set
		{
			_audioPublicNull = false;
			_audioPublic = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="AudioPublic"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsAudioPublicNull
	{
		get
		{
			return _audioPublicNull;
		}
		set
		{
			_audioPublicNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>AudioSold</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>AudioSold</c> column value.</value>
	public int AudioSold
	{
		get
		{
			if (IsAudioSoldNull)
		...
		set
		{
			_audioSoldNull = false;
			_audioSold = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="AudioSold"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsAudioSoldNull
	{
		get
		{
			return _audioSoldNull;
		}
		set
		{
			_audioSoldNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>AudioIDE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>AudioIDE</c> column value.</value>
	public int AudioIDE
	{
		get
		{
	...
	/// <summary>
	/// Indicates whether the <see cref="AudioIDE"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsAudioIDENull
	{
		get
		{
			return _audioIDENull;
		}
		set
		{
			_audioIDENull = value;
		...
		/// <summary>
		/// Gets or sets the <c>MessagePublic</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>MessagePublic</c> column value.</value>
	public int MessagePublic
	{
		get
		{
			if (IsMessagePublicNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _messagePublic;
		}
		set
		{
			_messagePublicNull = false;
			_messagePublic = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="MessagePublic"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsMessagePublicNull
	{
		get
		{
			return _messagePublicNull;
		}
		set
		{
			_messagePublicNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>MessageSold</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>MessageSold</c> column value.</value>
	public int MessageSold
	{
		get
		{
			if (IsMessageSoldNull)
				throw new InvalidOperationException("Cannot get value because it is DBNull.");
			return _messageSold;
		}
		set
		{
			_messageSoldNull = false;
			_messageSold = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="MessageSold"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsMessageSoldNull
	{
		get
		{
			return _messageSoldNull;
		}
		set
		{
			_messageSoldNull = value;
		}	
	}

		/// <summary>
		/// Gets or sets the <c>MessageIDE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>MessageIDE</c> column value.</value>
	public int MessageIDE
	{
		get
		{
			if (IsMessageIDENull)
		...
		set
		{
			_messageIDENull = false;
			_messageIDE = value;
		}
	}

	/// <summary>
	/// Indicates whether the <see cref="MessageIDE"/>
	/// property value is null.
	/// </summary>
	/// <value>true if the property value is null, otherwise false.</value>
	public bool IsMessageIDENull
	{
		get
		{
			return _messageIDENull;
		}
		set
		{
			_messageIDENull = value;
		}	
	}
	...
	public override string ToString()
	{
		...
		// AudioPublic
		dynStr.Append("  AudioPublic=");
		if( IsAudioPublicNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.AudioPublic);
		// AudioSold
		dynStr.Append("  AudioSold=");
		if( IsAudioSoldNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.AudioSold);
		// AudioIDE
		dynStr.Append("  AudioIDE=");
		if( IsAudioIDENull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.AudioIDE);
		// MessagePublic
		dynStr.Append("  MessagePublic=");
		if( IsMessagePublicNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.MessagePublic);
		// MessageSold
		dynStr.Append("  MessageSold=");
		if( IsMessageSoldNull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.MessageSold);
		// MessageIDE
		dynStr.Append("  MessageIDE=");
		if( IsMessageIDENull)
		{
			dynStr.Append("<NULL>");
		}
		else
			dynStr.Append(this.MessageIDE);
