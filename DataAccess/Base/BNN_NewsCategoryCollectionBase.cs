...
// <fileinfo name="Base\BNN_NewsCategoryCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_NewsCategoryCollectionBase
	: Base.ConllectionBase
	
{	
	// Constants
	public const string NewsCategory_IDColumnName  = "NewsCategory_ID";
	...
	public BNN_NewsCategoryCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_NewsCategory";
	}

	public BNN_NewsCategoryCollectionBase() : base()
	{
		this.TABLENAME = "BNN_NewsCategory";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_NewsCategory</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_NewsCategoryRow"/> objects.</returns>
	public virtual BNN_NewsCategoryRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_NewsCategory</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_NewsCategory</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_NewsCategory_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_NewsCategoryRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_NewsCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_NewsCategoryRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_NewsCategoryRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_NewsCategoryRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_NewsCategoryRow"/> objects.</returns>
	public BNN_NewsCategoryRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_NewsCategoryRow"/> objects.</returns>
	public virtual BNN_NewsCategoryRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_NewsCategoryRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_NewsCategory_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_NewsCategory_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_NewsCategoryRow"/> by the primary key.
	/// </summary>
	/// <param name="newsCategory_ID">The <c>NewsCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_NewsCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_NewsCategoryRow GetByPrimaryKey(int newsCategory_ID)
	{
		string LOCATION = "GetByPrimaryKey(int newsCategory_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_NewsCategory_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "NewsCategory_ID", newsCategory_ID);
			BNN_NewsCategoryRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_NewsCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_NewsCategoryRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_NewsCategoryRow value)
	{
		string LOCATION = "Insert(BNN_NewsCategoryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_NewsCategory_Insert", CommandType.StoredProcedure);
					// Parent_ID
			...
			if (value.IsLevelNull)
				...
				AddParameter(cmd, "Level", value.Level);
						...
						value.NewsCategory_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_NewsCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_NewsCategoryRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_NewsCategoryRow value)
	{	
		string LOCATION = "Update(BNN_NewsCategoryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_NewsCategory_Update", CommandType.StoredProcedure);
					// Parent_ID
			if (value.IsParent_IDNull)
				AddParameter(cmd, "Parent_ID", DBNull.Value);
			else
			...
			if (value.IsLevelNull)
				...
				AddParameter(cmd, "Level", value.Level);
					...
					AddParameter(cmd, "NewsCategory_ID", value.NewsCategory_ID);
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_NewsCategory</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_NewsCategoryRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_NewsCategoryRow value)
		{
			string LOCATION = "Save(BNN_NewsCategoryRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_NewsCategory_Save",CommandType.StoredProcedure);
					// Parent_ID
				if (value.IsParent_IDNull)
					AddParameter(cmd, "Parent_ID", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["NewsCategory_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_NewsCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_NewsCategoryRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_NewsCategoryRow value)
	{
		return DeleteByPrimaryKey(value.NewsCategory_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_NewsCategory</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="newsCategory_ID">The <c>NewsCategory_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int newsCategory_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int newsCategory_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_NewsCategory_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "NewsCategory_ID", newsCategory_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_NewsCategory</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_NewsCategory</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_NewsCategory_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_NewsCategory</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_NewsCategory_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_NewsCategoryRow"/> objects.</returns>
	protected BNN_NewsCategoryRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_NewsCategoryRow"/> objects.</returns>
	protected BNN_NewsCategoryRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_NewsCategoryRow"/> objects.</returns>
	protected virtual BNN_NewsCategoryRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// NewsCategory_ID
		int newsCategory_IDColumnIndex = reader.GetOrdinal("NewsCategory_ID");
		// Parent_ID
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_NewsCategoryRow record = new BNN_NewsCategoryRow();
				recordList.Add(record);

					record.NewsCategory_ID = Convert.ToInt32(reader.GetValue(newsCategory_IDColumnIndex));
		...
		return (BNN_NewsCategoryRow[])(recordList.ToArray(typeof(BNN_NewsCategoryRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_NewsCategoryRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_NewsCategoryRow"/> object.</returns>
	protected virtual BNN_NewsCategoryRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_NewsCategoryRow MapRow(DataRow row)";
		BNN_NewsCategoryRow mappedObject = new BNN_NewsCategoryRow();
		DataTable dataTable = row.Table;
		DataColumn dataColumn;
		// Column "NewsCategory_ID"
		dataColumn = dataTable.Columns["NewsCategory_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.NewsCategory_ID = (int)(row[dataColumn]);
		// Column "Parent_ID"
	...
	/// the <c>BNN_NewsCategory</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_NewsCategory";
		DataColumn dataColumn;
		// Create the "NewsCategory_ID" column
		dataColumn = dataTable.Columns.Add("NewsCategory_ID", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="BNN_NewsCategoryRow"/> by the primary key.
	/// </summary>
	/// <param name="newsCategory_ID">The <c>NewsCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_NewsCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int newsCategory_ID)
	{
