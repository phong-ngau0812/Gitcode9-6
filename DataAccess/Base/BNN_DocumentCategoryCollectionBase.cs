...
// <fileinfo name="Base\BNN_DocumentCategoryCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class BNN_DocumentCategoryCollectionBase
...
{	
	...
	public BNN_DocumentCategoryCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "BNN_DocumentCategory";
	}

	public BNN_DocumentCategoryCollectionBase() : base()
	{
		this.TABLENAME = "BNN_DocumentCategory";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	/// <returns>An array of <see cref="BNN_DocumentCategoryRow"/> objects.</returns>
	public virtual BNN_DocumentCategoryRow[] GetAll()
	{
	...
	/// includes all records from the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("BNN_DocumentCategory_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="BNN_DocumentCategoryRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="BNN_DocumentCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public BNN_DocumentCategoryRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			BNN_DocumentCategoryRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="BNN_DocumentCategoryRow"/> objects that 
	...
	/// <returns>An array of <see cref="BNN_DocumentCategoryRow"/> objects.</returns>
	public BNN_DocumentCategoryRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="BNN_DocumentCategoryRow"/> objects.</returns>
	public virtual BNN_DocumentCategoryRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			BNN_DocumentCategoryRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_DocumentCategory_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_DocumentCategory_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="BNN_DocumentCategoryRow"/> by the primary key.
	/// </summary>
	/// <param name="documentCategory_ID">The <c>DocumentCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_DocumentCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual BNN_DocumentCategoryRow GetByPrimaryKey(int documentCategory_ID)
	{
		string LOCATION = "GetByPrimaryKey(int documentCategory_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("BNN_DocumentCategory_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "DocumentCategory_ID", documentCategory_ID);
			BNN_DocumentCategoryRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_DocumentCategoryRow"/> object to be inserted.</param>
	public virtual void Insert(BNN_DocumentCategoryRow value)
	{
		string LOCATION = "Insert(BNN_DocumentCategoryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_DocumentCategory_Insert", CommandType.StoredProcedure);
					// Title
			...
			if (value.IsDistrict_IDNull)
				...
				AddParameter(cmd, "District_ID", value.District_ID);
						...
						value.DocumentCategory_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_DocumentCategoryRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(BNN_DocumentCategoryRow value)
	{	
		string LOCATION = "Update(BNN_DocumentCategoryRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_DocumentCategory_Update", CommandType.StoredProcedure);
					// Title
			if (value.IsTitleNull)
				AddParameter(cmd, "Title", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>BNN_DocumentCategory</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="BNN_DocumentCategoryRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(BNN_DocumentCategoryRow value)
		{
			string LOCATION = "Save(BNN_DocumentCategoryRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("BNN_DocumentCategory_Save",CommandType.StoredProcedure);
					// Title
				if (value.IsTitleNull)
					AddParameter(cmd, "Title", DBNull.Value);
				else
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["DocumentCategory_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	/// <param name="value">The <see cref="BNN_DocumentCategoryRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(BNN_DocumentCategoryRow value)
	{
		return DeleteByPrimaryKey(value.DocumentCategory_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>BNN_DocumentCategory</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="documentCategory_ID">The <c>DocumentCategory_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int documentCategory_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int documentCategory_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("BNN_DocumentCategory_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "DocumentCategory_ID", documentCategory_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>BNN_DocumentCategory</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>BNN_DocumentCategory</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("BNN_DocumentCategory_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("BNN_DocumentCategory_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="BNN_DocumentCategoryRow"/> objects.</returns>
	protected BNN_DocumentCategoryRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="BNN_DocumentCategoryRow"/> objects.</returns>
	protected BNN_DocumentCategoryRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="BNN_DocumentCategoryRow"/> objects.</returns>
	protected virtual BNN_DocumentCategoryRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				BNN_DocumentCategoryRow record = new BNN_DocumentCategoryRow();
		...
		return (BNN_DocumentCategoryRow[])(recordList.ToArray(typeof(BNN_DocumentCategoryRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="BNN_DocumentCategoryRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="BNN_DocumentCategoryRow"/> object.</returns>
	protected virtual BNN_DocumentCategoryRow MapRow(DataRow row)
	{
		string LOCATION = "BNN_DocumentCategoryRow MapRow(DataRow row)";
		BNN_DocumentCategoryRow mappedObject = new BNN_DocumentCategoryRow();
	...
	/// the <c>BNN_DocumentCategory</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "BNN_DocumentCategory";
		DataColumn dataColumn;
	...
	/// <summary>
	/// Exist <see cref="BNN_DocumentCategoryRow"/> by the primary key.
	/// </summary>
	/// <param name="documentCategory_ID">The <c>DocumentCategory_ID</c> column value.</param>
	/// <returns>An instance of <see cref="BNN_DocumentCategoryRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int documentCategory_ID)
	{
