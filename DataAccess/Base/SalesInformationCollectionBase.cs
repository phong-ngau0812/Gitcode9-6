...
// <fileinfo name="Base\SalesInformationCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class SalesInformationCollectionBase
...
{	
	...
	public const string BarcodeColumnName  = "Barcode";
	...
	public const string SalesShift_IDColumnName  = "SalesShift_ID";
	...
	public SalesInformationCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "SalesInformation";
	}

	public SalesInformationCollectionBase() : base()
	{
		this.TABLENAME = "SalesInformation";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>SalesInformation</c> table.
	/// </summary>
	/// <returns>An array of <see cref="SalesInformationRow"/> objects.</returns>
	public virtual SalesInformationRow[] GetAll()
	{
	...
	/// includes all records from the <c>SalesInformation</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>SalesInformation</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("SalesInformation_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="SalesInformationRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="SalesInformationRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public SalesInformationRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			SalesInformationRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="SalesInformationRow"/> objects that 
	...
	/// <returns>An array of <see cref="SalesInformationRow"/> objects.</returns>
	public SalesInformationRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="SalesInformationRow"/> objects.</returns>
	public virtual SalesInformationRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			SalesInformationRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("SalesInformation_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("SalesInformation_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="SalesInformationRow"/> by the primary key.
	/// </summary>
	/// <param name="salesInformation_ID">The <c>SalesInformation_ID</c> column value.</param>
	/// <returns>An instance of <see cref="SalesInformationRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual SalesInformationRow GetByPrimaryKey(int salesInformation_ID)
	{
		string LOCATION = "GetByPrimaryKey(int salesInformation_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("SalesInformation_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "SalesInformation_ID", salesInformation_ID);
			SalesInformationRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>SalesInformation</c> table.
	/// </summary>
	/// <param name="value">The <see cref="SalesInformationRow"/> object to be inserted.</param>
	public virtual void Insert(SalesInformationRow value)
	{
		string LOCATION = "Insert(SalesInformationRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("SalesInformation_Insert", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				...
				// Barcode
			if (value.IsBarcodeNull )
				AddParameter(cmd, "Barcode", DBNull.Value);
			else
				AddParameter(cmd, "Barcode", value.Barcode);
			
				// Total
			if (value.IsTotalNull)
				AddParameter(cmd, "Total", DBNull.Value);
			else
			...
			if (value.IsWorkshop_IDNull)
				...
				// SalesShift_ID
			if (value.IsSalesShift_IDNull)
				AddParameter(cmd, "SalesShift_ID", DBNull.Value);
			else
				AddParameter(cmd, "SalesShift_ID", value.SalesShift_ID);
			...
			if (value.IsSortNull)
				...
				AddParameter(cmd, "Sort", value.Sort);
						...
						value.SalesInformation_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>SalesInformation</c> table.
	/// </summary>
	/// <param name="value">The <see cref="SalesInformationRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(SalesInformationRow value)
	{	
		string LOCATION = "Update(SalesInformationRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("SalesInformation_Update", CommandType.StoredProcedure);
					// ProductBrand_ID
			if (value.IsProductBrand_IDNull)
				AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>SalesInformation</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="SalesInformationRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(SalesInformationRow value)
		{
			string LOCATION = "Save(SalesInformationRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("SalesInformation_Save",CommandType.StoredProcedure);
					// ProductBrand_ID
				if (value.IsProductBrand_IDNull)
					AddParameter(cmd, "ProductBrand_ID", DBNull.Value);
				else
				...
				if (value.IsBarcodeNull)
					...
					AddParameter(cmd, "Barcode", (object)(value.Barcode));
				
					// Total
				if (value.IsTotalNull)
					AddParameter(cmd, "Total", DBNull.Value);
				else
					AddParameter(cmd, "Total", (object)(value.Total));
				...
				if (value.IsSalesShift_IDNull)
					...
					AddParameter(cmd, "SalesShift_ID", (object)(value.SalesShift_ID));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["SalesInformation_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>SalesInformation</c> table.
	/// </summary>
	/// <param name="value">The <see cref="SalesInformationRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(SalesInformationRow value)
	{
		return DeleteByPrimaryKey(value.SalesInformation_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>SalesInformation</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="salesInformation_ID">The <c>SalesInformation_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int salesInformation_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int salesInformation_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("SalesInformation_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "SalesInformation_ID", salesInformation_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>SalesInformation</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>SalesInformation</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("SalesInformation_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>SalesInformation</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("SalesInformation_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="SalesInformationRow"/> objects.</returns>
	protected SalesInformationRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="SalesInformationRow"/> objects.</returns>
	protected SalesInformationRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="SalesInformationRow"/> objects.</returns>
	protected virtual SalesInformationRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// Barcode
		int barcodeColumnIndex = reader.GetOrdinal("Barcode");
		// Total
		...
		// SalesShift_ID
		int salesShift_IDColumnIndex = reader.GetOrdinal("SalesShift_ID");
		// Active
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				SalesInformationRow record = new SalesInformationRow();
				recordList.Add(record);
					...
					if(!reader.IsDBNull(barcodeColumnIndex))
						record.Barcode = Convert.ToString(reader.GetValue(barcodeColumnIndex));
					if(!reader.IsDBNull(totalColumnIndex))
						record.Total = Convert.ToDecimal(reader.GetValue(totalColumnIndex));
					...
					if(!reader.IsDBNull(salesShift_IDColumnIndex))
						record.SalesShift_ID = Convert.ToInt32(reader.GetValue(salesShift_IDColumnIndex));
		...
		return (SalesInformationRow[])(recordList.ToArray(typeof(SalesInformationRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="SalesInformationRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="SalesInformationRow"/> object.</returns>
	protected virtual SalesInformationRow MapRow(DataRow row)
	{
		string LOCATION = "SalesInformationRow MapRow(DataRow row)";
		SalesInformationRow mappedObject = new SalesInformationRow();
		...
		// Column "Barcode"
		dataColumn = dataTable.Columns["Barcode"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Barcode = (string)(row[dataColumn]);
		// Column "Total"
		...
		// Column "SalesShift_ID"
		dataColumn = dataTable.Columns["SalesShift_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.SalesShift_ID = (int)(row[dataColumn]);
		// Column "Active"
	...
	/// the <c>SalesInformation</c> table.
	/// </summary>
	/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "SalesInformation";
		DataColumn dataColumn;
		...
		dataColumn = dataTable.Columns.Add("Barcode", typeof(string));
		...
		// Create the "SalesShift_ID" column
		dataColumn = dataTable.Columns.Add("SalesShift_ID", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="SalesInformationRow"/> by the primary key.
	/// </summary>
	/// <param name="salesInformation_ID">The <c>SalesInformation_ID</c> column value.</param>
	/// <returns>An instance of <see cref="SalesInformationRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int salesInformation_ID)
	{
