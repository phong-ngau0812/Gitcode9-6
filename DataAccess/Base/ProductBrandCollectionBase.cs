...
// <fileinfo name="Base\ProductBrandCollectionBase.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
/// </remarks>
public abstract class ProductBrandCollectionBase
...
{	
	...
	public const string Rank_IDColumnName  = "Rank_ID";
	public const string ProductBrandRole_IDColumnName  = "ProductBrandRole_ID";
	public const string Sales_IDColumnName  = "Sales_ID";
	public const string ContractSigningDateColumnName  = "ContractSigningDate";
	public const string ProductCountColumnName  = "ProductCount";
	public const string StampCountColumnName  = "StampCount";
	...
	public ProductBrandCollectionBase(Database db) : base(db)
	{
		this.TABLENAME = "ProductBrand";
	}

	public ProductBrandCollectionBase() : base()
	{
		this.TABLENAME = "ProductBrand";     
	}
	...
	/// <summary>
	/// Gets an array of all records from the <c>ProductBrand</c> table.
	/// </summary>
	/// <returns>An array of <see cref="ProductBrandRow"/> objects.</returns>
	public virtual ProductBrandRow[] GetAll()
	{
	...
	/// includes all records from the <c>ProductBrand</c> table.
	/// </summary>
	...
	/// to retrieve all records from the <c>ProductBrand</c> table.
	/// </summary>
	...
	protected virtual IDbCommand CreateGetAllCommand()
	{
		...
		try
		{
			return _db.CreateCommand("ProductBrand_GetAll", CommandType.StoredProcedure);
		}
		catch (Exception ex)
        	{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Gets the first <see cref="ProductBrandRow"/> objects that 
	/// match the search condition.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. For example: 
	/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>An instance of <see cref="ProductBrandRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public ProductBrandRow GetRow(string whereSql)
	{
		string LOCATION = "GetRow(string whereSql)";
		try
        	{
			int totalRecordCount = -1;
			ProductBrandRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			if (0 == rows.Length)
				return null;
			return rows[0];
		}
	...
	/// <summary>
	/// Gets an array of <see cref="ProductBrandRow"/> objects that 
	...
	/// <returns>An array of <see cref="ProductBrandRow"/> objects.</returns>
	public ProductBrandRow[] GetAsArray(string whereSql, string orderBySql)
	{
	...
	/// <returns>An array of <see cref="ProductBrandRow"/> objects.</returns>
	public virtual ProductBrandRow[] GetAsArray(string whereSql, string orderBySql, int startIndex, int length, ref int totalRecordCount)
	{
		...
		try
		{
			...
			ProductBrandRow[] rows = MapRecords(reader);
			reader.Close();
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductBrand_GetAdHoc", CommandType.StoredProcedure);
	...
	protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql, int startIndex, int length)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductBrand_GetPageAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Gets <see cref="ProductBrandRow"/> by the primary key.
	/// </summary>
	/// <param name="productBrand_ID">The <c>ProductBrand_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductBrandRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual ProductBrandRow GetByPrimaryKey(int productBrand_ID)
	{
		string LOCATION = "GetByPrimaryKey(int productBrand_ID)";
		try
        	{
			IDbCommand cmd = _db.CreateCommand("ProductBrand_GetByPrimaryKey", CommandType.StoredProcedure);
			AddParameter(cmd, "ProductBrand_ID", productBrand_ID);
			ProductBrandRow[] tempArray = MapRecords(cmd);
	...
	/// <summary>
	/// Adds a new record into the <c>ProductBrand</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductBrandRow"/> object to be inserted.</param>
	public virtual void Insert(ProductBrandRow value)
	{
		string LOCATION = "Insert(ProductBrandRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductBrand_Insert", CommandType.StoredProcedure);
					// Language_ID
			...
			if (value.IsBusinessType_IDNull)
				...
				// Rank_ID
			if (value.IsRank_IDNull)
				AddParameter(cmd, "Rank_ID", DBNull.Value);
			else
				AddParameter(cmd, "Rank_ID", value.Rank_ID);
			
				// ProductBrandRole_ID
			if (value.IsProductBrandRole_IDNull)
				AddParameter(cmd, "ProductBrandRole_ID", DBNull.Value);
			else
				AddParameter(cmd, "ProductBrandRole_ID", value.ProductBrandRole_ID);
			
				// Sales_ID
			if (value.IsSales_IDNull)
				AddParameter(cmd, "Sales_ID", DBNull.Value);
			else
				AddParameter(cmd, "Sales_ID", value.Sales_ID);
			
				// ContractSigningDate
			if (value.IsContractSigningDateNull)
				AddParameter(cmd, "ContractSigningDate", DBNull.Value);
			else
				AddParameter(cmd, "ContractSigningDate", value.ContractSigningDate);
			
				// ProductCount
			if (value.IsProductCountNull)
				AddParameter(cmd, "ProductCount", DBNull.Value);
			else
				AddParameter(cmd, "ProductCount", value.ProductCount);
			
				// StampCount
			if (value.IsStampCountNull)
				AddParameter(cmd, "StampCount", DBNull.Value);
			else
				AddParameter(cmd, "StampCount", value.StampCount);
			...
			if (value.IsYoutubeNull )
				...
				AddParameter(cmd, "Youtube", value.Youtube);
						...
						value.ProductBrand_ID = Convert.ToInt32(cmd.ExecuteScalar());
			}
		catch(Exception ex)
		{
			throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <summary>
	/// Updates a record in the <c>ProductBrand</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductBrandRow"/>
	/// object used to update the table record.</param>
	/// <returns>true if the record was updated; otherwise, false.</returns>
	public virtual bool Update(ProductBrandRow value)
	{	
		string LOCATION = "Update(ProductBrandRow value)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductBrand_Update", CommandType.StoredProcedure);
					// Language_ID
			if (value.IsLanguage_IDNull)
				AddParameter(cmd, "Language_ID", DBNull.Value);
			else
        ...
        catch(Exception ex)
	{
		...
		/// <summary>
		/// Inserts or Updates a record in the <c>ProductBrand</c> table.
		/// If a row with the specified primary key exists then it is updated
		/// otehrwise, a new row is added.
		/// </summary>
		/// <param name="value">The <see cref="ProductBrandRow"/>
		/// object used to save the table record.</param>
		public virtual void Save(ProductBrandRow value)
		{
			string LOCATION = "Save(ProductBrandRow value)";
			try
			{
					IDbCommand cmd =  _db.CreateCommand("ProductBrand_Save",CommandType.StoredProcedure);
					// Language_ID
				if (value.IsLanguage_IDNull)
					AddParameter(cmd, "Language_ID", DBNull.Value);
				else
				...
				if (value.IsRank_IDNull)
					...
					AddParameter(cmd, "Rank_ID", (object)(value.Rank_ID));
				
					// ProductBrandRole_ID
				if (value.IsProductBrandRole_IDNull)
					AddParameter(cmd, "ProductBrandRole_ID", DBNull.Value);
				else
					AddParameter(cmd, "ProductBrandRole_ID", (object)(value.ProductBrandRole_ID));
				
					// Sales_ID
				if (value.IsSales_IDNull)
					AddParameter(cmd, "Sales_ID", DBNull.Value);
				else
					AddParameter(cmd, "Sales_ID", (object)(value.Sales_ID));
				
					// ContractSigningDate
				if (value.IsContractSigningDateNull)
					AddParameter(cmd, "ContractSigningDate", DBNull.Value);
				else
					AddParameter(cmd, "ContractSigningDate", (object)(value.ContractSigningDate));
				
					// ProductCount
				if (value.IsProductCountNull)
					AddParameter(cmd, "ProductCount", DBNull.Value);
				else
					AddParameter(cmd, "ProductCount", (object)(value.ProductCount));
				
					// StampCount
				if (value.IsStampCountNull)
					AddParameter(cmd, "StampCount", DBNull.Value);
				else
					AddParameter(cmd, "StampCount", (object)(value.StampCount));
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["ProductBrand_ID"]);
						}
						finally
						{
							row.Delete();
	...
	/// <summary>
	/// Deletes the specified object from the <c>ProductBrand</c> table.
	/// </summary>
	/// <param name="value">The <see cref="ProductBrandRow"/> object to delete.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public bool Delete(ProductBrandRow value)
	{
		return DeleteByPrimaryKey(value.ProductBrand_ID);
	}

	/// <summary>
	/// Deletes a record from the <c>ProductBrand</c> table using
	/// the specified primary key.
	/// </summary>
	/// <param name="productBrand_ID">The <c>ProductBrand_ID</c> column value.</param>
	/// <returns>true if the record was deleted; otherwise, false.</returns>
	public virtual bool DeleteByPrimaryKey(int productBrand_ID)
	{
		string LOCATION = "DeleteByPrimaryKey(int productBrand_ID)";
		try
		{
				IDbCommand cmd = _db.CreateCommand("ProductBrand_DeleteByPrimaryKey", CommandType.StoredProcedure);
					AddParameter(cmd, "ProductBrand_ID", productBrand_ID);
				return (0 < cmd.ExecuteNonQuery());
	}
        catch(Exception ex)
	...
	/// <summary>
	/// Deletes <c>ProductBrand</c> records that match the specified criteria.
	/// </summary>
	...
	/// to delete <c>ProductBrand</c> records that match the specified criteria.
	/// </summary>
	/// <param name="whereSql">The SQL search condition. 
	/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
	/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
	protected virtual IDbCommand CreateDeleteCommand(string whereSql)
	{
		...
		try
		{
			IDbCommand cmd = _db.CreateCommand("ProductBrand_DeleteAdHoc", CommandType.StoredProcedure);
	...
	/// <summary>
	/// Deletes all records from the <c>ProductBrand</c> table.
	/// </summary>
	/// <returns>The number of deleted records.</returns>
	public int DeleteAll()
	{
		...
		try
		{
				return _db.CreateCommand("ProductBrand_DeleteAll", CommandType.StoredProcedure).ExecuteNonQuery();
			}
		catch(Exception ex)
		{
		      	throw new Exceptions.DatabaseException(LOCATION, ex);
	...
	/// <returns>An array of <see cref="ProductBrandRow"/> objects.</returns>
	protected ProductBrandRow[] MapRecords(IDbCommand command)
	{
	...
	/// <returns>An array of <see cref="ProductBrandRow"/> objects.</returns>
	protected ProductBrandRow[] MapRecords(IDataReader reader)
	{
		int totalRecordCount = -1;
	...
	/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
	/// <returns>An array of <see cref="ProductBrandRow"/> objects.</returns>
	protected virtual ProductBrandRow[] MapRecords(IDataReader reader, int startIndex, int length, ref int totalRecordCount)
	{ 
		...
		// Rank_ID
		int rank_IDColumnIndex = reader.GetOrdinal("Rank_ID");
		// ProductBrandRole_ID
		int productBrandRole_IDColumnIndex = reader.GetOrdinal("ProductBrandRole_ID");
		// Sales_ID
		int sales_IDColumnIndex = reader.GetOrdinal("Sales_ID");
		// ContractSigningDate
		int contractSigningDateColumnIndex = reader.GetOrdinal("ContractSigningDate");
		// ProductCount
		int productCountColumnIndex = reader.GetOrdinal("ProductCount");
		// StampCount
		int stampCountColumnIndex = reader.GetOrdinal("StampCount");
		// Youtube
		...
		while(reader.Read())
		{
			...
			if(ri > 0 && ri <= length)
			{
				ProductBrandRow record = new ProductBrandRow();
				recordList.Add(record);
					...
					if(!reader.IsDBNull(rank_IDColumnIndex))
						record.Rank_ID = Convert.ToInt32(reader.GetValue(rank_IDColumnIndex));
					if(!reader.IsDBNull(productBrandRole_IDColumnIndex))
						record.ProductBrandRole_ID = Convert.ToInt32(reader.GetValue(productBrandRole_IDColumnIndex));
					if(!reader.IsDBNull(sales_IDColumnIndex))
						record.Sales_ID = reader.GetGuid(sales_IDColumnIndex);
					if(!reader.IsDBNull(contractSigningDateColumnIndex))
						record.ContractSigningDate = Convert.ToDateTime(reader.GetValue(contractSigningDateColumnIndex));
					if(!reader.IsDBNull(productCountColumnIndex))
						record.ProductCount = Convert.ToInt32(reader.GetValue(productCountColumnIndex));
					if(!reader.IsDBNull(stampCountColumnIndex))
						record.StampCount = Convert.ToInt32(reader.GetValue(stampCountColumnIndex));
		...
		return (ProductBrandRow[])(recordList.ToArray(typeof(ProductBrandRow)));
	}
	...
	/// <summary>
	/// Converts <see cref="System.Data.DataRow"/> to <see cref="ProductBrandRow"/>.
	/// </summary>
	/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
	/// <returns>A reference to the <see cref="ProductBrandRow"/> object.</returns>
	protected virtual ProductBrandRow MapRow(DataRow row)
	{
		string LOCATION = "ProductBrandRow MapRow(DataRow row)";
		ProductBrandRow mappedObject = new ProductBrandRow();
		...
		// Column "Rank_ID"
		dataColumn = dataTable.Columns["Rank_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Rank_ID = (int)(row[dataColumn]);
		// Column "ProductBrandRole_ID"
		dataColumn = dataTable.Columns["ProductBrandRole_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.ProductBrandRole_ID = (int)(row[dataColumn]);
		// Column "Sales_ID"
		dataColumn = dataTable.Columns["Sales_ID"];
		if (! row.IsNull(dataColumn) )
			mappedObject.Sales_ID = (System.Guid)(row[dataColumn]);
		// Column "ContractSigningDate"
		dataColumn = dataTable.Columns["ContractSigningDate"];
		if (! row.IsNull(dataColumn) )
			mappedObject.ContractSigningDate = (System.DateTime)(row[dataColumn]);
		// Column "ProductCount"
		dataColumn = dataTable.Columns["ProductCount"];
		if (! row.IsNull(dataColumn) )
			mappedObject.ProductCount = (int)(row[dataColumn]);
		// Column "StampCount"
		dataColumn = dataTable.Columns["StampCount"];
		if (! row.IsNull(dataColumn) )
			mappedObject.StampCount = (int)(row[dataColumn]);
		// Column "Youtube"
	...
	protected virtual DataTable CreateDataTable()
	{
		...
		dataTable.TableName = "ProductBrand";
		DataColumn dataColumn;
		...
		dataColumn = dataTable.Columns.Add("Rank_ID", typeof(int));
		// Create the "ProductBrandRole_ID" column
		dataColumn = dataTable.Columns.Add("ProductBrandRole_ID", typeof(int));
		// Create the "Sales_ID" column
		dataColumn = dataTable.Columns.Add("Sales_ID", typeof(System.Guid));
		// Create the "ContractSigningDate" column
		dataColumn = dataTable.Columns.Add("ContractSigningDate", typeof(System.DateTime));
		// Create the "ProductCount" column
		dataColumn = dataTable.Columns.Add("ProductCount", typeof(int));
		// Create the "StampCount" column
		dataColumn = dataTable.Columns.Add("StampCount", typeof(int));
	...
	/// <summary>
	/// Exist <see cref="ProductBrandRow"/> by the primary key.
	/// </summary>
	/// <param name="productBrand_ID">The <c>ProductBrand_ID</c> column value.</param>
	/// <returns>An instance of <see cref="ProductBrandRow"/> or null reference 
	/// (Nothing in Visual Basic) if the object was not found.</returns>
	public virtual bool Exist(int productBrand_ID)
	{
